...
d.save(function(){window.setTimeout(a.testConnection,0)});a.page=3};a.testConnection=function(){e.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),window.location="/redirect.html?v=v1.0.124"):window.setTimeout(a.testConnection,3E3)})}}]).controller("localAdminCtrl",["$scope","$route","$location","LocalAdmin","SystemSettings",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=e.get();a.locAdmin=d.get();
...
!1;window.uploadDone=function(){if(a.loadFile)var b=d.get(function(){b.successful?(e.save(function(){window.setTimeout(a.testConnection,0)}),a.completed=!0):(a.errorMessages=["Configuration File: Bad format of configuration file."],a.showErrorPage=!0)})};a.testConnection=function(){g.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,h.removeAll(),window.location="/redirect.html?v=v1.0.124"):window.setTimeout(a.testConnection,3E3)})};a.toggleShow=
...
3E3)},function(b){401==b.status?(a.restarting=!0,h.removeAll(),window.location=0==a.resetType?"/redirectSetup.html?v=v1.0.124":"/redirect.html?v=v1.0.124"):window.setTimeout(a.testConnection,3E3)})}}]).controller("rebootCtrl",["$scope","$route","Reboot","SystemSettings","Login","$location","$templateCache",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=d.get();a.rebooting=!1;a.restarting=!1;a.reboot=function(){a.rebooting=!0;c.save(function(){window.setTimeout(a.testConnection,
0)})};a.testConnection=function(){d.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),window.location="/redirect.html?v=v1.0.124"):window.setTimeout(a.testConnection,3E3)})};a.keyPress=function(b){13==b.keyCode&&"/advanced/reboot"==f.path()&&a.reboot()}}]).controller("macCloningCtrl",["$scope","$route","$location","MacCloning",function(a,b,c,d){a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.macCloning=d.get(function(){a.macAddress=
...
function(){systemSettings.warnBeforeChanges?a.detectBroadband=!0:a.doDetectBroadband()};a.detectCancel=function(){a.detectBroadband=!1};a.doDetectBroadband=function(){d.update({id:1},{detectBroadband:!0},function(){a.rebootingPage=!0;window.setTimeout(a.testConnection,0)})};a.testConnection=function(){f.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),window.location="/redirect.html?v=v1.0.124"):window.setTimeout(a.testConnection,
...
-1;a.bothDisabled=!1;a.basicGuestWifiEnabled=!1;a.guestPassWifiEnabled=!1;a.guestWifiEnum={BASIC_GUEST_WIFI:2,GUEST_PASS:3};a.tabsEnum={1:"partials/wireless/guestDevicesTab.html?v=v1.0.124",2:"partials/wireless/basicGuestWifiTab.html?v=v1.0.124",3:"partials/wireless/guestPassWifiTab.html?v=v1.0.124"};a.section=b.current.section;b=c.path();-1!=b.indexOf("/wireless/guestWifiSetup/devices")?a.currentTab=1:-1!=b.indexOf("/wireless/guestWifiSetup/basic")?a.currentTab=2:-1!=b.indexOf("/wireless/guestWifiSetup/pass")?
