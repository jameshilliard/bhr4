  ...
  .service('securityTips', ['$dialog', '$timeout', '$route',
    function ($dialog, $timeout,  $route) {
        ...
        var dialogDefaults = {
            ...
            backdropClick: true,
            dialogFade: true,
            templateUrl: 'partials/tips.html?v=v1.0.149'
        };
        ...
        var dialogDDNSDefaults = {
            ...
            backdropClick: true,
            dialogFade: true,
            templateUrl: 'partials/ddns.html?v=v1.0.149'
        };
        ...
        this.showMessage = function (title, message, buttons) {
          ...
          var msgBox = new $dialog.dialog({
              dialogFade: true,
              templateUrl: 'partials/basemessage.html?v=v1.0.149',
        ...
        this.showWEPMessage = function (title, message, buttons) {
          ...
          var msgBox = new $dialog.dialog({
              dialogFade: true,
              backdropClick: false,
              templateUrl: 'partials/basemessage1.html?v=v1.0.149',
              //templateUrl: 'partials/tips.html',
              controller: 'MessageBoxController',
              resolve:
                {
        ...
        this.showCustomMessage = function (title, message, buttons) {
          ...
          var msgBox = new $dialog.dialog({
              dialogFade: true,
              backdropClick: false,
              templateUrl: 'partials/popmessage.html?v=v1.0.149',
              //templateUrl: 'partials/tips.html',
              controller: 'MessageBoxController',
              resolve:
                {
       ...
       this.showWarningMsgBeforeSaving = function (title, message, btnLabel) {
            ...
            var msgBox = new $dialog.dialog({
                dialogFade: true,
                backdropClick: false,
                templateUrl: 'partials/basemessagewarning.html?v=v1.0.149',
                controller: 'MessageBoxController',
                resolve:
                {
                    model: function () {
       ...
       this.showWarningMsgBeforeSaving1 = function (title, message, btnLabel) {
            ...
            var msgBox = new $dialog.dialog({
                dialogFade: true,
                backdropClick: false,
                templateUrl: 'partials/basemessagewarning1.html?v=v1.0.149',
                controller: 'MessageBoxController',
                resolve:
                {
                    model: function () {
       ...
       this.showDmzSaving = function (title, message) {
         ...
         var msgBox = new $dialog.dialog({
           dialogFade: true,
           backdropClick: false,
           templateUrl: 'partials/basemessage2.html?v=v1.0.149',
           controller: 'MessageBoxController',
           resolve:
             {
               model: function () {
       ...
       this.showDmzSaving1 = function (title, message) {
         ...
         var msgBox = new $dialog.dialog({
           dialogFade: true,
           backdropClick: false,
           templateUrl: 'partials/basemessage3.html?v=v1.0.149',
           controller: 'MessageBoxController',
           resolve:
             {
               model: function () {
       ...
       this.showWarningMsgGuestWifi = function (title, message,confirmationFlag) {
         var templateURL = 'partials/wireless/guestWifiWarningNoConfirmation.html?v=v1.0.149';
         var defaultButtons;
         if(!confirmationFlag.isEmpty && confirmationFlag){
           templateURL = 'partials/wireless/guestWifiWarning.html?v=v1.0.149';
        ...
        this.showCreateGuestWifiPassword = function (title, message, wpa) {
            ...
            var msgBox =  new $dialog.dialog({
                dialogFade: true,
                backdropClick: false,
                templateUrl: 'partials/wireless/basicGuestWifiPopup.html?v=v1.0.149',
        ...
        this.showWirelease24GPrompt = function (title, message) {
            ...
            var msgBox =  new $dialog.dialog({
                dialogFade: true,
                backdropClick: false,
                templateUrl: 'partials/wireless/guestWifiWarningNo24GWireless.html?v=v1.0.149',
                controller: 'MessageBoxController',
                dialogClass: 'modal guest',
                resolve:
                {
        ...
        this.showWireleaseGuestEditPrompt = function (title, message) {
            ...
            var msgBox =  new $dialog.dialog({
                dialogFade: true,
                backdropClick: false,
                templateUrl: 'partials/wireless/guestWifiExitEditMode.html?v=v1.0.149',
                controller: 'MessageBoxController',
                dialogClass: 'modal guest',
                resolve:
                {
        ...
        this.showWarningMsgGuestWifi2 = function (title, message, confirmationFlag) {
          var templateURL = 'partials/wireless/guestWifiWarningMsgsNoConfirmation.html?v=v1.0.149';
          var defaultButtons;
          if(!confirmationFlag.isEmpty && confirmationFlag){
            templateURL = 'partials/wireless/guestWifiWarning.html?v=v1.0.149';
            defaultButtons = [{result:'ok', label: 'OK', cssClass: 'btn'},{result:'cancel', label: 'Cancel', cssClass: 'btn'}];
        ...
        this.showWarningMsgGuestWifi3 = function (title, message,confirmationFlag) {
          ...
          var defaultButtons;
          if(!confirmationFlag.isEmpty && confirmationFlag){
            templateURL = 'partials/wireless/guestWifiWarning2.html?v=v1.0.149';
            defaultButtons = [{result:'ok', label: 'OK', cssClass: 'btn'},{result:'cancel', label: 'Cancel', cssClass: 'btn'}];
          }else{
            defaultButtons = [{result:'ok', label: 'OK', cssClass: 'btn'}];
          }
        ...
        this.showAutoConnectMsgAuth = function (title, message) {
          var templateURL = 'partials/wireless/autoConnectMsgAuth.html?v=v1.0.149';
          var defaultButtons = [{result:'ok', label: 'OK', cssClass: 'btn'},{result:'cancel', label: 'Cancel', cssClass: 'btn'}];
          var msgBox = new $dialog.dialog({
            dialogFade: true,
            backdropClick: false,
        ...
        this.showAutoConnectMsgBasic = function (title, message) {
          var templateURL = 'partials/wireless/autoConnectMsgBasic.html?v=v1.0.149';
          var defaultButtons = [{result:'ok', label: 'OK', cssClass: 'btn'},{result:'cancel', label: 'Cancel', cssClass: 'btn'}];
          var msgBox = new $dialog.dialog({
            dialogFade: true,
            backdropClick: false,
        ...
        this.showAutoConnectMsgBroadcast = function (title, message) {
          var templateURL = 'partials/wireless/autoConnectMsgBroadcast.html?v=v1.0.149';
          var defaultButtons = [{result:'ok', label: 'OK', cssClass: 'btn'},{result:'cancel', label: 'Cancel', cssClass: 'btn'}];
          var msgBox = new $dialog.dialog({
            dialogFade: true,
            backdropClick: false,
        ...
        this.showAutoConnectMsgGuest = function (title, message) {
          var templateURL = 'partials/wireless/autoConnectMsgGuest.html?v=v1.0.149';
          var defaultButtons = [{result:'ok', label: 'OK', cssClass: 'btn'},{result:'cancel', label: 'Cancel', cssClass: 'btn'}];
          var msgBox = new $dialog.dialog({
            dialogFade: true,
            backdropClick: false,
        ...
        this.showNotifyRestartMsg = function (title, message) {
          var templateURL = 'partials/wireless/notifyRestartMsg.html?v=v1.0.149';
          var defaultButtons = [{result:'ok', label: 'OK', cssClass: 'btn'},{result:'cancel', label: 'Cancel', cssClass: 'btn'}];
          var msgBox = new $dialog.dialog({
            dialogFade: true,
            backdropClick: false,
