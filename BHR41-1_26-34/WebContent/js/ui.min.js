...
unescape(a.conn.name)});a.devices=d.query(function(){a.devices=filterOutGuest(a.devices)})};a.keyPress=function(b){13==b.keyCode&&"/advanced/dhcp/connections"==c.path()&&(a.adding||a.showErrorPage?a.adding&&!a.showErrorPage&&a.saveStaticConnection():c.path("/advanced/dhcp"))};a.refresh()}]).controller("fwUpgradeCtrl",["$scope","$route","FirmwareUpgrade","Reboot","SystemSettings","$location","$templateCache","$timeout","securityTips",function(a,b,c,d,e,f,g,h,k){a.tab=b.current.tab;a.section=b.current.section;
a.page=0;a.restarting=!1;a.inputfile=null;a.runFocus=!1;a.fakeTimer=null;a.fakeCount=0;a.fake_percent=0;a.$on("$destroy",function(){clearTimeout(a.fakeTimer)});a.fakeTimerFunction=function(){clearTimeout(a.fakeTimer);a.fakeCount++;60<a.fakeCount&&(a.fakeCount=0);a.fake_percent=a.fakeCount/60*100;a.fake_percent=Math.round(a.fake_percent);a.fakeTimer=window.setTimeout(a.fakeTimerFunction,1E3);a.$apply()};a.refresh=function(){a.stats=c.get()};a.refresh();a.errorPageOk=function(){a.runFocus=!0;a.showErrorPage=
...
function(){c.save({executeRestore:!0});d.save(function(){window.setTimeout(a.testConnection,0)});a.page=3};a.testConnection=function(){e.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),window.location=findCurrentPath()+"/redirect.html?v=v1.0.149"):window.setTimeout(a.testConnection,3E3)})}}]).controller("localAdminCtrl",["$scope","$route","$location","LocalAdmin","SystemSettings",function(a,b,c,d,e){a.tab=b.current.tab;a.section=
b.current.section;a.sysSettings=e.get();a.locAdmin=d.get();a.save=function(){a.locAdmin.$update(function(){c.path("/advanced")})};a.keyPress=function(b){13==b.keyCode&&"/advanced/localadmin"==c.path()&&a.save()}}]).controller("remoteAdminCtrl",["$scope","$route","$routeParams","$location","RemoteAdmin","SystemSettings",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=f.get();a.remAdmin=e.get();a.fromString="?from=ad";b="";a.prev="";a.back="/advanced";a.comingFrom=
"";if(null!=c.from){a.comingFrom=c.from;a.fromString="?from="+c.from+"-ad";a.back="/advanced/settings";c=c.from.split("-");for(e=0;e<c.length-1;e++)0!=e&&(b+="-"),b+=c[e];""!==b&&(a.prev="?from="+b)}else a.back="/advanced";a.save=function(){a.remAdmin.$update(function(){""==a.oldFrom?d.path(a.back).search({}):"settings"==a.comingFrom?location.reload():d.path(a.back).search({from:a.oldFrom})})};a.keyPress=function(b){13==b.keyCode&&"/advanced/remoteadmin"==d.path()&&a.save()}}]).controller("systemSettingsCtrl",
["$scope","$route","$routeParams","$location","SystemSettings","securityTips",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.fromString="?from=settings";a.oldFrom="";a.prev="";a.oldDomainName="";if(null!=c.from){a.fromString="?from="+c.from+"-settings";b=c.from.split("-");"fw"==b[b.length-1]?a.back="/firewall/remoteadmin":"ad"==b[b.length-1]&&(a.back="/advanced/remoteadmin");for(c=0;c<b.length-1;c++)0!=c&&(a.oldFrom+="-"),a.oldFrom+=b[c];""!==a.oldFrom&&
(a.prev="?from="+a.oldFrom)}else a.back="/advanced";a.sysSettings=e.get(function(){a.systemIpAddress=splitIpArr(a.sysSettings.systemRemoteHost);a.securityIpAddress=splitIpArr(a.sysSettings.securityRemoteHost);a.oldDomainName=a.sysSettings.localDomain});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.save=function(){a.errorMessages=[];validateLocalDomains(a.sysSettings.localDomain)||a.errorMessages.push("Domain Name: Name may not contain spaces. Only letters, digits and the special characters dash (-), underscore (_) and dot (.) may be used. These special characters may not appear at the beginning or at the end of a name. The maximum length of a label (text between two dots) is 63");
...
d=moment.unix(moment.utc(moment(d,"YYYY-MM-DD-HH-mm-ss")).unix()-60*(new Date).getTimezoneOffset()-3600*e),f={};f.localTime=d.unix();f.timeZone=a.tempDateObj.timeZone;var f=findTimeNow(f),e=f.format("HH"),f=f.format("mm"),p=!1,z=0,p=0;if(p=Number(e)==Number(b)&&Number(f)==Number(c)?!1:!0)p=4>b&&20<e?Number(b)-Number(e-24):20<b&&4>e?Number(b-24)-Number(e):Number(b)-Number(e),0!=p&&(z=3600*p),p=Number(c)-Number(f),0!=p&&(z+=60*p);a.tempDateObj.localTime=d.unix()+z;a.localTimeMoment=findTimeNow(a.tempDateObj);
...
servers:a.dateTimeSettings.servers},function(){f()})};a.keyPress=function(b){13==b.keyCode&&"/advanced/datetime"==d.path()&&(0!=a.pageToShow||a.showErrorPage?1!=a.pageToShow||a.showErrorPage||a.saveServer():a.save())}}]).controller("configFileCtrl",["$scope","$route","$location","ConfigInfo","Reboot","Login","SystemSettings","$templateCache","$timeout","securityTips",function(a,b,c,d,e,f,g,h,k,n){a.tab=b.current.tab;a.section=b.current.section;a.loadFile=!1;a.completed=!1;a.showErrorPage=!1;a.inputFile=
null;a.restarting=!1;a.isFileSubmitted=!1;window.uploadDone=function(){if(a.isFileSubmitted&&a.loadFile)var b=d.get(function(){b.successful?(e.save(function(){window.setTimeout(a.testConnection,0)}),a.completed=!0):(a.errorMessages=["Configuration File: Bad format of configuration file."],a.showErrorPage=!0)})};a.testConnection=function(){g.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,h.removeAll(),window.location=findCurrentPath()+"/redirect.html?v=v1.0.149"):
window.setTimeout(a.testConnection,3E3)})};a.toggleShow=function(b){k(function(){document.getElementById("submitting").focus()},1E3);a.loadFile=!a.loadFile;0==b&&(a.inputFile=null)};a.errorPageOk=function(){a.showErrorPage=!1;a.loadFile=!1;a.completed=!1;a.isFileSubmitted=!1;window.scrollTo(0,0)};a.submittingFile=function(){a.isFileSubmitted=!0;document.getElementById("submitForm").submit()};a.saving=function(){f.get(function(a){window.location="api/settings/configfile"})};a.loadConfig=function(){document.getElementById("submitting").focus()};
a.setFocus=function(){k(function(){document.getElementById("submitting").focus()},500)};a.keyPress=function(b){13==b.keyCode&&"/advanced/configfile"==c.path()&&(a.loadFile||c.path("/advanced"))}}]).controller("diagnosticsCtrl",["$scope","$route","$rootScope","Diagnostics","$location",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;a.destination="";a.pingCount=4;a.showErrorPage=!1;a.previousPath=c.pre_path;a.isCancelled=!1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,
0)};a.refresh=function(){var b=d.get(function(){a.destination=b.destination;a.pingCount=b.count;a.total=b.count;a.status=b.running?1:0;a.testRan=!0;null==b.transmitted?b.running?window.setTimeout(a.refresh,1E3):a.testRan=!1:(a.sent=b.transmitted,a.received=b.received,0==a.received&&0==a.sent&&0==a.status&&(a.status=5),0==a.status&&a.sent!=a.total&&(a.status=4),0==a.status&&a.sent==a.total&&a.received!=a.sent&&(a.status=2),a.loss=0<a.sent?Math.floor((a.sent-a.received)/a.sent*100):0,a.isCancelled&&
(a.status=4),0<a.received?(a.min=b.min.toFixed(2),a.max=b.max.toFixed(2),a.average=b.average.toFixed(2),a.hasResults=!0):a.hasResults=!1,1==a.status&&b.transmitted!=b.count&&window.setTimeout(a.refresh,1E3))})};a.goButton=function(){a.isCancelled=!1;a.errorMessages=[];var b=a.destination.split("."),c=!1;(c=validateIp(b))||(c=validateIPv6(a.destination));b=validateGivenHostName(a.destination);c||b||a.errorMessages.push("Server Address: The value must be a valid IP address or a valid domain name.");
(isNaN(a.pingCount)||1>a.pingCount||999<a.pingCount)&&a.errorMessages.push("Number of pings: Please enter a numeric value between 1 and 999.");0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.status=-1,a.total=4,a.sent=0,a.received=0,a.loss=0,a.hasResults=!1,d.save({destination:a.destination,count:parseInt(a.pingCount)},function(){a.status=-1;a.refresh()}))};a.cancel=function(){a.isCancelled=!0;d.remove({})};a.keyPress=function(b){13==b.keyCode&&"/advanced/diagnostics"==e.path()&&
a.goButton()};a.refresh()}]).controller("defaultsCtrl",["$scope","$route","Defaults","Login","Reboot","SystemSettings","$location","$templateCache","securityTips",function(a,b,c,d,e,f,g,h,k){a.tab=b.current.tab;a.section=b.current.section;a.restDefaults=0;a.resetType=0;a.restarting=!1;a.defaults=function(){a.restDefaults=1};a.cancel=function(){a.restDefaults=0};a.restoreDefaults=function(){a.restDefaults=2;c.save({resetType:parseInt(a.resetType)},function(){e.save(function(){window.setTimeout(a.testConnection,
0)})})};a.saving=function(){d.get(function(a){window.location="api/settings/configfile"})};a.testConnection=function(){f.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,h.removeAll(),window.location=0==a.resetType?findCurrentPath()+"/redirectSetup.html?v=v1.0.149":findCurrentPath()+"/redirect.html?v=v1.0.149"):window.setTimeout(a.testConnection,3E3)})}}]).controller("rebootCtrl",["$scope","$route","Reboot","SystemSettings","Login",
"$location","$templateCache","securityTips",function(a,b,c,d,e,f,g,h){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=d.get();a.rebooting=!1;a.restarting=!1;a.reboot=function(){a.rebooting=!0;c.save(function(){window.setTimeout(a.testConnection,0)})};a.testConnection=function(){d.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),window.location=findCurrentPath()+"/redirect.html?v=v1.0.149"):window.setTimeout(a.testConnection,
3E3)})};a.keyPress=function(b){13==b.keyCode&&"/advanced/reboot"==f.path()&&a.reboot()}}]).controller("macCloningCtrl",["$scope","$route","$location","MacCloning",function(a,b,c,d){a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.macCloning=d.get(function(){a.macAddress=splitMacArr(a.macCloning.mac)});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.save=function(){a.errorMessages=[];a.macCloning.mac=getMacString(a.macAddress);if(!validateMac(a.macCloning.mac))a.errorMessages=
...
0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):a.macCloning.$update(function(){c.path("/advanced")})};a.restore=function(){a.macAddress=splitMacArr(a.macCloning.defaultMac)};a.keyPress=function(b){13==b.keyCode&&"/advanced/maccloning"==c.path()&&a.save()}}]).controller("usersCtrl",["$scope","$route","$routeParams","$location","Users","SystemSettings",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=f.get();a.updateContent=function(){a.userObj=
e.get(function(){a.user=a.userObj.users[0];a.userObj.users[0].fullName=unescape(a.userObj.users[0].fullName);null!=c.edit&&a.edit(0)})};a.updateContent();a.pageToShow=0;a.editing=-1;a.showErrorPage=!1;a.setPassword=!1;a.showPassword=!1;a.userObjs=null;a.newPass=!1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.save=function(){a.errorMessages=[];var b=Number(a.userObj.maxLoginAttempts);(isNaN(b)||1>b||99<b)&&a.errorMessages.push("Maximum Unsuccessful Login Attempts: Please enter a numeric value between 1 and 99.");
0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):e.update({maxLoginAttempts:b},function(){void 0!=window?window.location.reload(!0):location.reload(!0)})};a.togglePage=function(b){0==b?null!=c.frommain?d.url(d.path("/main")):(a.pageToShow=b,a.updateContent()):a.pageToShow=b;window.scrollTo(0,0)};a.edit=function(b){a.newName=a.userObj.users[0].fullName;a.newPassword="";a.rtNewPassword="";a.setPassword=!1;a.editing=b;a.togglePage(1)};a.saveUserCfm=function(){e.update({users:[a.userObjs]},
function(){a.userObj.users[0].fullName=unescape(a.userObj.users[0].fullName);a.newPass?d.path("/logout"):a.togglePage(0)})};a.saveUser=function(){a.userObjs={id:0};a.errorMessages=[];""==a.newName&&a.errorMessages.push("Full Name: A string must be specified.");a.newPass=!1;a.setPassword&&(0==a.newPassword.length&&0==a.rtNewPassword.length&&a.errorMessages.push("New Password: A password must be specified."),a.newPassword!=a.rtNewPassword&&a.errorMessages.push("Incorrect New Password: Entered passwords mismatch."),
0==a.errorMessages.length&&(a.user.password=a.newPassword),a.userObjs.salt=uuid(),a.userObjs.password=CryptoJS.SHA512(a.newPassword+a.userObjs.salt).toString(),a.newPass=!0);0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.userObjs.fullName=escape(a.newName).replace(/\+/g,"%2B"),a.newPass?!0==a.sysSettings.warnBeforeChanges?a.togglePage(2):a.saveUserCfm():a.saveUserCfm())};a.keyPress=function(b){13==b.keyCode&&"/advanced/users"==d.path()&&(1!=a.pageToShow||a.showErrorPage?a.save():
a.saveUser())}}]).controller("schedulerCtrl",["$scope","$route","Schedules","DateTimeSettings","$location","AccessControl","PortForward",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;a.runFocus=!1;init_schedules(a);a.pageToShow=0;a.editing=!1;a.showErrorPage=!1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.save=function(){a.schedules.$update(function(){void 0!=window?window.location.reload(!0):location.reload(!0)})};a.refresh=function(){a.schedules=
c.query(function(){for(var b=0;b<a.schedules.length;b++)a.schedules[b].name=unescape(a.schedules[b].name);a.printSchedArr=[];printSchedule(0,a.schedules,a.printSchedArr);a.dateTimeSettings=d.get(function(){a.localTimeMoment=findTimeNow(a.dateTimeSettings);for(var b=0;b<a.schedules.length;b++)a.schedules[b].status=isScheduleActive(a.schedules[b],a.localTimeMoment)})})};a.refresh();a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.removeSchedule=function(b){var c=!1;a.toDeleteIndex=b;
a.portForward=g.query(function(){a.accessControl=f.query(function(){for(var b=0;b<a.accessControl.length;b++)if(null!=a.accessControl[b].schedule&&unescape(a.accessControl[b].schedule.name)==a.schedules[a.toDeleteIndex].name){c=!0;break}for(b=0;b<a.portForward.length;b++)if(null!=a.portForward[b].schedule&&unescape(a.portForward[b].schedule)==a.schedules[a.toDeleteIndex].name){c=!0;break}c?a.togglePage(8):a.removeScheduleNow(a.toDeleteIndex)})})};a.updateAccessControlBeforeRemove=function(){var b=
!0;a.portForward=g.query(function(){a.accessControl=f.query(function(){for(var c=0;c<a.accessControl.length;c++)if(null!=a.accessControl[c].schedule&&unescape(a.accessControl[c].schedule.name)==a.schedules[a.toDeleteIndex].name){a.accessControl[c].schedule="";a.accessControl[c].schedule1={};f.update({id:a.accessControl[c].id},a.accessControl[c],function(){a.updateAccessControlBeforeRemove()});b=!1;break}if(b)for(c=0;c<a.portForward.length;c++)if(null!=a.portForward[c].schedule&&unescape(a.portForward[c].schedule)==
a.schedules[a.toDeleteIndex].name){a.portForward[c].schedule="Always";g.remove({id:a.portForward[c].id},function(){a.portForward[c].id="";g.save(a.portForward[c],function(){a.updateAccessControlBeforeRemove()})});b=!1;break}b&&a.removeScheduleNow(a.toDeleteIndex)})})};a.removeScheduleNow=function(b){c.remove({id:a.schedules[b].id},function(){a.togglePage(0);a.refresh()})};a.applyRuleScheduler=function(){a.errorMessages=[];""===a.schedule.name&&a.errorMessages.push("Description: A string must be specified.");
for(var b=0;b<a.schedules.length;b++)if(b!=a.editingRuleSchedule&&a.schedules[b].name==a.schedule.name){a.errorMessages.push("Name: This name is already used by another scheduler rule.");break}0==a.schedule.timeSegments.length&&a.errorMessages.push("Rule Schedule: At least one time segment should be defined.");if(0<a.errorMessages.length)a.showErrorPage=!0,window.scrollTo(0,0);else{var d={};copySchedule(d,a.schedule);for(b=0;b<d.timeSegments.length;b++)for(var e=0;e<d.timeSegments[b].hourRanges.length;e++)d.timeSegments[b].hourRanges[e].startTimeHour=
parseInt(d.timeSegments[b].hourRanges[e].startTimeHour),d.timeSegments[b].hourRanges[e].startTimeMinute=parseInt(d.timeSegments[b].hourRanges[e].startTimeMinute),d.timeSegments[b].hourRanges[e].endTimeHour=parseInt(d.timeSegments[b].hourRanges[e].endTimeHour),d.timeSegments[b].hourRanges[e].endTimeMinute=parseInt(d.timeSegments[b].hourRanges[e].endTimeMinute);d.name=escape(a.schedule.name).replace(/\+/g,"%2B");-1==a.editingRuleSchedule?c.save(d,function(){a.refresh()}):(d.id=a.schedules[a.editingRuleSchedule].id,
c.update(d,function(){a.refresh()}));a.togglePage(0);init_schedules(a)}};a.formatTimeString=function(a,b){return(10>a?"0"+a:a)+":"+(10>b?"0"+b:b)};a.applyTimeSegment=function(){a.errorMessages=[];for(var b=!1,c=0;c<a.daysOfTheWeek.length;c++)a.daysOfTheWeek[c]&&(b=!0);b||a.errorMessages.push("Days of Week: At least one day must be selected.");0==a.hourRanges.length&&a.errorMessages.push("Hours Range: At least one hour range must be set.");0<a.errorMessages.length?a.showErrorPage=!0:applyTimeSegment(a);
window.scrollTo(0,0)};a.applyHourRange=function(){a.runFocus=!0;a.errorMessages=[];var b=a.hourRange.startTimeHour,c=a.hourRange.endTimeHour,d=a.hourRange.startTimeMinute,e=a.hourRange.endTimeMinute;(""===b||isNaN(b)||0>b||23<b||!checksForWholeNumber(b))&&a.errorMessages.push("Start Time Hour: Please enter a numeric value between 0 and 23.");(""===c||isNaN(c)||0>c||23<c||!checksForWholeNumber(c))&&a.errorMessages.push("End Time Hour: Please enter a numeric value between 0 and 23.");(""===d||isNaN(d)||
0>d||59<d||!checksForWholeNumber(d))&&a.errorMessages.push("Start Time Minutes: Please enter a numeric value between 0 and 59.");(""===e||isNaN(e)||0>e||59<e||!checksForWholeNumber(e))&&a.errorMessages.push("End Time Minutes: Please enter a numeric value between 0 and 59.");0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.hourRange.startTimeHour=parseInt(a.hourRange.startTimeHour),a.hourRange.startTimeMinute=parseInt(a.hourRange.startTimeMinute),a.hourRange.endTimeHour=parseInt(a.hourRange.endTimeHour),
a.hourRange.endTimeMinute=parseInt(a.hourRange.endTimeMinute),applyHourRange(a))};a.cancelRuleScheduler=function(){cancelRuleScheduler(a)};a.cancelTimeSegment=function(){cancelTimeSegment(a)};a.cancelHourRange=function(){cancelHourRange(a)};a.editSchedule=function(b){editRuleScheduler(a,a.schedules,b)};a.editTimeSegment=function(b){editTimeSegment(a,b)};a.editHourRange=function(b){editHourRange(a,b)};a.removeTimeSegment=function(b){removeObject(a.schedule.timeSegments,b)};a.removeHourRange=function(b){removeObject(a.hourRanges,
b)};a.keyPress=function(b){13==b.keyCode&&"/advanced/scheduler"==e.path()&&(0==a.pageToShow?e.path("/advanced"):5!=a.pageToShow||a.showErrorPage?6!=a.pageToShow||a.showErrorPage?7!=a.pageToShow||a.showErrorPage||a.applyHourRange():a.applyTimeSegment():a.applyRuleScheduler())}}]).controller("networkObjectCtrl",["$scope","$route","NetworkObjects","Devices","$location","AccessControl",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.runFocus=!1;a.networkObjects=c.query(function(){for(var b=
0;b<a.networkObjects.length;b++)a.networkObjects[b].name=unescape(a.networkObjects[b].name);a.printAddArr=[];printAddresses(1,a.networkObjects,a.printAddArr)});init_networkObjs(a);a.pageToShow=0;a.editing=-1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.togglePage=function(b){a.pageToShow=b};a.addNetworkObject=function(){init_networkObjs(a);a.togglePage(1);a.editing=-1};a.loadDeviceData=function(b){a.devices=d.query();a.macSelect=-1;a.togglePage(2)};a.copyMacAddress=function(){var b=
macSelecter.value;a.rule.mac=-1!=b?splitMacArr(a.devices[b].mac):splitMacArr("00:00:00:00:00:00");a.rule.macMask=splitMacArr("ff:ff:ff:ff:ff:ff")};a.applyNetworkObj=function(){a.errorMessages=[];if(""===a.networkObj.name)a.errorMessages.push("Description: A string must be specified.");else for(var b=0;b<a.networkObjects.length;b++)a.editingNetworkObj!=b&&a.networkObj.name===a.networkObjects[b].name&&a.errorMessages.push("Description: This name is already used by another network object.");0==a.networkObj.rules.length&&
a.errorMessages.push("Items: At least one item entry must be defined.");0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(b={},copyNetworkObj(b,a.networkObj),a.networkObj.name=escape(a.networkObj.name),-1==a.editingNetworkObj?c.save(b,function(){a.networkObjects=c.query(function(){a.printAddArr=[];printAddresses(1,a.networkObjects,a.printAddArr)})}):c.update({id:a.networkObjects[a.editing].id},b,function(){a.networkObjects=c.query(function(){a.printAddArr=[];printAddresses(1,a.networkObjects,
a.printAddArr)})}),a.togglePage(0),init_schedules(a))};a.applyAddress=function(){a.runFocus=!0;applyAddressCheck(a);0==a.errorMessages&&applyAddress(a)};a.cancelNetworkObj=function(){cancelNetworkObj(a);a.editing=-1};a.cancelAddress=function(){cancelAddress(a)};a.editNetworkObj=function(b){editNetworkObj(a,a.networkObjects,b);a.editing=b};a.editAddress=function(b){editAddress(a,b)};a.removeNetworkObj=function(b){var d=!0;a.accessControl=f.query(function(){for(var e=0;e<a.accessControl.length;e++)if(null!=
a.accessControl[e].networkObjects)for(var f=0;f<a.accessControl[e].networkObjects.length;f++)if(a.accessControl[e].networkObjects[f].id==a.networkObjects[b].id){d=!1;break}d?c.remove({id:a.networkObjects[b].id},function(){a.networkObjects=c.query(function(){a.printAddArr=[];printAddresses(1,a.networkObjects,a.printAddArr)})}):(a.errorMessages=[],a.errorMessages.push("Network Object: Network object is in use."),a.showErrorPage=!0,window.scrollTo(0,0))})};a.removeAddress=function(b){removeObject(a.networkObj.rules,
b)};a.keyPress=function(b){13==b.keyCode&&"/advanced/networkobjects"==e.path()&&(0!=a.pageToShow||a.showErrorPage?1!=a.pageToShow&&2!=a.pageToShow||a.showErrorPage||(2==a.pageToShow?a.applyAddress():a.applyNetworkObj()):e.path("/advanced"))}}]).controller("portForwardRuleCtrl",["$scope","$route","PortForwardRules","StaticNAT","PortForward","$location",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.runFocus=!1;init_services(a);a.tempPortForward={name:"Global Application",
description:"",servType:1,protocols:[]};a.pageToShow=0;a.editing=-1;a.showBasic=!1;a.togglePage=function(b){a.runFocus=!0;a.pageToShow=b;window.scrollTo(0,0)};a.toggleBasic=function(){a.showBasic=!a.showBasic;window.scrollTo(0,0)};a.refresh=function(){a.nat=d.query();a.forwards=e.query();a.portForwardRules=c.query(function(){a.portForwardRules=sortListItems(a.portForwardRules);a.printProtArr=[];printProtocol(1,a.portForwardRules,a.printProtArr)})};a.refresh();a.errorPageOk=function(){a.showErrorPage=
!1;window.scrollTo(0,0)};a.applyPortForwardRule=function(){a.errorMessages=[];""==a.tempPortForward.name?a.errorMessages.push("Service Name: A name must be specified."):/^[0-9A-Z\!\-\_]+$/i.test(a.tempPortForward.name)||a.errorMessages.push('Service Name: Rule name should consist of standard characters only (ASCII 32-126) excluding the special character space and any of :@"|\\/=+<>()[]{}&%^$*?,;');for(var b=0;b<a.portForwardRules.length;b++)b!=a.editing&&a.portForwardRules[b].name==a.tempPortForward.name&&
a.errorMessages.push("Service Name: This name is already used by another protocol.");0==a.tempPortForward.protocols.length&&a.errorMessages.push("Server Ports: At least one server ports entry must be defined.");if(0<a.errorMessages.length)a.showErrorPage=!0,window.scrollTo(0,0);else{var d={};d.name=escape(a.tempPortForward.name).replace(/\+/g,"%2B");d.description=escape(a.tempPortForward.description).replace(/\+/g,"%2B");d.servType=a.tempPortForward.servType;d.protocols=[];for(b=0;b<a.tempPortForward.protocols.length;b++){var e=
{};copyProtocol(e,a.tempPortForward.protocols[b]);d.protocols.push(e)}-1==a.editing?c.save(d,function(){a.refresh()}):c.update({id:a.portForwardRules[a.editing].id},d,function(){a.refresh()});init_services(a);a.tempPortForward={name:"Global Application",description:"",servType:1,protocols:[]};a.editing=-1;a.togglePage(0)}};a.applyProtocol=function(){a.errorMessages=[];a.protocols.protocol=parseInt(a.protocols.protocol);a.protocols.incomingPorts=parseInt(a.protocols.incomingPorts);a.protocols.outgoingPorts=
parseInt(a.protocols.outgoingPorts);a.protocols.icmpMessage=parseInt(a.protocols.icmpMessage);var b=a.protocols.incomingPortStart,c=a.protocols.incomingPortEnd,d=a.protocols.outgoingPortStart,e=a.protocols.outgoingPortEnd;switch(a.protocols.protocol){case 0:var f=a.protocols.protocolNumber;(null==f||""===f||isNaN(f)||0>f||255<f||isNotaInt(f)||!checksForWholeNumber(f))&&a.errorMessages.push("Protocol Number: Please enter a numeric value between 0 and 255.");break;case 1:case 2:switch(a.protocols.incomingPorts){case 1:(null==
b||""===b||1>b||65535<b||isNotaInt(b))&&a.errorMessages.push("Source Port: Please enter a numeric value between 1 and 65535.");break;case 2:(null==b||""===b||1>b||65535<b||isNotaInt(b))&&a.errorMessages.push("Start Source Port: Please enter a numeric value between 1 and 65535."),(null==c||""===c||1>c||65535<c||isNotaInt(c))&&a.errorMessages.push("End Source Port: Please enter a numeric value between 1 and 65535."),0==a.errorMessages.length&&b>=c&&a.errorMessages.push("Source Ports: The From value must be lower than the To value in a range of ports (from="+
b+", to="+c+").")}switch(a.protocols.outgoingPorts){case 1:(null==d||""===d||1>d||65535<d||isNotaInt(d))&&a.errorMessages.push("Destination Port: Please enter a numeric value between 1 and 65535.");4567==d&&!1==a.protocols.outgoingExclude&&1==a.protocols.protocol&&a.errorMessages.push("Invalid rule: Port 4567 cannot be blocked");break;case 2:(null==d||""===d||1>d||65535<d||isNotaInt(d))&&a.errorMessages.push("Start Destination Port: Please enter a numeric value between 1 and 65535."),(null==e||""===
e||1>e||65535<e||isNotaInt(e))&&a.errorMessages.push("End Destination Port: Please enter a numeric value between 1 and 65535."),0==a.errorMessages.length&&d>=e&&a.errorMessages.push("Destination Ports: The From value must be lower than the To value in a range of ports (from="+d+", to="+e+").")}break;case 3:if(10==a.protocols.icmpMessage){var f=a.protocols.icmpType,p=a.protocols.icmpCode;(null==f||""===f||0>f||255<f||isNotaInt(f))&&a.errorMessages.push("ICMP Type:  Please enter a numeric value between 0 and 255.");
(null==p||""===p||0>p||255<p||isNotaInt(p))&&a.errorMessages.push("ICMP Code:  Please enter a numeric value between 0 and 255.")}}0==a.errorMessages.length&&(0==a.protocols.incomingPorts&&(a.protocols.incomingExclude=!1),0==a.protocols.outgoingPorts&&(a.protocols.outgoingExclude=!1),1==a.protocols.protocol||2==a.protocols.protocol)&&(p=f=!1,0==a.protocols.incomingPorts?f=!0:2==a.protocols.incomingPorts&&!1==a.protocols.incomingExclude&&1==b&&65535==c&&(f=!0),0==a.protocols.outgoingPorts?p=!0:2==a.protocols.outgoingPorts&&
!1==a.protocols.outgoingExclude&&1==d&&65535==e&&(p=!0),f&&p&&a.errorMessages.push('Port forwarding rules can not be Any-to-Any (or "source: 1-65535" with "destination: 1-65535").'));0==a.errorMessages.length&&(b=getTempObjectContent(a.protocols),a.errorMessages=compareNewCondAndCurrentList(a.tempPortForward.protocols,b,a.editingProtocol));0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.protocols.protocolNumber=parseInt(a.protocols.protocolNumber),a.protocols.icmpType=parseInt(a.protocols.icmpType),
a.protocols.icmpCode=parseInt(a.protocols.icmpCode),applyProtocol(a,a.tempPortForward.protocols),printProtocol(2,a.tempPortForward.protocols,a.printPortsArr))};a.cancelPortForwardRule=function(){cancelService(a);a.tempPortForward={name:"Global Application",description:"",protocols:[]}};a.cancelProtocol=function(){cancelProtocol(a)};a.editPortForwardRule=function(b){a.tempPortForward.name=a.portForwardRules[b].name;a.tempPortForward.description=a.portForwardRules[b].description;a.tempPortForward.servType=
a.portForwardRules[b].servType;a.tempPortForward.protocols=[];for(var c=0;c<a.portForwardRules[b].protocols.length;c++){var d={};copyProtocol(d,a.portForwardRules[b].protocols[c]);a.tempPortForward.protocols.push(d)}a.printPortsArr=[];printProtocol(2,a.tempPortForward.protocols,a.printPortsArr);a.editing=b;a.togglePage(3)};a.editProtocol=function(b){editProtocol(a,b,a.tempPortForward.protocols)};a.removePortForwardRule=function(b){a.errorMessages=[];for(var d=a.portForwardRules[b].name,e=0;e<a.nat.length;e++)for(var f=
0;f<a.nat[e].services.length;f++)if(d===a.nat[e].services[f].name){a.errorMessages.push("Protocol: Protocol is in use.");break}if(0==a.errorMessages.length)for(e=0;e<a.forwards.length;e++)for(f=0;f<a.forwards[e].protocols.length;f++)if(d===a.forwards[e].name){a.errorMessages.push("Protocol: Protocol is in use.");break}0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):c.remove({id:a.portForwardRules[b].id},function(){a.portForwardRules=c.query(function(){a.portForwardRules=sortListItems(a.portForwardRules);
a.printProtArr=[];printProtocol(1,a.portForwardRules,a.printProtArr)})})};a.removeProtocol=function(b){removeObject(a.tempPortForward.protocols,b);a.printPortsArr=[];printProtocol(2,a.tempPortForward.protocols,a.printPortsArr)};a.keyPress=function(b){13==b.keyCode&&"/advanced/portforward"==f.path()&&(0!=a.pageToShow||a.showErrorPage?3!=a.pageToShow||a.showErrorPage?4!=a.pageToShow||a.showErrorPage||a.applyProtocol():a.applyPortForwardRule():f.path("/advanced"))}}]).controller("dnsServerCtrl",["$scope",
"$route","DnsServer","securityTips","$location",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;a.dnsServer=c.query();a.showErrorPage=!1;a.showAdd=!1;a.editing=-1;a.runFocus=!1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.validateBeforeSave=function(){a.errorMessages=[];validateHostnameDNSServer(a.tempDnsServer.hostname)||a.errorMessages.push("Host Name: Name may not contain spaces. Only letters, digits and the special characters dash (-), underscore (_) and dot (.) may be used. These special characters may not appear at the beginning or at the end of a name. The maximum length of a label (text between two dots) is 63.");
validateIp(a.tempDnsServer.ipAddress)?"0.0.0.0"===getIpString(a.tempDnsServer.ipAddress)?a.errorMessages.push("IP Address: IP address may not be 0.0.0.0. IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces. At least one of the values must be greater than 0."):("255.255.255.255"===getIpString(a.tempDnsServer.ipAddress)||224<=Number(a.tempDnsServer.ipAddress[0])&&239>=Number(a.tempDnsServer.ipAddress[0]))&&a.errorMessages.push("Invalid IP address."):
a.errorMessages.push("IP Address: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces.");for(var b=0;b<a.dnsServer.length;b++)a.editing!=b&&a.tempDnsServer.hostname==a.dnsServer[b].hostname&&a.errorMessages.push("Host Name: This name is already used by another DNS object.");0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):a.save()};a.save=function(){var b={hostname:a.tempDnsServer.hostname,type:a.tempDnsServer.type};1==b.type&&(b.ipAddress=
getIpString(a.tempDnsServer.ipAddress));-1==a.editing?c.save(b,function(){a.dnsServer=c.query()}):c.update({id:a.dnsServer[a.editing].id},b,function(){a.dnsServer=c.query()});a.tempDnsServer={};a.toggleShow()};a.toggleShow=function(){a.showAdd=!a.showAdd};a.addDnsEntry=function(){a.tempDnsServer={hostname:"new-host",type:1,ipAddress:[0,0,0,0]};a.runFocus=!0;a.editing=-1;a.toggleShow()};a.editDnsEntry=function(b){a.editing=b;a.tempDnsServer={hostname:a.dnsServer[a.editing].hostname,type:a.dnsServer[a.editing].type};
1==a.tempDnsServer.type&&(a.tempDnsServer.ipAddress=splitIpArr(a.dnsServer[a.editing].ipAddress));a.showAdd=!a.showAdd};a.removeDnsEntry=function(b){c.remove({id:a.dnsServer[b].id},function(){a.dnsServer=c.query()})};a.keyPress=function(b){13==b.keyCode&&"/advanced/dnsserver"==e.path()&&(a.showAdd?a.showAdd&&!a.showErrorPage&&a.validateBeforeSave():e.path("/advanced"))}}]).controller("ipv6Ctrl",["$scope","$route","$location","IPv6",function(a,b,c,d){a.tab=b.current.tab;a.section=b.current.section;
a.ipv6=d.get(function(){a.ipv6.addressStart=a.ipv6.addressStart.toString(16);a.ipv6.addressEnd=a.ipv6.addressEnd.toString(16);for(var b=0;b<a.ipv6.interfaces.length;b++)a.ipv6.interfaces[b].name=unescape(a.ipv6.interfaces[b].name);a.autoDns=1==a.ipv6.mode?a.ipv6.autoDns:0});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.save=function(){if(a.ipv6.enabled){a.errorMessages=[];a.ipv6.autoDns=a.autoDns;if(2==a.ipv6.mode)if(a.ipv6.staticAddress=a.ipv6.staticAddress.replace(/^\s+|\s+$/g,
...
a.errorMessages.push("Metric: Please enter a numeric value between 0 and 255.");"0.0.0.0"==getIpString(a.routeEditing.gateway)&&a.errorMessages.push("Gateway: IP Address may not be 0.0.0.0.");validateIp(a.routeEditing.gateway)||a.errorMessages.push("Gateway : IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces.");for(var b=!0,c=!1,e=0;4>e;e++){for(var f=7;-1<f;f--){var q=1==(a.routeEditing.netmask[e]>>f&1);if(q&&c){b=!1;break}q||(c=!0)}if(!b)break}b||
...
return b};a.getDeviceIp=function(b,c){for(var d=0;d<a.devices.length;d++)if(b==a.devices[d].name&&c===a.devices[d].ipAddress)return a.devices[d].ipAddress;return b};a.netObjsIPArr=[];a.showNetObj=[];a.netObjsArr=[];a.refresh=function(){a.active=[];a.dateTimeSettings=q.get(function(){a.localTimeMoment=findTimeNow(a.dateTimeSettings);a.devices=h.query(function(){a.devices=filterOutGuest(a.devices);a.accessControl=c.query(function(){a.netObjs=d.query(function(){a.netObjsIPArr=[];a.showNetObj=[];a.netObjsArr=
...
a.editHourRange=function(b){editHourRange(a,b)};a.removeHourRange=function(b){removeObject(a.hourRanges,b)};a.formatTimeString=function(a,b){return(10>a?"0"+a:a)+":"+(10>b?"0"+b:b)};a.keyPress=function(b){13==b.keyCode&&"/firewall/accesscontrol"==n.path()&&(a.showAdd&&0==a.pageToShow&&!a.isSame?a.applyMain():8!=a.pageToShow||a.showErrorPage?1!=a.pageToShow&&2!=a.pageToShow||a.showErrorPage?5!=a.pageToShow&&6!=a.pageToShow&&7!=a.pageToShow||a.showErrorPage?3!=a.pageToShow||a.showErrorPage?4!=a.pageToShow||
...
a.contains=function(a,b){for(var c=0;c<a.length;c++)if(a[c]===b)return!0;return!1};a.refresh=function(){a.portForward=c.query(function(){a.numItems=a.portForward.length;a.printPortsArr=[];printProtocol(1,a.portForward,a.printPortsArr);a.active=[];for(var b=0;b<a.portForward.length;b++)if(a.active.push(a.portForward[b].enabled),/^PortForward\_.*$/.test(a.portForward[b].name)){a.portForward[b].displayName="Destination Ports ";for(var c=[],h=0;h<a.portForward[b].protocols.length;h++){var p=a.portForward[b].protocols[h];
if(1==p.outgoingPorts){if(a.contains(c,p.outgoingPortStart))continue}else if(2==p.outgoingPorts&&a.contains(c,p.outgoingPortStart+"-"+p.outgoingPortEnd))continue;0<h&&(a.portForward[b].displayName+=",");0==p.outgoingPorts?a.portForward[b].displayName+="Any":1==p.outgoingPorts?(a.portForward[b].displayName+=p.outgoingPortStart,c.push(p.outgoingPortStart)):(a.portForward[b].displayName+=p.outgoingPortStart+"-"+p.outgoingPortEnd,c.push(p.outgoingPortStart+"-"+p.outgoingPortEnd))}}else a.portForward[b].displayName=
...
a.pf.protocol.protocol=parseInt(a.pf.protocol.protocol);var b=[],d=[],e=[],g=0,f=0,h=65535,r=0,y=0,w=65535;if(-2==a.appToForward)a.errorMessages.push("Error: Please select a pre-configured application or choose the option Custom ports to create a new appliction for port forwarding");else if(-1==a.appToForward)if(!a.showAdvanced&&0==a.errorMessages.length)for(var s=(""+a.pf.protocol.outgoingPortStart).split(","),u=0;u<s.length;u++){var m=s[u].split("-");if(2<m.length)a.errorMessages.push("Error: The input of port has illegal characters. Source port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on.");
else for(var l=0;l<m.length;l++)""===m[l]||isNaN(m[l])||checkForWholeNumbers(m[l])||!checksForWholeNumber(m[l])?a.errorMessages.push("Error: The input of port has illegal characters. Source port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on."):(1>m[l]||65535<m[l])&&a.errorMessages.push("Error: Port range should be between [1-65535]");1==m.length?(r=1,y=w=parseInt(m[0])):2==m.length&&(r=2,y=parseInt(m[0]),w=parseInt(m[1]));b.push(r);d.push(y);e.push(w)}else if(0==
a.errorMessages.length){if(1==a.sourcePortType){m=(""+a.pf.incomingPortStart).split("-");if(2<m.length)a.errorMessages.push("Error: The input of port has illegal characters. Source port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on.");else for(l=0;l<m.length;l++)""===m[l]||isNaN(m[l])||checkForWholeNumbers(m[l])||!checksForWholeNumber(m[l])?a.errorMessages.push("Error: The input of port has illegal characters. Source port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on."):
(1>m[l]||65535<m[l])&&a.errorMessages.push("Error: Port range should be between [1-65535]");1==m.length?(g=1,f=h=parseInt(m[0])):2==m.length&&(g=2,f=parseInt(m[0]),h=parseInt(m[1]))}if(1==a.destPortType&&0==a.errorMessages.length)for(s=(""+a.pf.outgoingPortStart).split(","),u=0;u<s.length;u++){m=s[u].split("-");if(2<m.length)a.errorMessages.push("Error: The input of port has illegal characters. Destination port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on.");
else for(l=0;l<m.length;l++)""===m[l]||isNaN(m[l])||checkForWholeNumbers(m[l])||!checksForWholeNumber(m[l])?a.errorMessages.push("Error: The input of port has illegal characters. Destination port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on."):(1>m[l]||65535<m[l])&&a.errorMessages.push("Error: Port range should be between [1-65535]");1==m.length?(r=1,y=w=parseInt(m[0])):2==m.length&&(r=2,y=parseInt(m[0]),w=parseInt(m[1]));b.push(r);d.push(y);e.push(w)}}a.showAdvanced&&
1==a.pf.servicePortType&&0==a.errorMessages.length&&(""===a.pf.servicePort||isNaN(a.pf.servicePort)||0>a.pf.servicePort||65535<a.pf.servicePort||!checksForWholeNumber(a.pf.servicePort))&&a.errorMessages.push("Forward to Port: Please enter a numeric value between 0 and 65535.");0==b.length&&(b.push(r),d.push(y),e.push(w));0==a.errorMessages.length&&-1==a.appToForward&&(r=s=!1,!0==a.showAdvanced?0==a.sourcePortType?s=!0:1==a.sourcePortType&&(l=(""+a.pf.incomingPortStart).split("-"),2==l.length&&1==
...
a.appToForward){u=a.pfRules[l];break}if(null==u)return;for(l=0;l<u.protocols.length;l++)if(!u.protocols[l].protocolExclude&&!u.protocols[l].outgoingExclude){var r=u.protocols[l].outgoingPortStart,w=u.protocols[l].outgoingPortEnd,y=u.name,x=r,s=u.protocols[l].protocol,B=!1;void 0!==w&&r!=w&&(x+="-"+w);void 0===w&&(w=r);for(x=0;x<a.portForward.length;x++)for(m=0;m<a.portForward[x].protocols.length;m++){var t=a.portForward[x].protocols[m];if(7!=s||!(1>t.protocol||2<t.protocol))if(7==s||s==t.protocol){void 0!=
r||s!=t.protocol||0!=s&&3!=s&&4!=s&&5!=s&&6!=s||(B=!0);var A="";if(0==t.outgoingPorts)A="Any";else if(1==t.outgoingPorts&&r<=t.outgoingPortStart&&w>=t.outgoingPortStart)A=t.outgoingPortStart;else if(2==t.outgoingPorts&&r<=t.outgoingPortStart&&w>=t.outgoingPortStart||r<=t.outgoingPortEnd&&w>=t.outgoingPortEnd||r>=t.outgoingPortStart&&w<=t.outgoingPortEnd)A=t.outgoingPortStart+" -> "+t.outgoingPortEnd;if(""!=A||B){t="Conflicting Port Forwarding Rules: The "+y+" service conflict with an existing port forwarding rule offering "+
y+" service.";A=!0;if(0<a.errorMessages.length)for(l=0;l<a.errorMessages.length;l++)if(a.errorMessages[l]==t){A=!1;break}A&&a.errorMessages.push(t)}}}}}if(0==a.errorMessages.length&&-1==a.appToForward)for(u=0;u<b.length;u++)if(r=b[u],y=d[u],w=e[u],s=parseInt(a.pf.protocol.protocol),1!=s&&7!=s||4567!=y||4567!=w||a.errorMessages.push("Invalid rule: Port 4567 cannot be blocked"),0==r)for(l=0;l<a.portForward.length;l++)for(m=0;m<a.portForward[l].protocols.length;m++){if(t=a.portForward[l].protocols[m],
7!=s||!(1>t.protocol||2<t.protocol))if(7==s||s==t.protocol)A="",A=0==t.outgoingPorts?"Any":1==t.outgoingPorts?t.outgoingPortStart:t.outgoingPortStart+" -> "+t.outgoingPortEnd,a.errorMessages.push("Conflicting Port Forwarding Rules: The Destination Ports Any service conflict with an existing port forwarding rule offering Destination Ports "+A+" service.")}else for(x=r=y,s=a.pf.protocol.protocol,r!=w&&(x+="-"+w),l=0;l<a.portForward.length;l++)for(m=0;m<a.portForward[l].protocols.length;m++)if(t=a.portForward[l].protocols[m],
y=a.portForward[l].name,7!=s||!(1>t.protocol||2<t.protocol))if(7==s||s==t.protocol){A="";if(0==t.outgoingPorts)A="Any";else if(1==t.outgoingPorts&&r<=t.outgoingPortStart&&w>=t.outgoingPortStart)A=t.outgoingPortStart;else if(2==t.outgoingPorts&&r<=t.outgoingPortStart&&w>=t.outgoingPortStart||r<=t.outgoingPortEnd&&w>=t.outgoingPortEnd||r>=t.outgoingPortStart&&w<=t.outgoingPortEnd)A=t.outgoingPortStart+" -> "+t.outgoingPortEnd;""!=A&&(0<=y.indexOf("_")?a.errorMessages.push("Conflicting Port Forwarding Rules: The Destination Ports "+
x+" service conflict with an existing port forwarding rule offering  Destination Ports "+A+" service."):a.errorMessages.push("Conflicting Port Forwarding Rules: The Destination Ports "+x+" service conflict with an existing port forwarding rule offering "+y+" service."))}if(0<a.errorMessages.length)a.showErrorPage=!0,window.scrollTo(0,0);else{y=w=u=r=!1;l=parseInt(a.pf.protocol.protocol);s={enabled:!0};-1==a.ipSelect?s.deviceIp=getIpString(a.pf.specifiedIp):0<=a.ipSelect&&(s.deviceIp=a.devices[a.ipSelect].ipAddress);
if(-1==a.appToForward)if(s.name="PortForward_"+(new Date).getTime(),s.protocols=[],7==l)for(l=0;l<b.length;l++)y=w=u=r=!1,m={protocol:1},m.incomingPorts=g,m.incomingPortStart=f,!1==w&&(m.incomingPortEnd=h),m.incomingExclude=r,m.outgoingPorts=b[l],m.outgoingPortStart=d[l],!1==y&&(m.outgoingPortEnd=e[l]),m.outgoingExclude=u,s.protocols.push(m),m={protocol:2},m.incomingPorts=g,m.incomingPortStart=f,!1==w&&(m.incomingPortEnd=h),m.incomingExclude=r,m.outgoingPorts=b[l],m.outgoingPortStart=d[l],!1==y&&
(m.outgoingPortEnd=e[l]),m.outgoingExclude=u,s.protocols.push(m);else for(l=0;l<b.length;l++)y=w=u=r=!1,m={},m.protocol=a.pf.protocol.protocol,m.incomingPorts=g,m.incomingPortStart=f,!1==w&&(m.incomingPortEnd=h),m.incomingExclude=r,m.outgoingPorts=b[l],m.outgoingPortStart=d[l],!1==y&&(m.outgoingPortEnd=e[l]),m.outgoingExclude=u,s.protocols.push(m);else if(0<=a.appToForward){b=null;for(l=0;l<a.pfRules.length;l++)if(a.pfRules[l].id==a.appToForward){b=a.pfRules[l];break}null!=b&&(s.protocols=b.protocols,
...
n=a.protocols.icmpCode;(null==k||""===k||0>k||255<k)&&a.errorMessages.push("ICMP Type:  Please enter a numeric value between 0 and 255.");(null==n||""===n||0>n||255<n)&&a.errorMessages.push("ICMP Code:  Please enter a numeric value between 0 and 255.")}}a.protocols.protocolNumber=parseInt(a.protocols.protocolNumber);0==a.errorMessages.length&&(0==a.protocols.incomingPorts&&(a.protocols.incomingExclude=!1),0==a.protocols.outgoingPorts&&(a.protocols.outgoingExclude=!1),1==a.protocols.protocol||2==a.protocols.protocol)&&
(n=k=!1,0==a.protocols.incomingPorts?k=!0:2==a.protocols.incomingPorts&&!1==a.protocols.incomingExclude&&1==b&&65535==c&&(k=!0),0==a.protocols.outgoingPorts?n=!0:2==a.protocols.outgoingPorts&&!1==a.protocols.outgoingExclude&&1==d&&65535==h&&(n=!0),k&&n&&a.errorMessages.push('Port forwarding rules can not be Any-to-Any (or "source: 1-65535" with "destination: 1-65535").'));var q={outgoing:[],incoming:[]};copyTrigger(q,a.tempTrigger);var p=n=k="",z=!1,b=!1,v,r,c=!1;r=v="";var y=!1,w=!1,s,u,m=!1;if(1==
a.protocols.protocol||2==a.protocols.protocol){1==a.protocols.protocol?k="TCP":2==a.protocols.protocol&&(k="UDP");for(var c=a.protocols.incomingPortEnd,b=a.protocols.incomingPortStart,h=a.protocols.outgoingPortEnd,d=a.protocols.outgoingPortStart,y=2==a.protocols.incomingPorts?!0:!1,z=2==a.protocols.outgoingPorts?!0:!1,q=!1==a.incoming?q.outgoing:q.incoming,l=0;l<q.length;l++)if(a.protocols.protocol==q[l].protocol&&a.tempIndex!=l&&(s=q[l].incomingPortEnd,u=q[l].incomingPortStart,w=null==s||""===s?
!1:!0,m=!1,y?w?Number(b)>=Number(u)&&Number(b)<=Number(s)?(v=u+"-"+s,r=b+"-"+c,m=!0):Number(c)>=Number(u)&&Number(c)<=Number(s)?(v=u+"-"+s,r=b+"-"+c,m=!0):Number(u)>=Number(b)&&Number(u)<=Number(c)?(v=u+"-"+s,r=b+"-"+c,m=!0):Number(s)>=Number(b)&&Number(s)<=Number(c)&&(v=u+"-"+s,r=b+"-"+c,m=!0):Number(u)>=Number(b)&&Number(u)<=Number(c)&&(v=u,r=b+"-"+c,m=!0):w?Number(b)>=Number(u)&&Number(b)<=Number(s)&&(v=u+"-"+s,r=d,m=!0):Number(b)==Number(u)&&(v=u,r=b,m=!0),m)){a.errorMessages.push("Overlapping Port Ranges: The "+
k+" source ports ("+r+") is overlapping with already defined "+k+" source ports ("+v+").");break}for(l=0;l<q.length;l++)if(a.protocols.protocol==q[l].protocol&&a.tempIndex!=l&&(v=q[l].outgoingPortEnd,r=q[l].outgoingPortStart,b=null==v||""===v?!1:!0,c=!1,z?b?Number(d)>=Number(r)&&Number(d)<=Number(v)?(n=r+"-"+v,p=d+"-"+h,c=!0):Number(h)>=Number(r)&&Number(h)<=Number(v)?(n=r+"-"+v,p=d+"-"+h,c=!0):Number(r)>=Number(d)&&Number(r)<=Number(h)?(n=r+"-"+v,p=d+"-"+h,c=!0):Number(v)>=Number(d)&&Number(v)<=
Number(h)&&(n=r+"-"+v,p=d+"-"+h,c=!0):Number(r)>=Number(d)&&Number(r)<=Number(h)&&(n=r,p=d+"-"+h,c=!0):b?Number(d)>=Number(r)&&Number(d)<=Number(v)&&(n=r+"-"+v,p=d,c=!0):Number(d)==Number(r)&&(n=r,p=d,c=!0),c)){a.errorMessages.push("Overlapping Port Ranges: The "+k+" destination ports ("+p+") is overlapping with already defined "+k+" destination ports ("+n+").");break}}0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.protocols.protocolNumber=parseInt(a.protocols.protocolNumber),
...
(null==c||""===c||1>c||65535<c)&&a.errorMessages.push("End Source Port: Please enter a numeric value between 1 and 65535."),0==a.errorMessages.length&&b>=c&&a.errorMessages.push("Source Ports: The From value must be lower than the To value in a range of ports (from="+b+", to="+c+").")}switch(a.protocols.outgoingPorts){case 1:(null==d||""===d||1>d||65535<d)&&a.errorMessages.push("Destination Port: Please enter a numeric value between 1 and 65535.");4567==d&&!1==a.protocols.outgoingExclude&&1==a.protocols.protocol&&
a.errorMessages.push("Invalid rule: Port 4567 cannot be blocked");break;case 2:(null==d||""===d||1>d||65535<d)&&a.errorMessages.push("Start Destination Port: Please enter a numeric value between 1 and 65535."),(null==e||""===e||1>e||65535<e)&&a.errorMessages.push("End Destination Port: Please enter a numeric value between 1 and 65535."),0==a.errorMessages.length&&d>=e&&a.errorMessages.push("Destination Ports: The From value must be lower than the To value in a range of ports (from="+d+", to="+e+").")}break;
case 3:if(10==a.protocols.icmpMessage){var f=a.protocols.icmpType,p=a.protocols.icmpCode;(null==f||""===f||0>f||255<f)&&a.errorMessages.push("ICMP Type:  Please enter a numeric value between 0 and 255.");(null==p||""===p||0>p||255<p)&&a.errorMessages.push("ICMP Code:  Please enter a numeric value between 0 and 255.")}}0==a.errorMessages.length&&(0==a.protocols.incomingPorts&&(a.protocols.incomingExclude=!1),0==a.protocols.outgoingPorts&&(a.protocols.outgoingExclude=!1),1==a.protocols.protocol||2==
a.protocols.protocol)&&(p=f=!1,0==a.protocols.incomingPorts?f=!0:2==a.protocols.incomingPorts&&!1==a.protocols.incomingExclude&&1==b&&65535==c&&(f=!0),0==a.protocols.outgoingPorts?p=!0:2==a.protocols.outgoingPorts&&!1==a.protocols.outgoingExclude&&1==d&&65535==e&&(p=!0),f&&p&&a.errorMessages.push('Port forwarding rules can not be Any-to-Any (or "source: 1-65535" with "destination: 1-65535").'));0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):applyProtocol(a,a.service.protocols)};
...
h.subnetMask);e.push(h.ipSubnet+" / "+h.subnetMask);break;case 2:a[d].displayText.push(h.ipStart+" - "+h.ipEnd);e.push(h.ipStart+" - "+h.ipEnd);break;case 3:a[d].displayText.push(h.mac);e.push(h.mac);break;case 4:a[d].displayText.push(h.hostname);for(var k=!1,n=0;n<b.length;n++)if(b[n].name==h.hostname){e.push(b[n].ipAddress);k=!0;break}k||e.push("");break;case 5:switch(h.dhcpType){case 0:e.push("DHCP Option: Vendor Class ID = "+h.option);a[d].displayText.push("DHCP Option: Vendor Class ID = "+h.option);
break;case 1:e.push("DHCP Option: Client ID = "+h.option);a[d].displayText.push("DHCP Option: Client ID = "+h.option);break;case 2:e.push("DHCP Option: User Class ID = "+h.option),a[d].displayText.push("DHCP Option: User Class ID = "+h.option)}break;case 6:e.push(h.hostname);a[d].displayText.push(h.hostname);break;case 7:a[d].displayText.push(h.name);k=!1;for(n=0;n<b.length;n++)if(b[n].name==h.name&&b[n].ipAddress===h.ipAddress){e.push(b[n].ipAddress);k=!0;break}k||e.push("")}}}c.push(e)}}
...
function overlapsSubPort(a,b,c,d,e,f,g){var h="",k="",n="",q=!1;1==a?1==d?Number(b)==Number(e)&&(k=b,n=e,q=!0):Number(f)>=Number(b)&&Number(e)<=Number(b)&&(k=b,n=e+"-"+f,q=!0):1==d?Number(c)>=Number(e)&&Number(b)<=Number(e)&&(k=b+"-"+c,n=e,q=!0):Number(c)>=Number(e)&&Number(b)<=Number(e)?(k=b+"-"+c,n=e+"-"+f,q=!0):Number(c)>=Number(f)&&Number(b)<=Number(f)?(k=b+"-"+c,n=e+"-"+f,q=!0):Number(f)>=Number(c)&&Number(e)<=Number(c)?(k=b+"-"+c,n=e+"-"+f,q=!0):Number(f)>=Number(c)&&Number(e)<=Number(c)&&(k=
b+"-"+c,n=e+"-"+f,q=!0);q&&(h="Overlapping Port Ranges: The "+g+" destination ports ("+k+") is overlapping with already defined "+g+" destination ports ("+n+").");return h};angular.module("igmp.controllers",[]).controller("IgmpProxyCtrl",["$scope","$route","$location","IGMPProxy",function(a,b,c,d){a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.igmp=d.get();a.save=function(){a.errorMessages=[];a.igmp.enabled="true"===""+a.igmp.enabled;a.igmp.fastLeave="true"===""+a.igmp.fastLeave;(null==a.igmp.robustness||isNaN(a.igmp.robustness)||1>a.igmp.robustness||!checksForDecimalNumber(a.igmp.robustness))&&
...
!1===a.isNewSsid&&!1===a.isNewWifiPw?b.path("/main"):a.page=5:b.path("/main")};a.checkConnection=function(){a.page=5;a.notConnected=!0;h.get(function(){k(function(){a.page=7},2E3)},function(b){200!=b.status&&(n++,3==n?(a.page=6,n=0):window.setTimeout(a.checkConnection,2E3))})};a.keyPress=function(c){if(13==c.keyCode)switch(a.page){case 0:a.getStarted();break;case 1:a.login();break;case 2:a.acceptSettings();break;case 4:a.confirmSettings();break;case 5:a.checkConnection();break;case 6:a.checkConnection();
...
"Devices","$rootScope","securityTips",function(a,b,c,d,e,f,g,h,k,n){a.tab=b.current.tab;a.section=b.current.section;a.detectBroadband=!1;a.restarting=!1;a.rebootingPage=!1;a.getStyleName=function(a){switch(a){case 0:return"Network";case 1:return"Network";case 2:return"Wireless";case 3:return"Wireless";case 4:return"Ethernet";case 5:return"Coax";default:return"Network"}};null!=e.fromdevicenetwork&&c.path("/network/connections/0");a.checkForDevicesNow=function(a,b){var c=!1,d="";switch(String(b)){case "2":d=
"4";break;case "3":d="5";break;case "4":d="0";break;default:return!1}if(0<a.length){for(var e=0;e<a.length;e++){if(String(a[e].connectionType)==String(d)&&!0==a[e].status){c=!0;break}if("6"==String(a[e].connectionType)&&a[e].approved&&"5"==String(d)&&!0==a[e].status){c=!0;break}if("7"==String(a[e].connectionType)&&"4"==String(d)&&!0==a[e].status){c=!0;break}}return c}return!1};var q,p=h.query(function(){q=d.query(function(){a.names=[];for(var b=[],c=0;c<q.length;c++)if(!q[c].done&&(q[c].done=!0,q[c].isChild=
!1,q[c].styleName=a.getStyleName(q[c].connectionId),q[c].hasConnectedDeviceNow=a.checkForDevicesNow(p,q[c].connectionId),b.push(q[c]),a.names.push(unescape(q[c].name)),q[c].availableBridges))for(var d=0;d<q[c].availableBridges.length;d++){var e=q[c].availableBridges[d];1!=e&&q[c].bridged[d]&&(q[e].isChild=!0,q[e].done||(q[e].styleName="BridgedItem "+a.getStyleName(q[e].connectionId),b.push(q[e]),a.names.push(unescape(q[e].name)),q[e].done=!0,q[e].hasConnectedDeviceNow=a.checkForDevicesNow(p,q[e].connectionId)))}a.connections=
b})});a.showChildren=k.connectionListIsAdvanced;a.detectConfirm=function(){systemSettings.warnBeforeChanges?a.detectBroadband=!0:a.doDetectBroadband()};a.detectCancel=function(){a.detectBroadband=!1};a.doDetectBroadband=function(){d.update({id:1},{detectBroadband:!0},function(){a.rebootingPage=!0;window.setTimeout(a.testConnection,0)})};a.testConnection=function(){f.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),window.location=findCurrentPath()+
"/redirect.html?v=v1.0.149"):window.setTimeout(a.testConnection,3E3)})};a.toggleChildren=function(){a.showChildren=!a.showChildren;k.connectionListIsAdvanced=!0==a.showChildren?!0:!1};a.checkNetworkConnections=function(){c.path("/network/connections")}}]).controller("NetworkConnectionCtrl",["$scope","$route","$routeParams","$location","NetworkConnections","Devices","securityTips",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;a.fromString="";a.oldFrom="";a.prev="";
a.deviceBridge=[];if(null!=c.from){a.fromString="?from="+c.from;b=c.from.split("-");"arptable"==b[b.length-1]?a.back="/advanced/arptable":"connlist"==b[b.length-1]?a.back="/advanced/dhcp/connections":"edit"==b[b.length-1]?a.back="/network/connections/0/edit":-1!=b[b.length-1].indexOf("dev_")?a.back="/network/device/details/"+b[b.length-1].substr(4):""===b[b.length-1]||isNaN(b[b.length-1])||(a.back="/network/connections/"+b[b.length-1]);for(var h=0;h<b.length-1;h++)0!=h&&(a.oldFrom+="-"),a.oldFrom+=
b[h];""!==a.oldFrom&&(a.prev="?from="+a.oldFrom)}else a.back="/network/connections";a.deviceNames=[];a.checkForDevicesNow=function(a,b){var c=!1,d="";switch(String(b)){case "2":d="4";break;case "3":d="5";break;case "4":d="0";break;default:return!1}if(0<a.length){for(var e=0;e<a.length;e++){if(String(a[e].connectionType)==String(d)&&!0==a[e].status){c=!0;break}if("6"==String(a[e].connectionType)&&a[e].approved&&"5"==String(d)&&!0==a[e].status){c=!0;break}if("7"==String(a[e].connectionType)&&"4"==String(d)&&
!0==a[e].status){c=!0;break}}return c}return!1};a.showBridgeDeviceList=function(b){for(var c=0;c<a.deviceBridge.length;c++)if(a.deviceBridge[c].name==b)return a.deviceBridge[c].toShowOut;return!0};a.findDeviceNames=function(b){for(var c=0;c<a.deviceBridge.length;c++)if(a.deviceBridge[c].name==b)return a.deviceBridge[c].realDeviceName};var k,n=f.query(function(){k=e.get({id:c.id},function(){a.name=unescape(k.name);a.deviceBridge=[];if(k.availableBridges)for(var b=0;b<k.availableBridges.length;b++){var c=
{};c.name=k.availableBridges[b];c.toShowOut=k.bridged[b];a.deviceBridge.push(c)}k.hasConnectedDeviceNow=a.checkForDevicesNow(n,k.connectionId);a.connections=e.query(function(){for(var b=0;b<a.connections.length;b++);if(k.underlyingDevices)for(angular.forEach(k.underlyingDevices,function(b){angular.forEach(a.connections,function(c){c.connectionId==b&&a.deviceNames.push(unescape(c.name))})}),b=0;b<a.deviceBridge.length;b++)for(var c=0;c<a.connections.length;c++)if(a.connections[c].connectionId==a.deviceBridge[b].name){a.deviceBridge[b].realDeviceName=
...
(a.savePopup=g.showSaving1("Save Settings","Saving your settings. Please wait..."),window.setTimeout(a.refreshContentsNow,15E3)):a.refreshContentsNow()})};a.toggleCoaxEnabled=function(){e.update({id:k.connectionId},{coaxEnabled:!k.coaxEnabled},function(){3==k.connectionId||2==k.connectionId?(a.savePopup=g.showSaving1("Save Settings","Saving your settings. Please wait..."),window.setTimeout(a.refreshContentsNow,15E3)):a.refreshContentsNow()})};a.cancelBtn=function(){window.scrollTo(0,0);null!=c.fromsystemtraffic?
...
"DhcpOptions","NetworkConnections","DhcpConnections","Routes","Devices","FirewallDMZ",function(a,b,c,d,e,f,g,h,k,n){a.tab=b.current.tab;a.section=b.current.section;a.confirm=!1;a.messages=[];a.staticConnections=[];a.routesConnections=[];a.oldCoaxPassword="";a.coTempIPAddress="";a.coTempHomeName="";a.tempStatic={};a.listOfNetworkIPAddress=[];a.fromString=c.from?"?from="+c.from+"&connectionEdit="+c.id:"?connectionEdit="+c.id;a.getStyleName=function(a){switch(a){case 0:return"Network";case 1:return"Network";
case 2:return"Wireless";case 3:return"Wireless";case 4:return"Ethernet";case 5:return"Coax";default:return"Network"}};a.checkForDevicesNow=function(a,b){var c=!1,d="";switch(String(b)){case "2":d="4";break;case "3":d="5";break;case "4":d="0";break;default:return!1}if(0<a.length){for(var e=0;e<a.length;e++){if(String(a[e].connectionType)==String(d)&&!0==a[e].status){c=!0;break}if("6"==String(a[e].connectionType)&&a[e].approved&&"5"==String(d)&&!0==a[e].status){c=!0;break}if("7"==String(a[e].connectionType)&&
"4"==String(d)&&!0==a[e].status){c=!0;break}}return c}return!1};var q=k.query(function(){a.connection=f.get({id:c.id},function(){a.connection.styleName=a.getStyleName(c.id);if(a.connection.dhcpExpires){var b=a.connection.dhcpExpires;a.connection.dhcpExpireTime=0!=b?Math.ceil(b/60)+" minutes":"Expired"}a.name=unescape(a.connection.name);a.connection.name=unescape(a.connection.name);a.connection.hasConnectedDeviceNow=a.checkForDevicesNow(q,a.connection.connectionId);a.oldsubnet=a.connection.subnetMask;
a.oldProtocolUsed=a.connection.protocolUsed;switch(a.connection.type){case 3:a.connectionType="Ethernet";break;case 5:a.connectionType="Coax";break;case 4:a.connectionType="AP";break;default:a.connectionType="Basic"}1==a.connection.connectionId&&(a.tempStatic={ipAddress:a.connection.ipAddress,defaultGateway:a.connection.defaultGateway,primaryDnsServer:a.connection.primaryDnsServer,secondaryDnsServer:a.connection.secondaryDnsServer,subnetMask:a.connection.subnetMask},a.connection.ipAddress=void 0!=
a.connection.staticIpAddress?a.connection.staticIpAddress:a.connection.ipAddress,a.connection.defaultGateway=void 0!=a.connection.staticDefaultGateway?a.connection.staticDefaultGateway:a.connection.defaultGateway,a.connection.primaryDnsServer=void 0!=a.connection.staticPrimaryDnsServer?a.connection.staticPrimaryDnsServer:a.connection.primaryDnsServer,a.connection.secondaryDnsServer=void 0!=a.connection.staticSecondaryDnsServer?a.connection.staticSecondaryDnsServer:a.connection.secondaryDnsServer,
...
a.bridges[b].styleName=a.getStyleName(a.bridges[b].connectionId);a.bridges[b].bridged=a.connection.bridged[b];a.bridges[b].name=unescape(a.bridges[b].name);a.bridges[b].hasConnectedDeviceNow=a.checkForDevicesNow(q,a.bridges[b].connectionId);break}}));a.dmz=n.get(function(){});a.connections=f.query(function(){var b=0;a.listOfNetworkIPAddress=[];for(var d=0;d<a.connections.length;d++){if(null!=a.connections[d].bridged)for(var f=0;f<a.connections[d].bridged.length;f++)a.connections[d].bridged[f]&&(a.connections[a.connections[d].availableBridges[f]].name=
2==a.connections[d].availableBridges[f]?unescape(a.connections[d].name)+" Wireless 802.11 2.4GHz Access Point":3==a.connections[d].availableBridges[f]?unescape(a.connections[d].name)+" Wireless 802.11 5.0GHz Access Point":unescape(a.connections[d].name+" "+a.connections[a.connections[d].availableBridges[f]].name));a.connections[d].name=unescape(a.connections[d].name);0==a.connections[d].connectionId&&(a.coTempHomeName=unescape(a.connections[d].name),a.coTempIPAddress=a.connections[d].ipAddress);if(0==
a.connections[d].connectionId||1==a.connections[d].connectionId)f={},f.id=a.connections[d].connectionId,f.ip=a.connections[d].ipAddress,f.name=unescape(a.connections[d].name),a.listOfNetworkIPAddress.push(f);a.connections[d].hasOwnProperty("connectionUsed")||(a.routesConnections[b]=a.connections[d],b++)}if(a.connection.dhcpSettings){a.dhcpOptions=e.query();a.dhcpStartIpAddress=splitIpArr(a.connection.dhcpSettings.startIpAddress);a.dhcpEndIpAddress=splitIpArr(a.connection.dhcpSettings.endIpAddress);
...
[];a.messages=[];if(2==a.connection.mtuType){var b=!1;validRange(a.connection.mtu,68,1500)?checkForWholeNumbers(a.connection.mtu)&&(b=!0):b=!0;b&&a.errorMessages.push("MTU: The maximum transfer unit of "+a.connection.name+" should be between 68 and 1500. ")}var e=b=!1,f=!1,g=!1,h=!1,n=!1,q=!1,k="",m=!0;if(a.connection.ipAddress){if(2==a.connection.protocolUsed){var l=!1,x=!1;validateIp(a.ipAddress)?"0.0.0.0"==getNumIpString(a.ipAddress)&&(a.errorMessages.push("IP address may not be 0.0.0.0. IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces. At least one of the values must be greater than 0."),
x=l=!0):(a.errorMessages.push("IP Address: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces."),x=l=!0);if(223<a.ipAddress[0]||0==a.ipAddress[0]||l)a.errorMessages.push("IP Address: Device IP address should start with a value between 1-223."),b=!0;0==a.connection.connectionId&&x&&a.errorMessages.push("IP Address already in use: IP address item is already in use by Port Forwarding.");validateIp(a.ipAddress)&&checkAllNetworks(a.listOfNetworkIPAddress,
a.ipAddress,a.connection.connectionId)&&(a.errorMessages.push("IP Address Already Exists: IP Address address "+getNumIpString(a.ipAddress)+" is already in use by "+checkAllNetworks4Name(a.listOfNetworkIPAddress,a.ipAddress,a.connection.connectionId)+"."),e=!0);b||e||!checkFor127(a.ipAddress)||(a.errorMessages.push("IP Address: IP addresses starting with 127 are not valid because they are reserved for loopback addresses."),h=!0)}x=l=!1;if(2==a.connection.protocolUsed||1==a.connection.protocolUsed)if(x=
!0,1!=a.connection.protocolUsed||a.connection.overrideSubnetMask||(x=!1),x){if(!validateIp(a.subnetMask)||checkFullListOfSubnetMaskRange(a.subnetMask))"0.0.0.0"!=getIpString(a.subnetMask)&&(l=!0,1==a.connection.connectionId&&1==a.connection.protocolUsed&&a.connection.overrideSubnetMask&&(l=!1),l?a.errorMessages.push("Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0."):
a.errorMessages.push("Override Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0.")),l=!0}else validateIp(a.subnetMask)||("0.0.0.0"!=getIpString(a.subnetMask)&&(l=!0,1==a.connection.connectionId&&1==a.connection.protocolUsed&&a.connection.overrideSubnetMask&&(l=!1),l?a.errorMessages.push("Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0."):
a.errorMessages.push("Override Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0.")),l=!0);0==a.connection.connectionId&&(checkForValidSubnetMaskRange(a.subnetMask)||l)&&(a.errorMessages.push("Subnet Mask: Subnet mask must be between 255.0.0.0 and 255.255.255.252."),l=!0);2==a.connection.protocolUsed&&a.defaultGateway&&!validateIp(a.defaultGateway)&&(a.errorMessages.push("Default Gateway: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces."),
m=!1,n=!0);!b&&!1==l&&2==a.connection.protocolUsed&&validateIp(a.ipAddress)&&"0.0.0.0"!=getNumIpString(a.ipAddress)&&(checkHostVsSubmask(a.ipAddress,a.subnetMask)?(k="IP Address and Subnet Mask combination: The combination of IP address and subnet mask is invalid. All of the bits in the host address portion of the IP address are set to "+checkBits(a.ipAddress)+".",a.errorMessages.push(k),q=!0):(l=compareIpMaskNetwork(a.ipAddress,a.subnetMask),"2"!=l&&(k="IP Address and Subnet Mask combination: The combination of IP address and subnet mask is invalid. All of the bits in the network address portion of the IP address are set to "+
l+".",a.errorMessages.push(k),q=!0)));if(2==a.connection.protocolUsed&&a.defaultGateway&&m&&!q&&validateIp(a.ipAddress)&&getNumIpString(a.ipAddress)==getNumIpString(a.defaultGateway)){if(""!=k){f=[];for(l=0;l<a.errorMessages.length;l++)k!=a.errorMessages[l]&&f.push(a.errorMessages[l]);a.errorMessages=f}a.errorMessages.push("Incorrect Gateway IP: The Gateway cannot have the same IP address as the specified Wireless Broadband Router IP address.");f=!0}a.connection.primaryDnsServer&&1==a.connection.dnsMode&&
...
0>a.connection.deviceMetric||255<a.connection.deviceMetric)&&a.errorMessages.push("Device Metric: Please enter a numeric value between 0 and 255.");k=getIpString(a.ipAddress);a.connection.dnsMode=parseInt(a.connection.dnsMode);x=m="";a.connection.primaryDnsServer&&(m=getIpString(a.primaryDnsServer),x=getIpString(a.secondaryDnsServer));var B=parseInt(a.connection.protocolUsed),t=a.connection.subnetMask;if(2==B||1==B)t=getIpString(a.subnetMask);var A=a.connection.defaultGateway;a.defaultGateway&&(A=
...
a.subnetMask;a.connection.overrideSubnetMask||1!=B||(C=splitIpArr(t));if((2==B||1==B&&a.connection.overrideSubnetMask)&&validateIp(C)){for(var D=!0,F=!1,l=0;4>l;l++){for(var E=7;-1<E;E--){var G=1==(C[l]>>E&1);if(G&&F){D=!1;break}G||(F=!0)}if(!D)break}l=!1;"0.0.0.0"==t&&(l=!0,1==a.connection.connectionId&&1==a.connection.protocolUsed&&a.connection.overrideSubnetMask&&(l=!1),l?a.errorMessages.push("Subnet Mask: Subnet mask may not be 0.0.0.0. Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0."):
a.errorMessages.push("Override Subnet Mask: Subnet mask may not be 0.0.0.0. Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0."),l=!0);if(!D)l=!0,1==a.connection.connectionId&&1==a.connection.protocolUsed&&a.connection.overrideSubnetMask&&(l=!1),n="",n=l?"Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0.":
"Override Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0.",a.checkMsg(a.errorMessages,n)||a.errorMessages.push(n);else if(2==B&&a.connection.defaultRoute&&"0.0.0.0"==A)a.errorMessages.push("Default Gateway: The Default Gateway must not be 0.0.0.0 while the Default Route is set.");else if(2==B&&"0.0.0.0"!=A&&!l&&validateIp(a.ipAddress)&&!(b||e||h||q||n)){for(l=
0;4>l;l++)if((C[l]&a.defaultGateway[l])!=(a.subnetMask[l]&a.ipAddress[l])){a.errorMessages.push("Wireless Broadband Router and Default Gateway Are Not on the Same Subnet: Under the given Netmask, the IP Address does not belong to the same Subnet as the Default Gateway.");g=!0;break}g||(checkHostVsSubmask(a.defaultGateway,a.subnetMask)?(a.errorMessages.push("Wireless Broadband Router and Default Gateway Are Not on the Same Subnet: Under the given Netmask, the IP Address does not belong to the same Subnet as the Default Gateway."),
g=!0):(l=compareIpMaskNetwork(a.defaultGateway,a.subnetMask),"2"!=l&&(a.errorMessages.push("Wireless Broadband Router and Default Gateway Are Not on the Same Subnet: Under the given Netmask, the IP Address does not belong to the same Subnet as the Default Gateway."),g=!0)))}}}0==a.connection.protocolUsed||1!=a.connection.dnsMode||1!=a.connection.connectionId||!a.connection.primaryDnsServer||b||e||f||g||h||(k==m&&1!=a.connection.protocolUsed?a.errorMessages.push("Primary DNS Server: DNS Server cannot have the IP address of Wireless Broadband Router "+
unescape(a.connection.name)+"."):m==a.coTempIPAddress&&a.errorMessages.push("Primary DNS Server: DNS Server cannot have the IP address of Wireless Broadband Router "+a.coTempHomeName+"."),k==x&&1!=a.connection.protocolUsed?a.errorMessages.push("Secondary DNS Server: DNS Server cannot have the IP address of Wireless Broadband Router "+unescape(a.connection.name)+"."):x==a.coTempIPAddress&&a.errorMessages.push("Secondary DNS Server: DNS Server cannot have the IP address of Wireless Broadband Router "+
a.coTempHomeName+"."),"0.0.0.0"!=m&&m==x&&a.errorMessages.push("Redundant DNS Entries: 'Primary' and 'Secondary' values may not point to the same DNS server."),"255.255.255.255"==m&&a.errorMessages.push("Primary DNS Server: "+m+" is invalid."),"255.255.255.255"==x&&a.errorMessages.push("Secondary DNS Server: "+x+" is invalid."));if(0!=a.errorMessages.length){a.showErrorPage=!0;window.scrollTo(0,0);return}2==a.connection.protocolUsed?(a.connection.ipAddress=k,a.defaultGateway&&(a.connection.defaultGateway=
A)):a.defaultGateway&&(a.connection.defaultGateway=null);void 0!==a.connection.routingMode&&(a.connection.routingMode=parseInt(a.connection.routingMode));a.connection.primaryDnsServer=m;a.connection.secondaryDnsServer=x;a.connection.protocolUsed=B;a.connection.subnetMask=t;0==c.id&&1==a.connection.protocolUsed&&2==a.oldProtocolUsed&&(a.messages.push({type:"DHCP Client:",data:"Configuring an internal connection to obtain an IP address automatically might make the connection inaccessible in case no IP address is obtained."}),
...
hourRanges:[{startTimeHour:0,startTimeMinute:0,endTimeHour:0,endTimeMinute:0}]}]},accessType:0,restrictions:[],hosts:[],status:!0};var k=[],n=e.query(function(){k=f.query(function(){for(var b=0;b<k.length;b++)if(6!=k[b].connectionType){for(var d=!1,e=0;e<n.length;e++)for(var f=n[e],g=0;g<f.hosts.length;g++)if(f.hosts[g]==k[b].mac){d=!0;break}d||k[b].isStb||a.availableDevices.push(k[b].name)}for(b=0;b<k.length;b++)if(6==k[b].connectionType&&k[b].approved){d=!1;for(e=0;e<n.length;e++)for(f=n[e],g=0;g<
f.hosts.length;g++)if(f.hosts[g]==k[b].mac){d=!0;break}d||k[b].isStb||a.availableDevices.push(k[b].name)}if(void 0!==c.id&&n.length>c.id){f=n[c.id];a.parentalControl.accessType=f.accessType;a.parentalControl.name=f.name;a.parentalControl.description=f.description;a.parentalControl.schedule.activeDuring=f.schedule.activeDuring;for(g=0;g<f.schedule.timeSegments[0].daysOfTheWeek.length;g++)a.days[f.schedule.timeSegments[0].daysOfTheWeek[g]]=!0;b=f.schedule.timeSegments[0].hourRanges[0].startTimeHour;
...
function(){d.path("/parental/summary");window.scrollTo(0,0)})};a.applySettings=function(){a.errorMessages=[];a.checkAccessValue();var b=0;""==a.parentalControl.name&&a.errorMessages.push("Policy: Rule name must be specified.");angular.forEach(n,function(d){d.name===a.parentalControl.name&&b!=c.id&&a.errorMessages.push("Policy: This name is already used by another rule.");b++});/^[0-9A-Z\!\-\_\.#']+$/i.test(a.parentalControl.name)||""===a.parentalControl.name||a.errorMessages.push('Policy: Rule name should consist of standard characters only (ASCII 32-126) excluding the special character space and any of :@"|\\/=+<>()[]{}&%^$*?,;');
...
a[e].approved&&"5"==String(d)&&!0==a[e].status){c=!0;break}if("7"==String(a[e].connectionType)&&"4"==String(d)&&!0==a[e].status){c=!0;break}}return c}return!1};a.initialLoad=!0;a.refresh=function(){if(a.initialLoad||a.autoRefresh){a.initialLoad=!1;var b,d=k.query(function(){b=c.query(function(){a.connections=b;for(var c=0;c<a.connections.length;c++)if(void 0!==a.connections[c].ipv6Address&&"::"!==a.connections[c].ipv6Address&&""!==a.connections[c].ipv6Address&&(a.showIpv6=!0),a.connections[c].displayName=
unescape(a.connections[c].name),a.connections[c].hasConnectedDeviceNow=a.checkForDevicesNow(d,a.connections[c].connectionId),a.connections[c].underlyingDevicesTempList=[],a.connections[c].underlyingDevices&&a.connections[c].availableBridges)for(var e=0;e<a.connections[c].availableBridges.length;e++)for(var f=0;f<a.connections[c].underlyingDevices.length;f++)if(a.connections[c].availableBridges[e]==a.connections[c].underlyingDevices[f]&&!0==a.connections[c].bridged[e]){a.connections[c].underlyingDevicesTempList.push(a.connections[c].availableBridges[e]);
break}a.autoRefresh&&a.valid&&(a.timer=setTimeout(function(){a.refresh()},1E4))})})}};a.toggleAutoRefresh=function(){clearTimeout(a.timer);a.systmSetngs=g.get();a.autoRefresh=!a.autoRefresh;a.systmSetngs.autoRefreshSystemMonitoring=a.autoRefresh;a.systmSetngs.$update(function(){systemSettings=a.systmSetngs;a.autoRefresh&&a.refresh()})};a.close=function(){null!=f.frommain?d.url(d.path("/main")):(d.path("/monitoring/advanced"),window.scrollTo(0,0))};a.refresh()}]).controller("BandwidthCtrl",["$scope",
"$route","NetworkConnections","SystemSettings","$location",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;a.valid=!0;a.timer=null;a.autoRefresh=systemSettings.autoRefreshSystemMonitoring;a.$on("$destroy",function(){a.valid=!1;clearInterval(a.timer)});a.initialLoad=!0;a.refresh=function(){if(a.initialLoad||a.autoRefresh){a.initialLoad=!1;var b=c.get({id:1},function(){a.bb=b;a.autoRefresh&&a.valid&&(a.timer=setTimeout(function(){a.refresh()},1E4))})}};a.toggleAutoRefresh=function(){clearTimeout(a.timer);
...
function validateIPv4DhcpSettings(a,b,c,d,e,f,g,h,k,n,q){var p=[],z=getSubnetID(a,d),v=angular.copy(z);v[3]=100;z=angular.copy(z);z[3]=150;var r=!1;validateIp(a)?q&&(validateChecksForWholeNumber(a)||(r=!0)):r=!0;r&&p.push("Invalid IP Address provided. Values must be between 0 and 255");r=!1;validateIp(b)?q&&(validateChecksForWholeNumber(b)||(r=!0)):r=!0;r&&p.push("Start IP Address: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces.");r=!1;validateIp(c)?
q&&(validateChecksForWholeNumber(c)||(r=!0)):r=!0;r&&p.push("End IP Address: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces.");validateIp(a)&&null!=n&&checkAllNetworks(n,a,g)&&$scope.errorMessages.push("IP Address Already Exists: IP Address address "+getNumIpString(a)+" is already in use by "+checkAllNetworks4Name(n,a,g)+".");q=n=!1;if(2==h||1==h)if(q=!0,1!=h||k||(q=!1),q){if(!validateIp(d)||checkFullListOfSubnetMaskRange(d))"0.0.0.0"!=getIpString(d)&&
p.push("Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0."),n=!0}else validateIp(d)||("0.0.0.0"!=getIpString(d)&&p.push("Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0."),n=!0);isIPWithinRange(b,v,z)&&isIPWithinRange(c,v,z)&&
p.push("Start IP Address, End IP Address: IP addresses between "+getIpString(v)+" and "+getIpString(z)+" are used for FiOS TV. Please select a start and/or end IP address outside of this reserved range.");0!=g||!checkForValidSubnetMaskRange(d)&&!0!=n||(p.push("Subnet Mask: Subnet mask must be between 255.0.0.0 and 255.255.255.252."),n=!0);!1==n&&2==h&&validateIp(a)&&"0.0.0.0"!=getNumIpString(a)&&(checkHostVsSubmask(a,d)?p.push("IP Address and Subnet Mask combination: The combination of IP address and subnet mask is invalid. All of the bits in the host address portion of the IP address are set to "+
checkBits(a)+"."):(g=compareIpMaskNetwork(a,d),"2"!=g&&p.push("IP Address and Subnet Mask combination: The combination of IP address and subnet mask is invalid. All of the bits in the network address portion of the IP address are set to "+g+".")));(!validateIp(e)||255<e[0]||255<e[1]||255<e[2]||255<e[3])&&p.push("WINS Server: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces.");(isNaN(f)||1>f||43200<f||0!==f%1)&&p.push("Lease Time in Minutes: Please enter a numeric value between 1 and 43200.");
"0.0.0.0"==getIpString(b)?p.push("Start IP Address: IP address may not be 0.0.0.0. IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces. At least one of the values must be greater than 0."):checkHostVsSubmask(b,d)&&"1"==checkBits(b)&&p.push("Start IP Address: "+b[0]+"."+b[1]+"."+b[2]+"."+b[3]+" isn't a valid address");"0.0.0.0"==getIpString(c)?p.push("End IP Address:  IP address may not be 0.0.0.0. IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces. At least one of the values must be greater than 0."):
checkHostVsSubmask(c,d)&&"1"==checkBits(c)&&p.push("End IP Address: "+c[0]+"."+c[1]+"."+c[2]+"."+c[3]+" isn't a valid address");if(0<p.length)return p;h=g=f=!0;e=!1;if((a[0]&d[0])!=(b[0]&d[0])||(a[1]&d[1])!=(b[1]&d[1])||(a[2]&d[2])!=(b[2]&d[2])||(a[3]&d[3])!=(b[3]&d[3]))g=!1;if((a[0]&d[0])!=(c[0]&d[0])||(a[1]&d[1])!=(c[1]&d[1])||(a[2]&d[2])!=(c[2]&d[2])||(a[3]&d[3])!=(c[3]&d[3]))h=!1;g&&h?validateDHCPRange(b,c,a,d)||p.push("Start IP Address, End IP Address: The DHCP IP address range does not conform to the connection IP address and the DHCP subnet mask."):
p.push((g?"":"Start IP Address")+(g||h?"":", ")+(h?"":"End IP Address")+":  The DHCP IP address range does not conform to the connection IP address and the DHCP subnet mask.");if(255==d[0]&&255==d[1]&&255==d[2]&&255==d[3]||d[0]<d[1]||d[1]<d[2]||d[2]<d[3])f=!1;g=!1;for(h=0;4>h;h++){for(k=7;-1<k;k--){if((v=1==(d[h]>>k&1))&&g){f=!1;break}v||(g=!0)}if(!f)break}if(f){f=f=d=!1;for(g=0;4>g;g++){h=b[g];k=c[g];h=Number(h);k=Number(k);k>h&&(f=!0);if(h>k&&!f)break;h!=k&&(d=!0)}getIpString(b)===getIpString(c)&&
(d=!0);d||(e=!0,p.push("IP Addresses: Start IP address is greater than End IP address."));if(f=isIPWithinRange(a,b,c))e=!0,p.push("IP Addresses: The Device's IP address should not be in the range of the IP pool");e||checkIPRange(b,c)||p.push("The number of IP Addresses in the DHCP IP address range must not be more than 256.")}else p.push("Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0.");
return p}function validateIPv6(a){a=a.split(":");if(3>a.length||8<a.length)return!1;for(var b=0,c=0;c<a.length;c++)if(""===a[c])b++;else if(!/^[a-f0-9]{1,4}$/i.test(a[c]))return!1;return 1==b?""!==a[a.length-1]&&""!==a[0]:2==b?""===a[a.length-1]&&""===a[a.length-2]||""===a[1]&&""===a[0]:3==b&&3==a.length?!0:2<b?!1:8==a.length}
...
function isScheduleActive(a,b){if(null===a||"Always"===a||""===a)return"Active";var c=["Active","Inactive"];a.activeDuring||(c=["Inactive","Active"]);var d=b.day();0==d&&(d=7);for(var d=d-1,e=b.hour(),f=b.minute(),g=0;g<a.timeSegments.length;g++)if(-1!=String(a.timeSegments[g].daysOfTheWeek).indexOf(d))for(var h=0;h<a.timeSegments[g].hourRanges.length;h++){var k=a.timeSegments[g].hourRanges[h].startTimeHour,n=a.timeSegments[g].hourRanges[h].endTimeHour,q=a.timeSegments[g].hourRanges[h].startTimeMinute,
p=a.timeSegments[g].hourRanges[h].endTimeMinute;if(k==n&&q<=p){if(k==e&&n==e&&q<=f&&p>f)return c[0]}else if(k<n){if(e>k&&e<n||k==e&&f>=q||n==e&&f<p)return c[0]}else if(k<e||k==e&&q<=f||n>e||n==e&&p>f)return c[0]}return c[1]}
...
a.wirelessUpdate=function(){a.wirelessA.ssid=a.wirelessA.ssid;a.wirelessB.ssid=a.wirelessB.ssid;a.hasApplyChanges=!0;a.wirelessA.$update(function(){a.wirelessB.$update(function(){d.showSaving("Save Settings","Saving your settings. Please wait...",15E3)})})};a.checkWEP=function(){a.wirelessA.radioEnabled&&0==a.wAtype&&a.wpsIsEnabled&&4==a.wirelessA.mode?a.enableWEP():a.wirelessA.radioEnabled&&0==a.wAtype&&(a.wpsIsEnabled||1==a.wirelessA.mode||8==a.wirelessA.mode)?a.enableWEP1():a.wirelessA.radioEnabled&&
1==a.wAtype&&0==a.isW24WEPOn?a.rdbtnChange(a.wAtype):a.check5GHzEnabled()};a.enableWEP=function(){d.showCustomMessage("Warning",["If WEP is enabled for the 2.4 GHz wireless network, then WPS will be disabled for the 2.4 GHz wireless network.","Are you sure you want to enable WEP?"]).then(function(b){"cancel"!=b&&a.check5GHzEnabled()})};a.enableWEP1=function(){d.showCustomMessage1("Warning",["Turning on WEP will change your 2.4 GHz wireless mode to Legacy Mode (802.11b/g) and disable Wi-Fi Protected Setup.",
"Press OK to continue or Cancel."]).then(function(b){"cancel"!=b&&(a.wirelessA.mode=4,a.check5GHzEnabled())})};a.save=function(){!1==a.hasApplyChanges&&(a.errorMessages=[],a.wirelessA.channelDesired=parseInt(a.wirelessA.channelDesired),a.wirelessB.channelDesired=parseInt(a.wirelessB.channelDesired),a.wepA.keyLength=parseInt(a.wepA.keyLength),a.wepA.entryMethod=parseInt(a.wepA.entryMethod),a.wepB.keyLength=parseInt(a.wepB.keyLength),a.wepB.entryMethod=parseInt(a.wepB.entryMethod),0==a.wAtype&&validateWepSettings(a.wepA,
...
!0):0==a.oldAType?a.wirelessA.security.enabled=!1:1==a.wAtype&&(a.wirelessA.security.type=a.oldAType),a.checkWEP()))};a.keyPress=function(b){13==b.keyCode&&"/wireless/basic"==f.path()&&a.save()};a.showNotifyRestartMsgPopup=function(){d.showNotifyRestartMsg("Warning",[""]).then(function(b){"cancel"!=b&&a.wirelessUpdate()})}}]).controller("WirelessSSIDBroadcast",["$scope","$route","$routeParams","$location","Wireless","securityTips","WPS",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;
a.wirelessWpsAreOn=!0;var h=c.id;0==h?(a.wirelessName="2.4 GHz",a.wirelessType=0):(a.wirelessName="5 GHz",a.wirelessType=1);var k=g.get({id:0},function(){a.wpsEnabled=k.enabled;var b=e.query(function(){a.wirelessARadioEnabled=b[0].radioEnabled;a.wirelessAWpsEnabled=b[0].wpsEnabled;a.wirelessBRadioEnabled=b[1].radioEnabled;a.wirelessBWpsEnabled=b[1].wpsEnabled;a.wirelessARadioEnabled||a.wirelessBRadioEnabled||(a.wirelessWpsAreOn=!1);a.wirelessAWpsEnabled||a.wirelessBWpsEnabled||(a.wirelessWpsAreOn=
!1);a.wpsEnabled&&!a.wirelessWpsAreOn&&(a.wpsEnabled=!1)})}),n=e.get({id:h},function(){a.ssidBroadcast=n.ssidBroadcast});a.wirelessUpdate=function(){e.update({id:h},{ssidBroadcast:a.ssidBroadcast},function(){d.path("/wireless/advanced")})};a.check5GHzBroadcast=function(){f.showAutoConnectMsgBroadcast("","").then(function(b){"cancel"!=b&&a.showNotifyRestartMsgPopup()})};a.showNotifyRestartMsgPopup=function(){f.showNotifyRestartMsg("Warning",[""]).then(function(b){"cancel"!=b&&a.wirelessUpdate()})};
a.save=function(){a.wpsEnabled&&!a.ssidBroadcast?f.showCustomMessage("Warning",["If SSID Broadcast is disabled for the "+a.wirelessName+" wireless network, then WPS will also be disabled for the "+a.wirelessName+" wireless network.","Are you sure you want to disable SSID Broadcast?"]).then(function(b){"cancel"!=b&&(0==a.wirelessType?a.showNotifyRestartMsgPopup():a.check5GHzBroadcast())}):a.ssidBroadcast?a.showNotifyRestartMsgPopup():0==a.wirelessType?a.showNotifyRestartMsgPopup():a.check5GHzBroadcast()}}]).controller("WirelessMode",
["$scope","$route","$location","Wireless","securityTips",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;var f=d.query(function(){a.modeA=f[0].mode;a.modeB=f[1].mode;a.wirelessAEnabled=f[0].radioEnabled;a.wAtype=f[0].security.enabled?0==f[0].security.type?0:1:1});a.wirelessUpdate=function(){d.update({id:0},{mode:parseInt(a.modeA)},function(){d.update({id:1},{mode:parseInt(a.modeB)},function(){c.path("/wireless/advanced")})})};a.enableWEP=function(){0!=a.wAtype||!a.wirelessAEnabled||
1!=a.modeA&&8!=a.modeA?a.showNotifyRestartMsgPopup():e.showCustomMessage2("Warning",["Compatibility Mode and Performance Mode are not compatible with WEP security. You must first select WPA/WPA2 Mixed Mode or WPA2 security before enabling Compatibility or Performance mode."])};a.save=function(){a.enableWEP()};a.showNotifyRestartMsgPopup=function(){e.showNotifyRestartMsg("Warning",[""]).then(function(b){"cancel"!=b&&a.wirelessUpdate()})}}]).controller("WirelessTransmissionCtrl",["$scope","$route",
"$routeParams","$location","WirelessTransmission","securityTips",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.errorMessages=[];a.showErrorPage=!1;a.confirmed=!(null!=c.warn&&"true"==c.warn);a.trans1=e.get({id:0});a.trans2=e.get({id:1});a.runFocus=!1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.isConfirmed=function(){a.confirmed=!0;a.runFocus=!0};a.keyPress=function(b){13==b.keyCode&&!a.showErrorPage&&a.confirmed&&a.save()};a.save=function(){a.errorMessages=
[];a.trans1.ctsProtection=parseInt(a.trans1.ctsProtection);a.trans1.ctsProtectionType=parseInt(a.trans1.ctsProtectionType);a.trans2.ctsProtection=parseInt(a.trans2.ctsProtection);a.trans2.ctsProtectionType=parseInt(a.trans2.ctsProtectionType);validateTransmissionSettings(a.trans1,"2.4 GHz Wireless",a.errorMessages);validateTransmissionSettings(a.trans2,"5.0 GHz Wireless",a.errorMessages);0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):a.showNotifyRestartMsgPopup()};a.showNotifyRestartMsgPopup=
function(){f.showNotifyRestartMsg("Warning",[""]).then(function(b){"cancel"!=b&&(a.trans1.channelWidth=parseInt(a.trans1.channelWidth),a.trans2.channelWidth=parseInt(a.trans2.channelWidth),a.trans1.beaconInterval=parseInt(a.trans1.beaconInterval),a.trans2.beaconInterval=parseInt(a.trans2.beaconInterval),a.trans1.dtimInterval=parseInt(a.trans1.dtimInterval),a.trans2.dtimInterval=parseInt(a.trans2.dtimInterval),a.trans1.fragmentationThreshold=parseInt(a.trans1.fragmentationThreshold),a.trans2.fragmentationThreshold=
parseInt(a.trans2.fragmentationThreshold),a.trans1.rtsThreshold=parseInt(a.trans1.rtsThreshold),a.trans2.rtsThreshold=parseInt(a.trans2.rtsThreshold),a.trans1.frameBurstMax=parseInt(a.trans1.frameBurstMax),a.trans2.frameBurstMax=parseInt(a.trans2.frameBurstMax),a.trans1.frameBurstTime=parseInt(a.trans1.frameBurstTime),a.trans2.frameBurstTime=parseInt(a.trans2.frameBurstTime),a.trans1.power=parseInt(a.trans1.power),a.trans2.power=parseInt(a.trans2.power),a.trans1.$update({id:0},function(){a.trans2.$update({id:1},
function(){d.path("/wireless/advanced")})}))})}}]).controller("WirelessWmmCtrl",["$scope","$route","$routeParams","$location","WirelessWmm","securityTips",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.wirelessName=0==c.id?"2.4 GHz":"5 GHz";a.qos=e.get({id:c.id});a.enabledClick=function(){a.qos.enabled||(a.qos.powerSave=!1)};a.save=function(){a.showNotifyRestartMsgPopup()};a.saveNow=function(){a.qos.$update({id:c.id},function(){location.reload()})};a.showNotifyRestartMsgPopup=
function(){f.showNotifyRestartMsg("Warning",[""]).then(function(b){"cancel"!=b&&a.saveNow()})};a.keyPress=function(b){13==b.keyCode&&d.path()=="/wireless/wmm/"+c.id&&a.save()}}]).controller("WirelessWEPCtrl",["$scope","$route","$routeParams","$location","WEP","securityTips","WPS","Wireless",function(a,b,c,d,e,f,g,h){a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.errorMessages=[];var k=c.id;a.wirelessName=0==k?"2.4 GHz":"5 GHz";a.wep=e.get({id:k},function(){var b=g.get({id:0},
function(){a.wpsIsEnabled=b.enabled;a.wirelessCmd=h.query(function(){a.wirelessACmd=a.wirelessCmd[0];a.wpsIsEnabled=a.wpsIsEnabled?!0:!1;a.ipAddress=splitIpArr(a.wep.serverIp)})})});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.wepChanged=function(b){b=a.wep.settings[b];var c=10,c=0==b.keyLength?0==b.entryMethod?10:5:0==b.entryMethod?26:13;b.key.length>c&&(b.key=b.key.substr(0,c))};a.wirelessUpdate=function(b){e.update({id:k},{activeSetting:a.wep.activeSetting,mode:a.wep.mode,
authenticationType:a.wep.authenticationType,settings:a.wep.settings},function(){1==b?h.update({id:0},{mode:4},function(){d.path("/wireless/advanced")}):d.path("/wireless/advanced")})};a.checkWEP=function(){a.wirelessACmd.radioEnabled&&a.wpsIsEnabled&&4==a.wirelessACmd.mode?a.enableWEP():a.wirelessACmd.radioEnabled&&(a.wpsIsEnabled||1==a.wirelessACmd.mode||8==a.wirelessACmd.mode)?a.enableWEP1():a.showNotifyRestartMsgPopup(0)};a.enableWEP=function(){f.showCustomMessage("Warning",["If WEP is enabled for the 2.4 GHz wireless network, then WPS will be disabled for the 2.4 GHz wireless network.",
"Are you sure you want to enable WEP?"]).then(function(b){"ok"==b&&a.showNotifyRestartMsgPopup(0)})};a.enableWEP1=function(){f.showCustomMessage1("Warning",["Turning on WEP will change your 2.4 GHz wireless mode to Legacy Mode (802.11b/g) and disable Wi-Fi Protected Setup.","Press OK to continue or Cancel."]).then(function(b){"ok"==b&&a.showNotifyRestartMsgPopup(1)})};a.save=function(){a.errorMessages=[];a.wep.authenticationType=parseInt(a.wep.authenticationType);for(var b=0;b<a.wep.settings.length;b++)a.wep.settings[b].entryMethod=
parseInt(a.wep.settings[b].entryMethod),a.wep.settings[b].keyLength=parseInt(a.wep.settings[b].keyLength),validateWepSettings(a.wep.settings[b],b==a.wep.activeSetting,"Key #"+(b+1),a.errorMessages);0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):a.checkWEP()};a.showNotifyRestartMsgPopup=function(b){f.showNotifyRestartMsg("Warning",[""]).then(function(c){"cancel"!=c&&a.wirelessUpdate(b)})}}]).controller("WirelessWPACtrl",["$scope","$route","$routeParams","$location","WPA","securityTips",
function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.whichKey=1;a.keyType=0;a.errorMessages=[];a.showErrorPage=!1;var g=c.id;a.wirelessName=0==g?"2.4 GHz":"5 GHz";a.wpaType=0==b.current.wpa?"WPA2/WPA mixed mode":"WPA2";a.wpa=e.get({id:g},function(){a.wpa.key=a.wpa.key;a.wpa.type=b.current.wpa});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.validateWpaKey=function(b){8>b.length&&a.errorMessages.push("Pre-Shared Key: Pass-Phrase has to be at least 8 characters long.")};
a.save=function(){a.errorMessages=[];a.wpa.groupKeyUpdateIntervalEnabled&&(isNaN(a.wpa.groupKeyUpdateInterval)||900>a.wpa.groupKeyUpdateInterval||86400<a.wpa.groupKeyUpdateInterval||!checksForDecimalNumber(a.wpa.groupKeyUpdateInterval))&&a.errorMessages.push("Group Key Update Interval: Please enter a numeric value between 900 and 86400.");a.validateWpaKey(a.wpa.key);0!=a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):a.showNotifyRestartMsgPopup()};a.showNotifyRestartMsgPopup=function(){f.showNotifyRestartMsg("Warning",
[""]).then(function(b){"cancel"!=b&&a.saveData()})};a.saveData=function(){a.wpa.groupKeyUpdateIntervalEnabled||(a.wpa.groupKeyUpdateInterval=0);a.wpa.encryptionAlgorithm=parseInt(a.wpa.encryptionAlgorithm);e.update({id:g},{type:a.wpa.type,mode:a.wpa.mode,encryptionAlgorithm:a.wpa.encryptionAlgorithm,groupKeyUpdateInterval:a.wpa.groupKeyUpdateInterval,groupKeyUpdateIntervalEnabled:a.wpa.groupKeyUpdateIntervalEnabled,key:a.wpa.key},function(){d.path("/wireless/advanced")})}}]).controller("WirelessMACFilterCtrl",
["$scope","$route","$location","WirelessMACFilter","Wireless","securityTips","WPS",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;a.warningFlg=!1;a.newMac="";a.filter0=d.get({id:0});a.filter1=d.get({id:1});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.checkFilters=function(b){for(var c=0;c<b.length;c++)if(17!=b[c].length||!validateMac(b[c])||/[0\:]{17}$/.test(b[c])||/[f\:]{17}$/i.test(b[c])||parseInt(b[c].split(":")[0],16)&1){a.errorMessages.push("Invalid MAC Address format: Please try again.");
break}};a.save=function(){a.errorMessages=[];a.checkFilters(a.filter0.macs);0==a.errorMessages.length&&a.checkFilters(a.filter1.macs);0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.filter0.mode=parseInt(a.filter0.mode),a.filter1.mode=parseInt(a.filter1.mode),a.filter0.$update({id:0},function(){a.filter1.$update({id:1},function(){c.path("/wireless/advanced")})}))};a.chkBeforeSaveNow=function(){f.showNotifyRestartMsg("Warning",[""]).then(function(b){"cancel"!=b&&a.save()})};a.chkBeforeSave=
function(){var b=!0,c=e.query(function(){var d=g.get({id:0},function(){a.wpsEnabled=d.enabled;b=!0;a.wire0=c[0].radioEnabled;a.wire1=c[1].radioEnabled;var e=c[0].wpsEnabled,g=c[1].wpsEnabled;a.wire0||a.wire1||(b=!1);e||g||(b=!1);a.wpsEnabled&&!b&&(a.wpsEnabled=!1);var g=e=!1,z="",v="";a.filter0.enabled&&0==a.filter0.mode&&0==a.filter0.macs.length&&(e=!0);a.filter1.enabled&&0==a.filter1.mode&&0==a.filter1.macs.length&&(g=!0);a.warningFlg=a.wpsEnabled?e||g?!0:!1:!1;a.warningFlg?(e&&g?(z="2.4GHz and 5.0GHz",
v="networks"):g?(z="5.0GHz",v="network"):e&&(z="2.4GHz",v="network"),f.showCustomMessage1("Warning",["If Access List (MAC address filter) is enabled with no accepted devices (an empty white list) for the "+z+" wireless "+v+", then WPS will be disabled for the "+z+" wireless "+v+".","Are you sure you want to enable Access List with no accepted devices?","Press OK to continue or Cancel."]).then(function(b){"cancel"!=b&&a.check5GHZList()})):a.check5GHZList()})})};a.check5GHZList=function(){a.filter1.enabled?
f.showAutoConnectMsgAuth("","").then(function(b){"cancel"!=b&&a.chkBeforeSaveNow()}):a.chkBeforeSaveNow()};a.removeMac=function(b,c){0==b?a.filter0.macs.splice(c,1):a.filter1.macs.splice(c,1)};a.addFilter=function(b){a.errorMessages=[];if(0==b)if(angular.isUndefined(a.newMac0))a.errorMessages.push("MAC Address: MAC address must consist of 6 fields. Each field's value must be between 00 and FF (in hexadecimal representation), without any spaces. The LSB of the first byte must be zero.");else if(0!=
a.errorMessages.length||validateMac(a.newMac0)&&notAcceptedMac(a.newMac0)&&/^([0-9A-Fa-f]{2}[:]){5}([0-9A-Fa-f]{2})$/.test(a.newMac0)){for(b=0;b<a.filter0.macs.length;b++)if(a.newMac0==a.filter0.macs[b])return;a.filter0.macs.push(a.newMac0);a.newMac0=""}else a.errorMessages.push("MAC Address: MAC address must consist of 6 fields. Each field's value must be between 00 and FF (in hexadecimal representation), without any spaces. The LSB of the first byte must be zero.");else if(angular.isUndefined(a.newMac1))a.errorMessages.push("MAC Address: MAC address must consist of 6 fields. Each field's value must be between 00 and FF (in hexadecimal representation), without any spaces. The LSB of the first byte must be zero.");
...
-1;a.bothDisabled=!1;a.basicGuestWifiEnabled=!1;a.guestPassWifiEnabled=!1;a.guestWifiEnum={BASIC_GUEST_WIFI:2};a.tabsEnum={1:"partials/wireless/guestDevicesTab.html?v=v1.0.149",2:"partials/wireless/basicGuestWifiTab.html?v=v1.0.149"};a.section=b.current.section;b=c.path();-1!=b.indexOf("/wireless/guestWifiSetup/devices")?a.currentTab=1:-1!=b.indexOf("/wireless/guestWifiSetup/basic")?a.currentTab=2:a.wireless1=d.query(function(){a.wirelessA1=a.wireless1[0];a.basicGuestWifi1=a.wireless1[a.guestWifiEnum.BASIC_GUEST_WIFI];
...
function(b){return a.currentTab===b};a.setActive=function(a){switch(a){case 1:c.url("/wireless/guestWifiSetup/devices");break;case 2:c.url("/wireless/guestWifiSetup/basic");break;default:c.url("/wireless/guestWifiSetup/basic")}};a.getActive=function(){return a.currentTab}}]).controller("GuestWifiSetupCtrl",["$scope","$route","$location","Wireless","GuestDevices","GuestPassDevices","Devices","$rootScope","securityTips",function(a,b,c,d,e,f,g,h,k){a.bothDisable=!1;a.pageToShow=0;a.tab=b.current.tab;
a.section=b.current.section;a.tempDevices=null;a.refresh=function(){a.guestDevices=null;a.wireless=d.query(function(){a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];a.basicGuestWifi.enabled?a.guestDevices=g.query(function(){for(var b=0;b<a.guestDevices.length;b++)a.guestDevices[b].toDisplay=!1,6==a.guestDevices[b].connectionType&&(a.basicGuestWifi.enabled&&(a.guestDevices[b].ssid=a.basicGuestWifi.ssid),a.guestDevices[b].toDisplay=!0,setDeviceStyle(a.guestDevices[b],""))}):a.bothDisable=
!0});a.togglePage(0)};a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.refresh();a.toggleOnOffSave=function(b){a.tempDevices=b;a.toggleOnOffSaveNow(a.tempDevices)};a.toggleOnOffSaveMsg=function(){k.showNotifyRestartMsg("Warning",[""]).then(function(b){"cancel"!=b&&a.toggleOnOffSaveNow(a.tempDevices)})};a.toggleOnOffSaveNow=function(b){b.blocked=!b.blocked;g.update({id:b.id},b,function(){a.refresh()})}}]).controller("BasicGuestCtrl",["$scope","$route","$location","Wireless","GuestDevices",
"WPA","securityTips","$sce","$rootScope","Devices",function(a,b,c,d,e,f,g,h,k,n){a.warningFlag=!1;a.pageToShow=0;a.tab=b.current.tab;a.section=b.current.section;a.keySet=!1;a.showPassword=!0;k.editingGuest=!1;k.guestHasChanges=!1;a.countDownPopup=null;a.fakeTimer=!1;a.listener=null;a.tempWPAkey="";a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.refresh=function(){a.showPassword=!0;a.wireless=d.query(function(){a.wirelessA=a.wireless[0];a.wirelessB=a.wireless[1];a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];
a.basicGuestWifi.ssid=a.basicGuestWifi.ssid;a.tempWPAkey="";void 0!=a.basicGuestWifi&&null!=a.basicGuestWifi&&(a.guestDevices=n.query(function(){a.guestDevices=filterOutNonGuest(a.guestDevices)}),a.wpa=f.get({id:a.guestWifiEnum.BASIC_GUEST_WIFI},function(){void 0!=a.wpa.key&&(a.wpa.key=a.wpa.key,a.tempWPAkey=h.trustAsHtml(a.convertKey(a.wpa.key)),a.keySet=""!==a.wpa.key?!0:!1)}));a.warningFlag=void 0==a.basicGuestWifi||null==a.basicGuestWifi||a.basicGuestWifi.enabled?!1:!0});a.mainRefresh();a.togglePage(0)};
a.convertKey=function(a){var b="";if(a)for(var c=0;c<a.length;c++)b+="&bull;";return b=unescape(b)};a.refresh();a.toggleOnOffSave=function(){a.wirelessA.radioEnabled?a.basicGuestWifi.enabled?a.showAutoConnectMsg(1,""):a.keySet?a.showAutoConnectMsg(0,""):a.showAutoConnectMsg(2,""):g.showWirelease24GPrompt("","").then(function(a){})};a.showAutoConnectMsg=function(b,c){g.showAutoConnectMsgGuest("","").then(function(c){"cancel"==c?a.refresh():0==b?a.saveSettings(!0):1==b?(a.basicGuestWifi.enabled=!1,
a.saveToggle(!0)):2==b&&a.showKeyForm()})};a.saveSettings=function(b){a.basicGuestWifi.enabled=!0;a.saveToggle(b)};a.saveToggle=function(b){a.basicGuestWifi.radioFreq=a.wirelessA.radioEnabled?1:-1;clearTimeout(a.fakeTimer);a.countDownPopup=g.showSavingNow("Save Settings","Saving your settings. Please wait...");a.countDownPopup.open();a.fakeTimer=window.setTimeout(a.closeCountDownPopup1,15E3);d.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},a.basicGuestWifi,function(){b?a.refresh():a.saveWifiKey()})};
a.showKeyForm=function(){g.showCreateGuestWifiPassword("Create Password","Please create a password to activate your Guest Wi-Fi.",a.wpa).then(function(b){"cancel"==b.result?a.refresh():a.showNotifyRestartMsg1Popup(b)})};a.openValidationPopup=function(){g.showWarningMsgGuestWifi("","Password has to be at least 8 characters long",!1,[""]).then(function(b){"ok"==b&&a.showKeyForm()})};a.openValidationPopup1=function(){g.showWarningMsgGuestWifi("","Password has to be at least 8 characters long",!1,[""]).then(function(a){})};
a.openValidationPopup2=function(){g.showWarningMsgGuestWifi("","SSID must be 1 to 64 characters",!1,[""]).then(function(a){})};a.openValidationPopup3=function(){g.showWarningMsgGuestWifi2("","SSID must be 1 to 64 characters",!1,[""]).then(function(a){})};a.saveWifiKey=function(){a.wpa.encryptionAlgorithm=parseInt(a.wpa.encryptionAlgorithm);f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{type:a.wpa.type,mode:a.wpa.mode,encryptionAlgorithm:a.wpa.encryptionAlgorithm,groupKeyUpdateInterval:a.wpa.groupKeyUpdateInterval,
groupKeyUpdateIntervalEnabled:a.wpa.groupKeyUpdateIntervalEnabled,key:a.wpa.key},function(){})};a.editWifiSettings=function(){k.editingGuest=!0;k.guestHasChanges=!1};a.saveWifiSettings=function(){var b=!1,c=!1;if(8>a.wpa.key.length||63<a.wpa.key.length)b=!0;if(1>a.basicGuestWifi.ssid.length||64<a.basicGuestWifi.ssid.length||!/^[0-9a-zA-Z\!\"\#\$\%\&\u2019\'\(\)\*\+\,\-\.\/\:\;\<\=\>\?\@\[\\\]\^\_\`\{\|\}\~\ ]+$/i.test(a.basicGuestWifi.ssid))c=!0;c&&b?(a.cancelRedirect(),a.openValidationPopup3()):
c?(a.cancelRedirect(),a.openValidationPopup2()):b?(a.cancelRedirect(),a.openValidationPopup1()):a.showNotifyRestartMsgPopup()};a.closeCountDownPopup1=function(){a.countDownPopup.close();a.countDownPopup=null;a.basicGuestWifi.ssid="";a.refresh();k.editingGuest=!1};a.closeCountDownPopup=function(){a.countDownPopup.close();a.countDownPopup=null;k.locationChangeActivate?a.redirect():(a.basicGuestWifi.ssid="",a.refresh(),k.editingGuest=!1)};a.cancel=function(){a.refresh();k.editingGuest=!1;k.guestHasChanges=
!1};a.change=function(){k.guestHasChanges=!0};a.saveContents1Function=function(b){a.showNotifyRestartMsg2Popup()};a.listener=k.$on("saveContents1",a.saveContents1Function);a.$on("$destroy",function(){a.listener()});a.redirect=function(){k.locationChangeActivate=!1;k.editingGuest=!1;k.guestHasChanges=!1;""==getNextLocationForLocationChangeSub(k.locationChangeNext)?c.path(getNextLocationForLocationChange(k.locationChangeNext)):c.path(getNextLocationForLocationChange(k.locationChangeNext)).search(getNextLocationForLocationChangeSub(k.locationChangeNext))};
a.toggleShowPassword=function(){f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{wpaShowKeyInUI:a.wpa.wpaShowKeyInUI},function(){})};a.cancelRedirect=function(){k.locationChangeActivate=!1};a.showNotifyRestartMsgPopup=function(){g.showNotifyRestartMsg("Warning",[""]).then(function(b){"cancel"!=b&&(a.basicGuestWifi.ssid=a.basicGuestWifi.ssid,clearTimeout(a.fakeTimer),a.countDownPopup=g.showSavingNow("Save Settings","Saving your settings. Please wait..."),a.countDownPopup.open(),a.fakeTimer=window.setTimeout(a.closeCountDownPopup,
15E3),d.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},a.basicGuestWifi,function(){f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{wpaShowKeyInUI:a.wpa.wpaShowKeyInUI},function(){a.saveWifiKey()})}))})};a.showNotifyRestartMsg1Popup=function(b){g.showNotifyRestartMsg("Warning",[""]).then(function(c){if("cancel"!=c){c=!1;if(void 0==b.returnObj)c=!0;else if(a.wpa.key=b.returnObj,8>a.wpa.key.length||63<a.wpa.key.length)c=!0;c?a.openValidationPopup():f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{wpaShowKeyInUI:b.wpaShowKeyInUI},
function(){a.saveSettings(!1)})}})};a.showNotifyRestartMsg2Popup=function(){g.showNotifyRestartMsg("Warning",[""]).then(function(b){"cancel"==b?a.cancelRedirect():a.saveWifiSettings()})}}]).controller("BasicGuestCtrlPopup",["$scope","WPA","model","dialog",function(a,b,c,d){a.key=c.key;a.wpaPopup=c.wpa;a.buttons=c.buttons;a.title=c.title;a.message=c.message;a.close=function(b){d.close({result:b,returnObj:a.key,wpaShowKeyInUI:a.wpaPopup.wpaShowKeyInUI})}}]).controller("GuestPassWifiCtrl",["$scope",
"$route","$location","Wireless","GuestPassDevices","securityTips","Devices","$rootScope",function(a,b,c,d,e,f,g,h){a.warningFlag=!1;a.pageToShow=0;a.tab=b.current.tab;a.section=b.current.section;h.editingGuest=!1;h.guestHasChanges=!1;a.listener=null;a.countDownPopup=null;a.fakeTimer=null;a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.refresh=function(){a.wireless=d.query(function(){a.wirelessA=a.wireless[0];a.wirelessB=a.wireless[1];a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];
a.guestPassWifi=a.wireless[a.guestWifiEnum.GUEST_PASS];a.guestPassWifi.ssid=a.guestPassWifi.ssid;void 0!=a.guestPassWifi&&null!=a.guestPassWifi&&(a.guestDevices=g.query(function(){a.guestDevices=filterOutNonGuest(a.guestDevices)}));a.warningFlag=void 0!=a.guestPassWifi&&null!=a.guestPassWifi&&!a.guestPassWifi.enabled&&void 0!=a.basicGuestWifi&&null!=a.basicGuestWifi&&a.basicGuestWifi.enabled?!0:!1});a.mainRefresh();a.togglePage(0)};a.refresh();a.toggleOnOffSave=function(){a.wirelessA.radioEnabled?
a.guestPassWifi.enabled?(a.guestPassWifi.enabled=!1,a.saveToggle()):a.basicGuestWifi.enabled?f.showWarningMsgGuestWifi3("","This will disable Basic Guest Wi-Fi and open your Wi-Fi to an unsecure security model.",!0,[""]).then(function(b){"cancel"!=b&&(a.guestPassWifi.enabled=!0,a.basicGuestWifi.enabled=!1,a.saveToggle())}):(a.guestPassWifi.enabled=!0,a.saveToggle()):f.showWirelease24GPrompt("","").then(function(a){})};a.saveToggle=function(){a.basicGuestWifi.radioFreq=a.wirelessA.radioEnabled?1:-1;
a.guestPassWifi.radioFreq=a.wirelessA.radioEnabled?1:-1;a.guestPassWifi.ssid=a.guestPassWifi.ssid;clearTimeout(a.fakeTimer);a.countDownPopup=f.showSavingNow("Save Settings","Saving your settings. Please wait...");a.countDownPopup.open();a.fakeTimer=window.setTimeout(a.closeCountDownPopup,15E3);d.update({id:a.guestWifiEnum.GUEST_PASS},a.guestPassWifi,function(){})};a.closeCountDownPopup=function(){a.countDownPopup.close();a.countDownPopup=null;h.locationChangeActivate?a.redirect():(a.guestPassWifi.ssid=
"",a.refresh(),h.editingGuest=!1)};a.editWifiSettings=function(){h.editingGuest=!0;h.guestHasChanges=!1};a.openValidationPopup2=function(){f.showWarningMsgGuestWifi("","SSID must be 1 to 64 characters",!1,[""]).then(function(a){})};a.saveWifiSettings=function(){var b=!1;if(1>a.guestPassWifi.ssid.length||64<a.guestPassWifi.ssid.length||!/^[0-9a-zA-Z\!\"\#\$\%\&\u2019\'\(\)\*\+\,\-\.\/\:\;\<\=\>\?\@\[\\\]\^\_\`\{\|\}\~\ ]+$/i.test(a.guestPassWifi.ssid))b=!0;b?(a.cancelRedirect(),a.openValidationPopup2()):
a.saveToggle()};a.cancel=function(){a.refresh();h.editingGuest=!1;h.guestHasChanges=!1};a.change=function(){h.guestHasChanges=!0};a.saveContents2Function=function(b){a.saveWifiSettings()};a.listener=h.$on("saveContents2",a.saveContents2Function);a.$on("$destroy",function(){a.listener()});a.redirect=function(){h.locationChangeActivate=!1;h.editingGuest=!1;h.guestHasChanges=!1;""==getNextLocationForLocationChangeSub(h.locationChangeNext)?c.path(getNextLocationForLocationChange(h.locationChangeNext)):
c.path(getNextLocationForLocationChange(h.locationChangeNext)).search(getNextLocationForLocationChangeSub(h.locationChangeNext))};a.cancelRedirect=function(){h.locationChangeActivate=!1}}]);
