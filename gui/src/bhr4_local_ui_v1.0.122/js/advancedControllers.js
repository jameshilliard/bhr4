      ...
      $scope.applyProtocol = function() {
        ...
        switch($scope.protocols.protocol) {
          case 0: {
            ...
            if(pro == null || pro === '' || isNaN(pro) || pro < 0 || pro > 255 || isNotaInt(pro))
            {
    ...
    function($scope, $route, $location, IPv6) {
      ...
      $scope.save = function() {
        if(!$scope.ipv6.enabled) {
          ...
          if($scope.ipv6.advertisementLifetime === '' || isNaN($scope.ipv6.advertisementLifetime) || $scope.ipv6.advertisementLifetime < 0 || $scope.ipv6.advertisementLifetime > 150 || !checksForDecimalNumber($scope.ipv6.advertisementLifetime))
          ...
          if($scope.ipv6.mode != 0 && $scope.ipv6.lanMode == 1) {
            if($scope.ipv6.addressLifetime === '' || isNaN($scope.ipv6.addressLifetime) || $scope.ipv6.addressLifetime < 3 || $scope.ipv6.addressLifetime > 150 || !checksForDecimalNumber($scope.ipv6.addressLifetime))
  ...
  .controller('PortConfigCtrl', ['$scope', '$route', '$location', 'Ethernet',
    ...
    function($scope, $route, $location, Routes, NetworkConnections, SystemSettings) {
      ...
      $scope.saveRoute = function() {
        ...
        if($scope.routeEditing.metric == null || $scope.routeEditing.metric === '' || isNaN($scope.routeEditing.metric) || $scope.routeEditing.metric < 0 || $scope.routeEditing.metric > 255 || isNotaInt($scope.routeEditing.metric))
