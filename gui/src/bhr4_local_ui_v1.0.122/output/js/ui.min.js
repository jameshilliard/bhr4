...
function(){a.isFileSubmitted=!0};a.fileUpgradePage=function(){h(function(){document.getElementById("submitting").focus()},1E3);a.inputfile=null;a.page=1;window.scrollTo(0,0)};a.testConnection=function(){e.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),clearTimeout(a.fakeTimer),f.path("/login").search({rebooting:"true"})):window.setTimeout(a.testConnection,3E3)})};a.chooseFile=function(){h(function(){document.getElementById("submitting").focus()},
...
!1;window.uploadDone=function(){if(a.loadFile)var b=d.get(function(){b.successful?(e.save(function(){window.setTimeout(a.testConnection,0)}),a.completed=!0):(a.errorMessages=["Configuration File: Bad format of configuration file."],a.showErrorPage=!0)})};a.testConnection=function(){g.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,h.removeAll(),c.path("/login").search({rebooting:"true"})):window.setTimeout(a.testConnection,3E3)})};a.toggleShow=function(b){k(function(){document.getElementById("submitting").focus()},
1E3);a.loadFile=!a.loadFile;0==b&&(a.inputFile=null)};a.errorPageOk=function(){a.showErrorPage=!1;a.loadFile=!1;a.completed=!1;a.isFileSubmitted=!1;window.scrollTo(0,0)};a.submittingFile=function(){a.isFileSubmitted=!0};a.saving=function(){f.get(function(a){window.location="api/settings/configfile"})};a.loadConfig=function(){document.getElementById("submitting").focus()};a.setFocus=function(){k(function(){document.getElementById("submitting").focus()},500)};a.keyPress=function(b){13==b.keyCode&&"/advanced/configfile"==
c.path()&&(a.loadFile||c.path("/advanced"))}}]).controller("diagnosticsCtrl",["$scope","$route","$rootScope","Diagnostics","$location",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;a.destination="";a.pingCount=4;a.showErrorPage=!1;a.previousPath=c.pre_path;a.isCancelled=!1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.refresh=function(){var b=d.get(function(){a.destination=b.destination;a.pingCount=b.count;a.total=b.count;a.status=b.running?1:0;a.testRan=
!0;null==b.transmitted?b.running?window.setTimeout(a.refresh,1E3):a.testRan=!1:(a.sent=b.transmitted,a.received=b.received,0==a.received&&0==a.sent&&0==a.status&&(a.status=5),0==a.status&&a.sent!=a.total&&(a.status=4),0==a.status&&a.sent==a.total&&a.received!=a.sent&&(a.status=2),a.loss=0<a.sent?Math.floor((a.sent-a.received)/a.sent*100):0,a.isCancelled&&(a.status=4),0<a.received?(a.min=b.min.toFixed(2),a.max=b.max.toFixed(2),a.average=b.average.toFixed(2),a.hasResults=!0):a.hasResults=!1,1==a.status&&
b.transmitted!=b.count&&window.setTimeout(a.refresh,1E3))})};a.goButton=function(){a.isCancelled=!1;a.errorMessages=[];var b=a.destination.split("."),c=!1;(c=validateIp(b))||(c=validateIPv6(a.destination));b=validateGivenHostName(a.destination);c||b||a.errorMessages.push("Server Address: The value must be a valid IP address or a valid domain name.");(isNaN(a.pingCount)||1>a.pingCount||999<a.pingCount)&&a.errorMessages.push("Number of pings: Please enter a numeric value between 1 and 999.");0<a.errorMessages.length?
(a.showErrorPage=!0,window.scrollTo(0,0)):(a.status=-1,a.total=4,a.sent=0,a.received=0,a.loss=0,a.hasResults=!1,d.save({destination:a.destination,count:parseInt(a.pingCount)},function(){a.status=-1;a.refresh()}))};a.cancel=function(){a.isCancelled=!0;d.remove({})};a.keyPress=function(b){13==b.keyCode&&"/advanced/diagnostics"==e.path()&&a.goButton()};a.refresh()}]).controller("defaultsCtrl",["$scope","$route","Defaults","Login","Reboot","SystemSettings","$location","$templateCache",function(a,b,c,
d,e,f,g,h){a.tab=b.current.tab;a.section=b.current.section;a.restDefaults=0;a.resetType=0;a.restarting=!1;a.defaults=function(){a.restDefaults=1};a.cancel=function(){a.restDefaults=0};a.restoreDefaults=function(){a.restDefaults=2;c.save({resetType:parseInt(a.resetType)},function(){e.save(function(){window.setTimeout(a.testConnection,0)})})};a.saving=function(){d.get(function(a){window.location="api/settings/configfile"})};a.testConnection=function(){f.get(function(){window.setTimeout(a.testConnection,
3E3)},function(b){401==b.status?(a.restarting=!0,h.removeAll(),0==a.resetType?g.path("/setup"):g.path("/login").search({rebooting:"true"})):window.setTimeout(a.testConnection,3E3)})}}]).controller("rebootCtrl",["$scope","$route","Reboot","SystemSettings","Login","$location","$templateCache",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=d.get();a.rebooting=!1;a.restarting=!1;a.reboot=function(){a.rebooting=!0;c.save(function(){window.setTimeout(a.testConnection,
0)})};a.testConnection=function(){d.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),f.path("/login").search({rebooting:"true"})):window.setTimeout(a.testConnection,3E3)})};a.keyPress=function(b){13==b.keyCode&&"/advanced/reboot"==f.path()&&a.reboot()}}]).controller("macCloningCtrl",["$scope","$route","$location","MacCloning",function(a,b,c,d){a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.macCloning=d.get(function(){a.macAddress=
...
(a.showErrorPage=!0,window.scrollTo(0,0)):(a.protocols.icmpType=parseInt(a.protocols.icmpType),a.protocols.icmpCode=parseInt(a.protocols.icmpCode),applyProtocol(a,a.tempPortForward.protocols),printProtocol(2,a.tempPortForward.protocols,a.printPortsArr))};a.cancelPortForwardRule=function(){cancelService(a);a.tempPortForward={name:"Global Application",description:"",protocols:[]}};a.cancelProtocol=function(){cancelProtocol(a)};a.editPortForwardRule=function(b){a.tempPortForward.name=a.portForwardRules[b].name;
a.tempPortForward.description=a.portForwardRules[b].description;a.tempPortForward.servType=a.portForwardRules[b].servType;a.tempPortForward.protocols=[];for(var c=0;c<a.portForwardRules[b].protocols.length;c++){var d={};copyProtocol(d,a.portForwardRules[b].protocols[c]);a.tempPortForward.protocols.push(d)}a.printPortsArr=[];printProtocol(2,a.tempPortForward.protocols,a.printPortsArr);a.editing=b;a.togglePage(3)};a.editProtocol=function(b){editProtocol(a,b,a.tempPortForward.protocols)};a.removePortForwardRule=
function(b){a.errorMessages=[];for(var d=a.portForwardRules[b].name,e=0;e<a.nat.length;e++)for(var f=0;f<a.nat[e].services.length;f++)if(d===a.nat[e].services[f].name){a.errorMessages.push("Protocol: Protocol is in use.");break}if(0==a.errorMessages.length)for(e=0;e<a.forwards.length;e++)for(f=0;f<a.forwards[e].protocols.length;f++)if(d===a.forwards[e].name){a.errorMessages.push("Protocol: Protocol is in use.");break}0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):c.remove({id:a.portForwardRules[b].id},
function(){a.portForwardRules=c.query(function(){a.portForwardRules=sortListItems(a.portForwardRules);a.printProtArr=[];printProtocol(1,a.portForwardRules,a.printProtArr)})})};a.removeProtocol=function(b){removeObject(a.tempPortForward.protocols,b);a.printPortsArr=[];printProtocol(2,a.tempPortForward.protocols,a.printPortsArr)};a.keyPress=function(b){13==b.keyCode&&"/advanced/portforward"==f.path()&&(0!=a.pageToShow||a.showErrorPage?3!=a.pageToShow||a.showErrorPage?4!=a.pageToShow||a.showErrorPage||
a.applyProtocol():a.applyPortForwardRule():f.path("/advanced"))}}]).controller("dnsServerCtrl",["$scope","$route","DnsServer","securityTips","$location",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;a.dnsServer=c.query();a.showErrorPage=!1;a.showAdd=!1;a.editing=-1;a.runFocus=!1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.validateBeforeSave=function(){a.errorMessages=[];validateHostname(a.tempDnsServer.hostname)||a.errorMessages.push("Host Name: Name may not contain spaces. Only letters, digits and the special characters dash (-), underscore (_) and dot (.) may be used. These special characters may not appear at the beginning or at the end of a name. The maximum length of a label (text between two dots) is 63.");
...
a.errorMessages.push("IP Address: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces.");for(var b=0;b<a.dnsServer.length;b++)a.editing!=b&&(a.tempDnsServer.hostname==a.dnsServer[b].hostname&&a.errorMessages.push("Host Name: This name is already used by another DNS object."),getIpString(a.tempDnsServer.ipAddress)==a.dnsServer[b].ipAddress&&a.errorMessages.push("IP Address:You have entered an IP address that already exists. Please enter new IP address."));
0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):hasADot(a.tempDnsServer.hostname)?d.showWarningMsgBeforeSaving("DNS Entry","Hostnames including a period (.) may not resolve correctly.",[""]).then(function(b){"cancel"!=b&&a.save()}):a.save()};a.save=function(){var b={hostname:a.tempDnsServer.hostname,type:a.tempDnsServer.type};1==b.type&&(b.ipAddress=getIpString(a.tempDnsServer.ipAddress));-1==a.editing?c.save(b,function(){a.dnsServer=c.query()}):c.update({id:a.dnsServer[a.editing].id},
b,function(){a.dnsServer=c.query()});a.tempDnsServer={};a.toggleShow()};a.toggleShow=function(){a.showAdd=!a.showAdd};a.addDnsEntry=function(){a.tempDnsServer={hostname:"new-host",type:1,ipAddress:[0,0,0,0]};a.runFocus=!0;a.editing=-1;a.toggleShow()};a.editDnsEntry=function(b){a.editing=b;a.tempDnsServer={hostname:a.dnsServer[a.editing].hostname,type:a.dnsServer[a.editing].type};1==a.tempDnsServer.type&&(a.tempDnsServer.ipAddress=splitIpArr(a.dnsServer[a.editing].ipAddress));a.showAdd=!a.showAdd};
a.removeDnsEntry=function(b){c.remove({id:a.dnsServer[b].id},function(){a.dnsServer=c.query()})};a.keyPress=function(b){13==b.keyCode&&"/advanced/dnsserver"==e.path()&&(a.showAdd?a.showAdd&&!a.showErrorPage&&a.save():e.path("/advanced"))}}]).controller("ipv6Ctrl",["$scope","$route","$location","IPv6",function(a,b,c,d){a.tab=b.current.tab;a.section=b.current.section;a.ipv6=d.get(function(){a.ipv6.addressStart=a.ipv6.addressStart.toString(16);a.ipv6.addressEnd=a.ipv6.addressEnd.toString(16);for(var b=
0;b<a.ipv6.interfaces.length;b++)a.ipv6.interfaces[b].name=unescape(a.ipv6.interfaces[b].name);a.autoDns=1==a.ipv6.mode?a.ipv6.autoDns:0});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.save=function(){if(a.ipv6.enabled){a.errorMessages=[];a.ipv6.autoDns=a.autoDns;if(2==a.ipv6.mode)if(a.ipv6.staticAddress=a.ipv6.staticAddress.replace(/^\s+|\s+$/g,""),a.ipv6.staticDefaultGateway=a.ipv6.staticDefaultGateway.replace(/^\s+|\s+$/g,""),a.ipv6.staticPrimaryDns=a.ipv6.staticPrimaryDns.replace(/^\s+|\s+$/g,
...
(""===a.ipv6.advertisementLifetime||isNaN(a.ipv6.advertisementLifetime)||0>a.ipv6.advertisementLifetime||150<a.ipv6.advertisementLifetime||!checksForDecimalNumber(a.ipv6.advertisementLifetime))&&a.errorMessages.push("Router Advertisement Lifetime: Please enter a numeric value between 0 and 150.");0!=a.ipv6.mode&&1==a.ipv6.lanMode&&(""===a.ipv6.addressLifetime||isNaN(a.ipv6.addressLifetime)||3>a.ipv6.addressLifetime||150<a.ipv6.addressLifetime||!checksForDecimalNumber(a.ipv6.addressLifetime))&&a.errorMessages.push("IPv6 Address Lifetime: Please enter a numeric value between 3 and 150.");
if(0<a.errorMessages.length)a.showErrorPage=!0,window.scrollTo(0,0);else{a.ipv6.mode=parseInt(a.ipv6.mode);switch(a.ipv6.mode){case 0:a.ipv6.autoDns=2;break;case 1:a.ipv6.autoDns=parseInt(a.autoDns);break;case 2:a.ipv6.autoDns=1}a.ipv6.staticPrefixLength=parseInt(a.ipv6.staticPrefixLength);a.ipv6.lanMode=parseInt(a.ipv6.lanMode);a.ipv6.advertisementLifetime=parseInt(a.ipv6.advertisementLifetime);a.ipv6.addressLifetime=parseInt(a.ipv6.addressLifetime);a.ipv6.addressStart=f;a.ipv6.addressEnd=g;for(b=
0;b<a.ipv6.interfaces.length;b++)a.ipv6.interfaces[b].name=escape(a.ipv6.interfaces[b].name).replace(/\+/g,"%2B");a.ipv6.$update(function(){a.ipv6.addressStart=a.ipv6.addressStart.toString(16);a.ipv6.addressEnd=a.ipv6.addressEnd.toString(16);for(var b=0;b<a.ipv6.interfaces.length;b++)a.ipv6.interfaces[b].name=unescape(a.ipv6.interfaces[b].name);c.path("/advanced")})}}else d.update({enabled:!1},function(){c.path("/advanced")})};a.keyPress=function(b){13==b.keyCode&&"/advanced/ipv6"==c.path()&&a.save()}}]).controller("ArpCtrl",
...
"0.0.0.0"==getIpString(a.routeEditing.netmask)&&a.errorMessages.push("Netmask: Subnet mask may not be 0.0.0.0. Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0.");(null==a.routeEditing.metric||""===a.routeEditing.metric||isNaN(a.routeEditing.metric)||0>a.routeEditing.metric||255<a.routeEditing.metric||isNotaInt(a.routeEditing.metric))&&a.errorMessages.push("Metric: Please enter a numeric value between 0 and 255.");
"0.0.0.0"==getIpString(a.routeEditing.gateway)&&a.errorMessages.push("Gateway: IP Address may not be 0.0.0.0.");validateIp(a.routeEditing.gateway)||a.errorMessages.push("Gateway : IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces.");for(var b=!0,c=!1,e=0;4>e;e++){for(var f=7;-1<f;f--){var p=1==(a.routeEditing.netmask[e]>>f&1);if(p&&c){b=!1;break}p||(c=!0)}if(!b)break}b||a.errorMessages.push("Netmask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0.");
0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.editingRoute=!1,a.routeEditing.type=parseInt(a.translateRouteEnum(a.routeEditing.type,!1)),a.routeEditing.destination=getIpString(a.routeEditing.destination),a.routeEditing.netmask=getIpString(a.routeEditing.netmask),a.routeEditing.gateway=getIpString(a.routeEditing.gateway),a.routeEditing.metric=parseInt(a.routeEditing.metric),-1!=a.routeIndex?d.update({id:a.routeIndex},a.routeEditing,function(){a.routingObject=d.get(function(){a.routes=
a.routingObject.routes})}):d.save(a.routeEditing,function(){a.routingObject=d.get(function(){a.routes=a.routingObject.routes})}))};a.translateRouteEnum=function(a,b){if(b)switch(parseInt(a)){case 0:return 0;case 2:return 1;case 3:return 2}else switch(parseInt(a)){case 0:return 0;case 1:return 2;case 2:return 3}};a.selectOpt=function(){a.runFocus=!0};a.keyPress=function(b){13==b.keyCode&&"/advanced/routing"==c.path()&&(a.editingRoute||a.showErrorPage||a.showIGMPwarning?a.editingRoute&&!a.showErrorPage&&
a.saveRoute():a.save(a.routingObject.igmpRouting))}}]).controller("UPnPCtrl",["$scope","$route","$location","UPnP",function(a,b,c,d){a.tab=b.current.tab;a.section=b.current.section;a.upnpSettings=d.get();a.save=function(){a.upnpSettings.$update(function(){c.path("/advanced")})}}]).controller("dynamicDnsCtrl",["$scope","$route","$location","DynamicDNS","DynamicDNSProvider","$window","securityTips","SystemSettings",function(a,b,c,d,e,f,g,h){a.sysSettings=h.get();a.pageToShow=0;a.toggleWarningPage=function(b){a.pageToShow=
b;window.scrollTo(0,0)};a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.showAddEdit=!1;a.editing=-1;a.ddnsObjects=[];a.ddnsObject={};a.runFocus=!1;a.getTitle=function(a){return getStatusTitle(a)};a.show=function(a){g.showMessage(getStatusTitle(a.status),a.errorMessage)};a.init_DDNSObject=function(){a.ddnsObject={hostname:"",provider:"",username:"",password:"",useSsl:!0,status:"",lastUpdate:""}};a.loadProviders=function(){a.ddnsProviders=e.query(function(){0<a.ddnsProviders.length&&
(a.ddnsObject.provider=a.ddnsProviders[0])})};a.refresh=function(){a.ddnsObjects=[];a.dynamicDNSObjects=d.query(function(){for(var b,c=0;c<a.dynamicDNSObjects.length;c++)b={},b.id=a.dynamicDNSObjects[c].id,b.hostname=unescape(a.dynamicDNSObjects[c].hostname),b.lastUpdate=unescape(a.dynamicDNSObjects[c].updateTime),b.status=unescape(a.dynamicDNSObjects[c].status),b.errorMessage=unescape(a.dynamicDNSObjects[c].errorMessage),b.hyperLink=0===a.dynamicDNSObjects[c].status||1===a.dynamicDNSObjects[c].status?
!1:!0,void 0==b&&b.hostname==b||a.ddnsObjects.push(b)});a.loadProviders()};a.refresh();a.togglePage=function(b){a.showAddEdit=!1};a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.addDDNS=function(){a.loadProviders();a.showErrorPage=!1;a.showAddEdit=!0;a.editing=-1;a.init_DDNSObject();a.runFocus=!0};a.openSub=function(){""!=a.ddnsObject.provider&&(a.DnsLink=a.ddnsObject.provider.url,f.open(a.DnsLink))};a.editDDNSObj=function(b){a.showAddEdit=!0;a.showErrorPage=!1;a.editing=b;a.ddnsObject=
...
a.errorMessages.push("Host Name: Name may not contain spaces. Only letters, digits and the special characters dash (-), underscore (_) and dot (.) may be used. These special characters may not appear at the beginning or at the end of a name. The maximum length of a label (text between two dots) is 63.")}else a.errorMessages.push("Host Name: Name may not contain spaces. Only letters, digits and the special characters dash (-), underscore (_) and dot (.) may be used. These special characters may not appear at the beginning or at the end of a name. The maximum length of a label (text between two dots) is 63.");
...
break}a.pfRules=sortListItems(a.pfRules);removeObject(a.services,b)};a.applyProtocol=function(){a.errorMessages=[];a.protocols.protocol=parseInt(a.protocols.protocol);a.protocols.incomingPorts=parseInt(a.protocols.incomingPorts);a.protocols.outgoingPorts=parseInt(a.protocols.outgoingPorts);a.protocols.icmpMessage=parseInt(a.protocols.icmpMessage);a.protocols.protocolNumber=parseInt(a.protocols.protocolNumber);var b=a.protocols.incomingPortStart,c=a.protocols.incomingPortEnd,d=a.protocols.outgoingPortStart,
e=a.protocols.outgoingPortEnd;switch(a.protocols.protocol){case 0:var g=a.protocols.protocolNumber;(null==g||""===g||isNaN(g)||0>g||255<g)&&a.errorMessages.push("Protocol Number: Please enter a numeric value between 0 and 255.");break;case 1:case 2:switch(a.protocols.incomingPorts){case 1:(null==b||""===b||1>b||65535<b)&&a.errorMessages.push("Source Port: Please enter a numeric value between 1 and 65535.");break;case 2:(null==b||""===b||1>b||65535<b)&&a.errorMessages.push("Start Source Port: Please enter a numeric value between 1 and 65535."),
...
case 3:if(10==a.protocols.icmpMessage){var g=a.protocols.icmpType,f=a.protocols.icmpCode;(null==g||""===g||0>g||255<g)&&a.errorMessages.push("ICMP Type:  Please enter a numeric value between 0 and 255.");(null==f||""===f||0>f||255<f)&&a.errorMessages.push("ICMP Code:  Please enter a numeric value between 0 and 255.")}}0==a.errorMessages.length&&(0==a.protocols.incomingPorts&&(a.protocols.incomingExclude=!1),0==a.protocols.outgoingPorts&&(a.protocols.outgoingExclude=!1),1==a.protocols.protocol||2==
a.protocols.protocol)&&(f=g=!1,0==a.protocols.incomingPorts?g=!0:2==a.protocols.incomingPorts&&!1==a.protocols.incomingExclude&&1==b&&65535==c&&(g=!0),0==a.protocols.outgoingPorts?f=!0:2==a.protocols.outgoingPorts&&!1==a.protocols.outgoingExclude&&1==d&&65535==e&&(f=!0),g&&f&&a.errorMessages.push('Port forwarding rules can not be Any-to-Any (or "source: 1-65535" with "destination: 1-65535").'));0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.protocols.icmpType=parseInt(a.protocols.icmpType),
a.protocols.icmpCode=parseInt(a.protocols.icmpCode),applyProtocol(a,a.service.protocols))};a.cancelProtocol=function(){cancelProtocol(a)};a.editProtocol=function(b){editProtocol(a,b,a.service.protocols)};a.removeProtocol=function(b){removeObject(a.service.protocols,b);a.setPrintArr(1)};a.scheduleChange=function(){a.runFocus=!0;-2!=a.sched&&-1==a.sched&&a.addSchedule()};a.addSchedule=function(){init_schedule(a);a.editingSchedule=!1;a.togglePage(5)};a.applyRuleScheduler=function(){a.runFocus=!0;a.errorMessages=
[];""===a.schedule.name&&a.errorMessages.push("Description: A string must be specified.");for(var b=0;b<a.schedArr.length;b++)if(b!=a.editingRuleSchedule&&a.schedArr[b].name==a.schedule.name){a.errorMessages.push("Name: This name is already used by another scheduler rule.");break}0==a.schedule.timeSegments.length&&a.errorMessages.push("Rule Schedule: At least one time segment should be defined.");if(0<a.errorMessages.length)a.showErrorPage=!0,window.scrollTo(0,0);else{var c={};copySchedule(c,a.schedule);
for(b=0;b<c.timeSegments.length;b++)for(var d=0;d<c.timeSegments[b].hourRanges.length;d++)c.timeSegments[b].hourRanges[d].startTimeHour=parseInt(c.timeSegments[b].hourRanges[d].startTimeHour),c.timeSegments[b].hourRanges[d].startTimeMinute=parseInt(c.timeSegments[b].hourRanges[d].startTimeMinute),c.timeSegments[b].hourRanges[d].endTimeHour=parseInt(c.timeSegments[b].hourRanges[d].endTimeHour),c.timeSegments[b].hourRanges[d].endTimeMinute=parseInt(c.timeSegments[b].hourRanges[d].endTimeMinute);a.schedule=
c;a.schedule.name=unescape(a.schedule.name);a.togglePage(0);a.printSchedArr=[];printSchedule(1,[a.schedule],a.printSchedArr)}};a.cancelRuleScheduler=function(){cancelRuleScheduler(a);a.editingSchedule||(a.sched=-2)};a.editRuleScheduler=function(){a.editingSchedule=!0;var b={};copySchedule(b,a.schedule);editRuleScheduler(a,[b],0)};a.removeRuleScheduler=function(b){a.sched=-2;a.printSchedArr=[]};a.applyTimeSegment=function(){a.errorMessages=[];for(var b=!1,c=0;c<a.daysOfTheWeek.length;c++)a.daysOfTheWeek[c]&&
(b=!0);b||a.errorMessages.push("Days of Week: At least one day must be selected.");0==a.hourRanges.length&&a.errorMessages.push("Hours Range: At least one hour range must be set.");0<a.errorMessages.length?a.showErrorPage=!0:applyTimeSegment(a);window.scrollTo(0,0)};a.cancelTimeSegment=function(){cancelTimeSegment(a)};a.editTimeSegment=function(b){editTimeSegment(a,b)};a.removeTimeSegment=function(b){removeObject(a.schedule.timeSegments,b)};a.applyHourRange=function(){a.runFocus=!0;a.errorMessages=
[];var b=a.hourRange.startTimeHour,c=a.hourRange.endTimeHour,d=a.hourRange.startTimeMinute,e=a.hourRange.endTimeMinute;(""===b||isNaN(b)||0>b||23<b)&&a.errorMessages.push("Start Time Hour: Please enter a numeric value between 0 and 23.");(""===c||isNaN(c)||0>c||23<c)&&a.errorMessages.push("End Time Hour: Please enter a numeric value between 0 and 23.");(""===d||isNaN(d)||0>d||59<d)&&a.errorMessages.push("Start Time Minutes: Please enter a numeric value between 0 and 59.");(""===e||isNaN(e)||0>e||
59<e)&&a.errorMessages.push("End Time Minutes: Please enter a numeric value between 0 and 59.");0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.hourRange.startTimeHour=parseInt(a.hourRange.startTimeHour),a.hourRange.startTimeMinute=parseInt(a.hourRange.startTimeMinute),a.hourRange.endTimeHour=parseInt(a.hourRange.endTimeHour),a.hourRange.endTimeMinute=parseInt(a.hourRange.endTimeMinute),applyHourRange(a))};a.cancelHourRange=function(){cancelHourRange(a)};a.editHourRange=function(b){editHourRange(a,
b)};a.removeHourRange=function(b){removeObject(a.hourRanges,b)};a.formatTimeString=function(a,b){return(10>a?"0"+a:a)+":"+(10>b?"0"+b:b)};a.keyPress=function(b){13==b.keyCode&&"/firewall/accesscontrol"==n.path()&&(a.showAdd&&0==a.pageToShow&&!a.isSame?a.applyMain():8!=a.pageToShow||a.showErrorPage?1!=a.pageToShow&&2!=a.pageToShow||a.showErrorPage?5!=a.pageToShow&&6!=a.pageToShow&&7!=a.pageToShow||a.showErrorPage?3!=a.pageToShow||a.showErrorPage?4!=a.pageToShow||a.showErrorPage?a.showAdd||0!=a.pageToShow||
a.save():a.applyProtocol():a.applyPortForwardRule():6!=a.pageToShow||a.showErrorPage?7!=a.pageToShow||a.showErrorPage?a.showErrorPage||a.applyRuleScheduler():a.applyHourRange():a.applyTimeSegment():2==a.pageToShow?a.applyAddress():a.applyNetworkObj():a.createAccessControl(null))}}]).controller("PortForwardCtrl",["$scope","$route","PortForward","Devices","PortForwardRules","Schedules","DateTimeSettings",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;a.sourcePortType=0;a.destPortType=
0;a.showAdvanced=!1;a.ipSelect=-2;a.appToForward=-2;a.showErrorPage=!1;a.portsUsed=[];a.hasPrevValue=null;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.pf={specifiedIp:[0,0,0,0],servicePortType:0,servicePort:0,schedule:"Always",protocol:{protocol:1,incomingPorts:0,incomingPortStart:65535,incomingPortEnd:0,outgoingPorts:0,outgoingPortStart:65535,outgoingPortEnd:0}};a.removeBox=[];for(var h=0;h<a.numItems;h++)a.removeBox.push(!1);a.isScheduleActive=isScheduleActive;a.appForward=
function(){if(0<=a.appToForward){a.portsUsed=[];for(var b=null,c=0;c<a.pfRules.length;c++)if(a.pfRules[c].id==a.appToForward){b=a.pfRules[c];break}null!=b&&printProtocol(6,b.protocols,a.portsUsed)}};a.save=function(){for(var b=0,d=0,e=0;e<a.portForward.length;e++)a.active[e]!=a.portForward[e].enabled&&(b++,c.update({id:a.portForward[e].id},{enabled:a.active[e]},function(){d++;d==b&&a.refresh()}))};a.toggleShow=function(){a.showAdvanced=!a.showAdvanced};a.contains=function(a,b){for(var c=0;c<a.length;c++)if(a[c]===
b)return!0;return!1};a.refresh=function(){a.portForward=c.query(function(){a.numItems=a.portForward.length;a.printPortsArr=[];printProtocol(1,a.portForward,a.printPortsArr);a.active=[];for(var b=0;b<a.portForward.length;b++)if(a.active.push(a.portForward[b].enabled),/^PortForward\_.*$/.test(a.portForward[b].name)){a.portForward[b].displayName="Destination Ports ";for(var c=[],h=0;h<a.portForward[b].protocols.length;h++){var q=a.portForward[b].protocols[h];if(1==q.outgoingPorts){if(a.contains(c,q.outgoingPortStart))continue}else if(2==
q.outgoingPorts&&a.contains(c,q.outgoingPortStart+"-"+q.outgoingPortEnd))continue;0<h&&(a.portForward[b].displayName+=",");0==q.outgoingPorts?a.portForward[b].displayName+="Any":1==q.outgoingPorts?(a.portForward[b].displayName+=q.outgoingPortStart,c.push(q.outgoingPortStart)):(a.portForward[b].displayName+=q.outgoingPortStart+"-"+q.outgoingPortEnd,c.push(q.outgoingPortStart+"-"+q.outgoingPortEnd))}}else a.portForward[b].displayName=unescape(a.portForward[b].name);a.dateTimeSettings=g.get(function(){a.localTimeMoment=
findTimeNow(a.dateTimeSettings);a.schedules=f.query(function(){for(var b=0;b<a.portForward.length;b++){a.portForward[b].schedActive="Active";for(var c=0;c<a.schedules.length;c++)if(a.portForward[b].schedule==a.schedules[c].name){a.portForward[b].schedActive=isScheduleActive(a.schedules[c],a.localTimeMoment);break}}for(c=0;c<a.schedules.length;c++)a.schedules[c].name=unescape(a.schedules[c].name)})});null==a.hasPrevValue?a.devices=d.query(function(){for(var b=0;b<a.devices.length;b++)a.devices[b].displayName=
a.devices[b].ipAddress!=a.devices[b].name?a.devices[b].ipAddress+" - "+a.devices[b].name:a.devices[b].name;for(b=0;b<a.portForward.length;b++){for(var c=0;c<a.devices.length;c++)if(a.portForward[b].deviceIp==a.devices[c].ipAddress&&a.devices[c].name!==a.devices[c].ipAddress){a.portForward[b].hostname=a.devices[c].name;a.portForward[b].showIp=!0;break}if(null==a.portForward[b].hostname||""===a.portForward[b].hosname)a.portForward[b].showIp=!1,a.portForward[b].hostname=a.portForward[b].deviceIp}a.devices=
filterOutStb(a.devices);a.devices=filterOutGuest(a.devices);a.pfRules=e.query(function(){a.pfRules=sortListItems(a.pfRules);a.pfRulesCopy=copyArrayFromSource(a.pfRules)})}):!0==a.hasPrevValue&&(a.hasPrevValue=null,a.devices1=d.query(function(){for(var b=0;b<a.devices1.length;b++)a.devices1[b].displayName=a.devices1[b].ipAddress!=a.devices1[b].name?a.devices1[b].ipAddress+" - "+a.devices1[b].name:a.devices1[b].name;for(b=0;b<a.portForward.length;b++){for(var c=0;c<a.devices1.length;c++)if(a.portForward[b].deviceIp==
a.devices1[c].ipAddress&&a.devices1[c].name!==a.devices1[c].ipAddress){a.portForward[b].hostname=a.devices1[c].name;a.portForward[b].showIp=!0;break}if(null==a.portForward[b].hostname||""===a.portForward[b].hosname)a.portForward[b].showIp=!1,a.portForward[b].hostname=a.portForward[b].deviceIp}}))})};a.refresh();a.resolveNow=function(){};a.reset=function(){a.ipSelect=-2;a.appToForward=-2;a.showAdvanced=!1;a.pf={specifiedIp:[0,0,0,0],servicePortType:0,servicePort:0,schedule:"Always",protocol:{protocol:1,
incomingPorts:0,incomingPortStart:65535,incomingPortEnd:0,outgoingPorts:0,outgoingPortStart:65535,outgoingPortEnd:0}}};a.add=function(){a.errorMessages=[];-2==a.ipSelect?a.errorMessages.push("Error: Please select the IP Address you want to forward to, or select an already connected item from the list"):-1==a.ipSelect&&(validateIp(a.pf.specifiedIp)&&"0.0.0.0"!=getIpString(a.pf.specifiedIp)&&"255.255.255.255"!=getIpString(a.pf.specifiedIp)||a.errorMessages.push("Error: The IP address specified is invalid"));
a.pf.protocol.protocol=parseInt(a.pf.protocol.protocol);var b=[],d=[],e=[],g=0,f=0,h=65535,s=0,y=0,v=65535;if(-2==a.appToForward)a.errorMessages.push("Error: Please select a pre-configured application or choose the option Custom ports to create a new appliction for port forwarding");else if(-1==a.appToForward)if(!a.showAdvanced&&0==a.errorMessages.length)for(var r=(""+a.pf.protocol.outgoingPortStart).split(","),t=0;t<r.length;t++){var l=r[t].split("-");if(2<l.length)a.errorMessages.push("Error: The input of port has illegal characters. Source port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on.");
else for(var m=0;m<l.length;m++)""===l[m]||isNaN(l[m])||checkForWholeNumbers(l[m])?a.errorMessages.push("Error: The input of port has illegal characters. Source port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on."):(1>l[m]||65535<l[m])&&a.errorMessages.push("Error: Port range should be between [1-65535]");1==l.length?(s=1,y=v=parseInt(l[0])):2==l.length&&(s=2,y=parseInt(l[0]),v=parseInt(l[1]));b.push(s);d.push(y);e.push(v)}else if(0==a.errorMessages.length){if(1==
a.sourcePortType){l=(""+a.pf.incomingPortStart).split("-");if(2<l.length)a.errorMessages.push("Error: The input of port has illegal characters. Source port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on.");else for(m=0;m<l.length;m++)""===l[m]||isNaN(l[m])||checkForWholeNumbers(l[m])?a.errorMessages.push("Error: The input of port has illegal characters. Source port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on."):
(1>l[m]||65535<l[m])&&a.errorMessages.push("Error: Port range should be between [1-65535]");1==l.length?(g=1,f=h=parseInt(l[0])):2==l.length&&(g=2,f=parseInt(l[0]),h=parseInt(l[1]))}if(1==a.destPortType&&0==a.errorMessages.length)for(r=(""+a.pf.outgoingPortStart).split(","),t=0;t<r.length;t++){l=r[t].split("-");if(2<l.length)a.errorMessages.push("Error: The input of port has illegal characters. Destination port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on.");
else for(m=0;m<l.length;m++)""===l[m]||isNaN(l[m])||checkForWholeNumbers(l[m])?a.errorMessages.push("Error: The input of port has illegal characters. Destination port should be 111 or 111-222; Destination port should be 111, or 111-222, or 111,222-333 and so on."):(1>l[m]||65535<l[m])&&a.errorMessages.push("Error: Port range should be between [1-65535]");1==l.length?(s=1,y=v=parseInt(l[0])):2==l.length&&(s=2,y=parseInt(l[0]),v=parseInt(l[1]));b.push(s);d.push(y);e.push(v)}}a.showAdvanced&&1==a.pf.servicePortType&&
0==a.errorMessages.length&&(""===a.pf.servicePort||isNaN(a.pf.servicePort)||0>a.pf.servicePort||65535<a.pf.servicePort)&&a.errorMessages.push("Forward to Port: Please enter a numeric value between 0 and 65535.");0==b.length&&(b.push(s),d.push(y),e.push(v));0==a.errorMessages.length&&-1==a.appToForward&&(t=r=!1,!0==a.showAdvanced?0==a.sourcePortType?r=!0:1==a.sourcePortType&&(m=(""+a.pf.incomingPortStart).split("-"),2==m.length&&1==m[0]&&65535==m[1]&&(r=!0)):r=!0,!0==a.showAdvanced?0==a.destPortType?
t=!0:1==a.destPortType&&(m=(""+a.pf.outgoingPortStart).split("-"),2==m.length&&1==m[0]&&65535==m[1]&&(t=!0)):(m=(""+a.pf.protocol.outgoingPortStart).split("-"),2==m.length&&1==m[0]&&65535==m[1]&&(t=!0)),r&&t&&a.errorMessages.push('Port forwarding rules can not be Any-to-Any (or "source: 1-65535" with "destination: 1-65535").'));if(0==a.errorMessages.length&&0<=a.appToForward){t=null;for(m=0;m<a.pfRules.length;m++)if(a.pfRules[m].id==a.appToForward){t=a.pfRules[m];break}if(null==t)return;for(m=0;m<
t.protocols.length;m++)if(!t.protocols[m].protocolExclude&&!t.protocols[m].outgoingExclude){var s=t.protocols[m].outgoingPortStart,v=t.protocols[m].outgoingPortEnd,y=t.name,x=s,r=t.protocols[m].protocol,B=!1;void 0!==v&&s!=v&&(x+="-"+v);void 0===v&&(v=s);for(x=0;x<a.portForward.length;x++)for(l=0;l<a.portForward[x].protocols.length;l++){var u=a.portForward[x].protocols[l];if(7!=r||!(1>u.protocol||2<u.protocol))if(7==r||r==u.protocol){void 0!=s||r!=u.protocol||0!=r&&3!=r&&4!=r&&5!=r&&6!=r||(B=!0);
var A="";if(0==u.outgoingPorts)A="Any";else if(1==u.outgoingPorts&&s<=u.outgoingPortStart&&v>=u.outgoingPortStart)A=u.outgoingPortStart;else if(2==u.outgoingPorts&&s<=u.outgoingPortStart&&v>=u.outgoingPortStart||s<=u.outgoingPortEnd&&v>=u.outgoingPortEnd||s>=u.outgoingPortStart&&v<=u.outgoingPortEnd)A=u.outgoingPortStart+" -> "+u.outgoingPortEnd;(""!=A||B)&&a.errorMessages.push("Conflicting Port Forwarding Rules: The "+y+" service conflict with an existing port forwarding rule offering "+y+" service.")}}}}if(0==
a.errorMessages.length&&-1==a.appToForward)for(t=0;t<b.length;t++)if(s=b[t],y=d[t],v=e[t],r=parseInt(a.pf.protocol.protocol),1!=r&&7!=r||4567!=y||4567!=v||a.errorMessages.push("Invalid rule: Port 4567 cannot be blocked"),0==s)for(m=0;m<a.portForward.length;m++)for(l=0;l<a.portForward[m].protocols.length;l++){if(u=a.portForward[m].protocols[l],7!=r||!(1>u.protocol||2<u.protocol))if(7==r||r==u.protocol)A="",A=0==u.outgoingPorts?"Any":1==u.outgoingPorts?u.outgoingPortStart:u.outgoingPortStart+" -> "+
u.outgoingPortEnd,a.errorMessages.push("Conflicting Port Forwarding Rules: The Destination Ports Any service conflict with an existing port forwarding rule offering Destination Ports "+A+" service.")}else for(x=s=y,r=a.pf.protocol.protocol,s!=v&&(x+="-"+v),m=0;m<a.portForward.length;m++)for(l=0;l<a.portForward[m].protocols.length;l++)if(u=a.portForward[m].protocols[l],y=a.portForward[m].name,7!=r||!(1>u.protocol||2<u.protocol))if(7==r||r==u.protocol){A="";if(0==u.outgoingPorts)A="Any";else if(1==
u.outgoingPorts&&s<=u.outgoingPortStart&&v>=u.outgoingPortStart)A=u.outgoingPortStart;else if(2==u.outgoingPorts&&s<=u.outgoingPortStart&&v>=u.outgoingPortStart||s<=u.outgoingPortEnd&&v>=u.outgoingPortEnd||s>=u.outgoingPortStart&&v<=u.outgoingPortEnd)A=u.outgoingPortStart+" -> "+u.outgoingPortEnd;""!=A&&(0<=y.indexOf("_")?a.errorMessages.push("Conflicting Port Forwarding Rules: The Destination Ports "+x+" service conflict with an existing port forwarding rule offering  Destination Ports "+A+" service."):
a.errorMessages.push("Conflicting Port Forwarding Rules: The Destination Ports "+x+" service conflict with an existing port forwarding rule offering "+y+" service."))}if(0<a.errorMessages.length)a.showErrorPage=!0,window.scrollTo(0,0);else{y=v=s=t=!1;m=parseInt(a.pf.protocol.protocol);r={enabled:!0};-1==a.ipSelect?r.deviceIp=getIpString(a.pf.specifiedIp):0<=a.ipSelect&&(r.deviceIp=a.devices[a.ipSelect].ipAddress);if(-1==a.appToForward)if(r.name="PortForward_"+(new Date).getTime(),r.protocols=[],7==
m)for(m=0;m<b.length;m++)y=v=s=t=!1,l={protocol:1},l.incomingPorts=g,l.incomingPortStart=f,!1==v&&(l.incomingPortEnd=h),l.incomingExclude=t,l.outgoingPorts=b[m],l.outgoingPortStart=d[m],!1==y&&(l.outgoingPortEnd=e[m]),l.outgoingExclude=s,r.protocols.push(l),l={protocol:2},l.incomingPorts=g,l.incomingPortStart=f,!1==v&&(l.incomingPortEnd=h),l.incomingExclude=t,l.outgoingPorts=b[m],l.outgoingPortStart=d[m],!1==y&&(l.outgoingPortEnd=e[m]),l.outgoingExclude=s,r.protocols.push(l);else for(m=0;m<b.length;m++)y=
v=s=t=!1,l={},l.protocol=a.pf.protocol.protocol,l.incomingPorts=g,l.incomingPortStart=f,!1==v&&(l.incomingPortEnd=h),l.incomingExclude=t,l.outgoingPorts=b[m],l.outgoingPortStart=d[m],!1==y&&(l.outgoingPortEnd=e[m]),l.outgoingExclude=s,r.protocols.push(l);else if(0<=a.appToForward){b=null;for(m=0;m<a.pfRules.length;m++)if(a.pfRules[m].id==a.appToForward){b=a.pfRules[m];break}null!=b&&(r.protocols=b.protocols,r.name=escape(b.name).replace(/\+/g,"%2B"))}a.showAdvanced?(r.schedule=a.pf.schedule,r.schedule=
escape(r.schedule).replace(/\+/g,"%2B"),r.servicePort=0==a.pf.servicePortType?0:parseInt(a.pf.servicePort)):(r.servicePort=0,r.schedule="Always");c.save(r,function(){a.refresh()});a.reset()}};a.remove=function(){for(var b=[],c=0;c<a.portForward.length;c++)a.removeBox[c]&&b.push(a.portForward[c].id);if(0<b.length){for(c=0;c<b.length;c++)b[c]-=c;a.removeListItems(b)}a.removeBox=[];for(c=0;c<a.portForward.length;c++)a.removeBox.push(!1)};a.removeListItems=function(b){0<b.length?c.remove({id:b[h]},function(){b.splice(0,
...
a.initVars(),a.togglePage(0))};a.applyProtocol=function(){a.runFocus=!0;a.errorMessages=[];a.protocols.protocol=parseInt(a.protocols.protocol);a.protocols.incomingPorts=parseInt(a.protocols.incomingPorts);a.protocols.outgoingPorts=parseInt(a.protocols.outgoingPorts);a.protocols.icmpMessage=parseInt(a.protocols.icmpMessage);a.protocols.protocolNumber=parseInt(a.protocols.protocolNumber);var b=a.protocols.incomingPortStart,c=a.protocols.incomingPortEnd,d=a.protocols.outgoingPortStart,h=a.protocols.outgoingPortEnd;
switch(a.protocols.protocol){case 0:var k=a.protocols.protocolNumber;(null==k||""===k||isNaN(k)||0>k||255<k)&&a.errorMessages.push("Protocol Number: Please enter a numeric value between 0 and 255.");break;case 1:case 2:switch(a.protocols.incomingPorts){case 1:(null==b||""===b||1>b||65535<b)&&a.errorMessages.push("Source Port: Please enter a numeric value between 1 and 65535.");break;case 2:(null==b||""===b||1>b||65535<b)&&a.errorMessages.push("Start Source Port: Please enter a numeric value between 1 and 65535."),
(null==c||""===c||1>c||65535<c)&&a.errorMessages.push("End Source Port: Please enter a numeric value between 1 and 65535."),0==a.errorMessages.length&&b>=c&&a.errorMessages.push("Source Ports: The From value must be lower than the To value in a range of ports (from="+b+", to="+c+").")}switch(a.protocols.outgoingPorts){case 1:(null==d||""===d||1>d||65535<d)&&a.errorMessages.push("Destination Port: Please enter a numeric value between 1 and 65535.");4567==d&&!1==a.protocols.outgoingExclude&&1==a.protocols.protocol&&
a.errorMessages.push("Invalid rule: Port 4567 cannot be blocked");break;case 2:(null==d||""===d||1>d||65535<d)&&a.errorMessages.push("Start Destination Port: Please enter a numeric value between 1 and 65535."),(null==h||""===h||1>h||65535<h)&&a.errorMessages.push("End Destination Port: Please enter a numeric value between 1 and 65535."),0==a.errorMessages.length&&d>=h&&a.errorMessages.push("Destination Ports: The From value must be lower than the To value in a range of ports (from="+d+", to="+h+").")}break;
case 3:if(10==a.protocols.icmpMessage){var k=a.protocols.icmpType,n=a.protocols.icmpCode;(null==k||""===k||0>k||255<k)&&a.errorMessages.push("ICMP Type:  Please enter a numeric value between 0 and 255.");(null==n||""===n||0>n||255<n)&&a.errorMessages.push("ICMP Code:  Please enter a numeric value between 0 and 255.")}}0==a.errorMessages.length&&(0==a.protocols.incomingPorts&&(a.protocols.incomingExclude=!1),0==a.protocols.outgoingPorts&&(a.protocols.outgoingExclude=!1),1==a.protocols.protocol||2==
a.protocols.protocol)&&(n=k=!1,0==a.protocols.incomingPorts?k=!0:2==a.protocols.incomingPorts&&!1==a.protocols.incomingExclude&&1==b&&65535==c&&(k=!0),0==a.protocols.outgoingPorts?n=!0:2==a.protocols.outgoingPorts&&!1==a.protocols.outgoingExclude&&1==d&&65535==h&&(n=!0),k&&n&&a.errorMessages.push('Port forwarding rules can not be Any-to-Any (or "source: 1-65535" with "destination: 1-65535").'));var p={outgoing:[],incoming:[]};copyTrigger(p,a.tempTrigger);var q=n=k="",z=!1,b=!1,w,s,c=!1;s=w="";var y=
!1,v=!1,r,t,l=!1;if(1==a.protocols.protocol||2==a.protocols.protocol){1==a.protocols.protocol?k="TCP":2==a.protocols.protocol&&(k="UDP");for(var c=a.protocols.incomingPortEnd,b=a.protocols.incomingPortStart,h=a.protocols.outgoingPortEnd,d=a.protocols.outgoingPortStart,y=2==a.protocols.incomingPorts?!0:!1,z=2==a.protocols.outgoingPorts?!0:!1,p=!1==a.incoming?p.outgoing:p.incoming,m=0;m<p.length;m++)if(a.protocols.protocol==p[m].protocol&&a.tempIndex!=m&&(r=p[m].incomingPortEnd,t=p[m].incomingPortStart,
v=null==r||""===r?!1:!0,l=!1,y?v?Number(b)>=Number(t)&&Number(b)<=Number(r)?(w=t+"-"+r,s=b+"-"+c,l=!0):Number(c)>=Number(t)&&Number(c)<=Number(r)?(w=t+"-"+r,s=b+"-"+c,l=!0):Number(t)>=Number(b)&&Number(t)<=Number(c)?(w=t+"-"+r,s=b+"-"+c,l=!0):Number(r)>=Number(b)&&Number(r)<=Number(c)&&(w=t+"-"+r,s=b+"-"+c,l=!0):Number(t)>=Number(b)&&Number(t)<=Number(c)&&(w=t,s=b+"-"+c,l=!0):v?Number(b)>=Number(t)&&Number(b)<=Number(r)&&(w=t+"-"+r,s=d,l=!0):Number(b)==Number(t)&&(w=t,s=b,l=!0),l)){a.errorMessages.push("Overlapping Port Ranges: The "+
k+" source ports ("+s+") is overlapping with already defined "+k+" source ports ("+w+").");break}for(m=0;m<p.length;m++)if(a.protocols.protocol==p[m].protocol&&a.tempIndex!=m&&(w=p[m].outgoingPortEnd,s=p[m].outgoingPortStart,b=null==w||""===w?!1:!0,c=!1,z?b?Number(d)>=Number(s)&&Number(d)<=Number(w)?(n=s+"-"+w,q=d+"-"+h,c=!0):Number(h)>=Number(s)&&Number(h)<=Number(w)?(n=s+"-"+w,q=d+"-"+h,c=!0):Number(s)>=Number(d)&&Number(s)<=Number(h)?(n=s+"-"+w,q=d+"-"+h,c=!0):Number(w)>=Number(d)&&Number(w)<=
Number(h)&&(n=s+"-"+w,q=d+"-"+h,c=!0):Number(s)>=Number(d)&&Number(s)<=Number(h)&&(n=s,q=d+"-"+h,c=!0):b?Number(d)>=Number(s)&&Number(d)<=Number(w)&&(n=s+"-"+w,q=d,c=!0):Number(d)==Number(s)&&(n=s,q=d,c=!0),c)){a.errorMessages.push("Overlapping Port Ranges: The "+k+" destination ports ("+q+") is overlapping with already defined "+k+" destination ports ("+n+").");break}}0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.protocols.icmpType=parseInt(a.protocols.icmpType),a.protocols.icmpCode=
parseInt(a.protocols.icmpCode),a.incoming?applyProtocol(a,a.tempTrigger.incoming):applyProtocol(a,a.tempTrigger.outgoing))};a.cancelTrigger=function(){a.refresh();a.togglePage(0)};a.cancelProtocol=function(){cancelProtocol(a)};a.editTrigger=function(b){a.editing=b;a.tempTrigger={enabled:a.portTrigger[b].enabled,name:a.portTrigger[b].name,outgoing:[],incoming:[]};copyTrigger(a.tempTrigger,a.portTrigger[b]);a.togglePage(3)};a.editOutgoingProtocol=function(b){editProtocol(a,b,a.tempTrigger.outgoing);
a.incoming=!1;a.tempIndex=b};a.editIncomingProtocol=function(b){editProtocol(a,b,a.tempTrigger.incoming,5);a.incoming=!0;a.tempIndex=b};a.removeTrigger=function(b){c.remove({id:a.portTrigger[b].id},function(){a.refresh()})};a.removeOutgoingProtocol=function(b){removeObject(a.tempTrigger.outgoing,b)};a.removeIncomingProtocol=function(b){removeObject(a.tempTrigger.incoming,b)};a.keyPress=function(b){13==b.keyCode&&"/firewall/porttrigger"==d.path()&&(4!=a.pageToShow&&5!=a.pageToShow||a.showErrorPage?
3!=a.pageToShow||a.showErrorPage?0==a.pageToShow&&a.save():a.applyTrigger():a.applyProtocol())}}]).controller("RemoteAdminCtrl",["$scope","$route","$routeParams","$location","RemoteAdmin","SystemSettings",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=f.get();a.remAdmin=e.get();a.fromString="?from=fw";a.prev="";a.oldFrom="";a.back="/firewall";if(null!=c.from){a.fromString="?from="+c.from+"-fw";a.back="/advanced/settings";b=c.from.split("-");c="";for(e=0;e<b.length-
1;e++)0!=e&&(c+="-"),c+=b[e];""!==c&&(a.prev="?from="+c)}else a.back="/firewall";a.save=function(){a.remAdmin.$update(function(){""==a.oldFrom?location.reload():d.path(a.back).search({from:a.oldFrom})})};a.keyPress=function(b){13==b.keyCode&&"/firewall/remoteadmin"==d.path()&&a.save()}}]).controller("StaticNATCtrl",["$scope","$route","StaticNAT","Devices","PortForwardRules","$location",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.runFocus=!1;a.errorPageOk=
function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.pageToShow=0;a.prot=-2;a.initVars=function(){init_services(a);a.statNat={localHost:-1,host:"192.168.1.0",publicIp:splitIpArr("0.0.0.0"),portForwarding:!1,services:[]};a.editing=-1;a.checkEdit=-1};a.initVars();a.setPrintArr=function(b){a.printProtArr=[];switch(b){case 1:printProtocol(1,a.statNat.services,a.printProtArr)}};a.devices=d.query(function(){a.devices=filterOutStb(a.devices);a.devices=filterOutGuest(a.devices)});a.save=function(){for(var b=
0,d=0,e=0;e<a.staticNAT.length;e++)a.enabled[e]!=a.staticNAT[e].active&&(b++,c.update({id:a.staticNAT[e].id},{active:a.enabled[e]},function(){d++;d==b&&a.refresh()}))};a.togglePage=function(b){a.runFocus=!0;a.pageName="Add";a.pageToShow=b;1==b&&(a.prot=-2,a.setPrintArr(1));window.scrollTo(0,0)};a.saveRule=function(){a.errorMessages=[];var b=a.statNat.host.split(".");-1==a.statNat.localHost&&(validateIpDomain(a.statNat.host)&&validateIp(b)||a.errorMessages.push("Local Host: The value must be a valid IP address."));
...
case "3":d="5";break;case "4":d="0";break;default:return!1}if(0<a.length){for(var e=0;e<a.length;e++)if(String(a[e].connectionType)==String(d)&&!0==a[e].status){c=!0;break}return c}return!1};var n,p=h.query(function(){n=d.query(function(){a.names=[];for(var b=[],c=0;c<n.length;c++)if(!n[c].done&&(n[c].done=!0,n[c].isChild=!1,n[c].styleName=a.getStyleName(n[c].connectionId),n[c].hasConnectedDeviceNow=a.checkForDevicesNow(p,n[c].connectionId),b.push(n[c]),a.names.push(unescape(n[c].name)),n[c].availableBridges))for(var d=
0;d<n[c].availableBridges.length;d++){var e=n[c].availableBridges[d];1!=e&&n[c].bridged[d]&&(n[e].isChild=!0,n[e].done||(n[e].styleName="BridgedItem "+a.getStyleName(n[e].connectionId),b.push(n[e]),a.names.push(unescape(n[e].name)),n[e].done=!0,n[e].hasConnectedDeviceNow=a.checkForDevicesNow(p,n[e].connectionId)))}a.connections=b})});a.showChildren=k.connectionListIsAdvanced;a.detectConfirm=function(){systemSettings.warnBeforeChanges?a.detectBroadband=!0:a.doDetectBroadband()};a.detectCancel=function(){a.detectBroadband=
!1};a.doDetectBroadband=function(){d.update({id:1},{detectBroadband:!0},function(){a.rebootingPage=!0;window.setTimeout(a.testConnection,0)})};a.testConnection=function(){f.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),c.path("/login").search({rebooting:"true"})):window.setTimeout(a.testConnection,3E3)})};a.toggleChildren=function(){a.showChildren=!a.showChildren;k.connectionListIsAdvanced=!0==a.showChildren?!0:!1};a.checkNetworkConnections=
function(){c.path("/network/connections")}}]).controller("NetworkConnectionCtrl",["$scope","$route","$routeParams","$location","NetworkConnections","Devices","securityTips",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;a.fromString="";a.oldFrom="";a.prev="";a.deviceBridge=[];if(null!=c.from){a.fromString="?from="+c.from;b=c.from.split("-");"arptable"==b[b.length-1]?a.back="/advanced/arptable":"connlist"==b[b.length-1]?a.back="/advanced/dhcp/connections":"edit"==b[b.length-
1]?a.back="/network/connections/0/edit":-1!=b[b.length-1].indexOf("dev_")?a.back="/network/device/details/"+b[b.length-1].substr(4):""===b[b.length-1]||isNaN(b[b.length-1])||(a.back="/network/connections/"+b[b.length-1]);for(var h=0;h<b.length-1;h++)0!=h&&(a.oldFrom+="-"),a.oldFrom+=b[h];""!==a.oldFrom&&(a.prev="?from="+a.oldFrom)}else a.back="/network/connections";a.deviceNames=[];a.checkForDevicesNow=function(a,b){var c=!1,d="";switch(String(b)){case "2":d="4";break;case "3":d="5";break;case "4":d=
"0";break;default:return!1}if(0<a.length){for(var e=0;e<a.length;e++)if(String(a[e].connectionType)==String(d)&&!0==a[e].status){c=!0;break}return c}return!1};a.showBridgeDeviceList=function(b){for(var c=0;c<a.deviceBridge.length;c++)if(a.deviceBridge[c].name==b)return a.deviceBridge[c].toShowOut;return!0};a.findDeviceNames=function(b){for(var c=0;c<a.deviceBridge.length;c++)if(a.deviceBridge[c].name==b)return a.deviceBridge[c].realDeviceName};var k,n=f.query(function(){k=e.get({id:c.id},function(){a.name=
unescape(k.name);a.deviceBridge=[];if(k.availableBridges)for(var b=0;b<k.availableBridges.length;b++){var c={};c.name=k.availableBridges[b];c.toShowOut=k.bridged[b];a.deviceBridge.push(c)}k.hasConnectedDeviceNow=a.checkForDevicesNow(n,k.connectionId);a.connections=e.query(function(){for(var b=0;b<a.connections.length;b++);if(k.underlyingDevices)for(angular.forEach(k.underlyingDevices,function(b){angular.forEach(a.connections,function(c){c.connectionId==b&&a.deviceNames.push(unescape(c.name))})}),
b=0;b<a.deviceBridge.length;b++)for(var c=0;c<a.connections.length;c++)if(a.connections[c].connectionId==a.deviceBridge[b].name){a.deviceBridge[b].realDeviceName=unescape(a.connections[c].name);break}a.connection=k;a.connFromString=""===a.fromString?"?from="+a.connection.connectionId:a.fromString+"-"+a.connection.connectionId;a.showIpv6=!1;void 0!==k.ipv6Address&&"::"!==k.ipv6Address&&""!==k.ipv6Address&&(a.showIpv6=!0)})})});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.refreshContentsNow=
function(){location.reload()};a.toggleEnabled=function(){e.update({id:k.connectionId},{enabled:!k.enabled},function(){3==k.connectionId||2==k.connectionId?(a.savePopup=g.showSaving1("Save Settings","Saving your settings. Please wait..."),window.setTimeout(a.refreshContentsNow,15E3)):a.refreshContentsNow()})};a.toggleCoaxEnabled=function(){e.update({id:k.connectionId},{coaxEnabled:!k.coaxEnabled},function(){3==k.connectionId||2==k.connectionId?(a.savePopup=g.showSaving1("Save Settings","Saving your settings. Please wait..."),
window.setTimeout(a.refreshContentsNow,15E3)):a.refreshContentsNow()})};a.cancelBtn=function(){window.scrollTo(0,0);null!=c.fromsystemtraffic?d.url("/monitoring/traffic"):null!=c.fromsystemfullstatus?d.url("/monitoring/fullstatus"):null!=c.fromdevicenetwork?d.url("/network/device/details/"+c.devicenum+"?fromdevicenetwork=true&devicenum="+c.devicenum):null!=c.connEdit?d.url("/network/connections/"+c.connEdit+"/edit"):d.url(a.back+a.prev)};a.saveName=function(b){a.errorMessages=[];a.connection.name=
escape(a.name.replace(/^\s+|\s+$/g,"")).replace(/\+/g,"%2B");if(0==a.connection.name.length)a.errorMessages.push("Connection Name: Connection Name cannot be empty.");else for(var f=0;f<a.connections.length;f++)f!=a.connection.connectionId&&unescape(a.connection.name)==unescape(a.connections[f].name)&&a.errorMessages.push("Connection Name:  Connection Name already in use.");0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):e.update({id:b.connectionId},{name:a.connection.name},function(){window.scrollTo(0,
0);null!=c.fromsystemtraffic?d.url("/monitoring/traffic"):null!=c.fromsystemfullstatus?d.url("/monitoring/fullstatus"):null!=c.fromdevicenetwork?d.url("/network/device/details/"+c.devicenum+"?fromdevicenetwork=true&devicenum="+c.devicenum):null!=c.connEdit?d.url("/network/connections/"+c.connEdit+"/edit"):""==a.oldFrom?d.path(a.back).search({}):d.path(a.back).search({from:a.oldFrom})})};a.checkNetworkConnections=function(){d.path("/network/connections")};a.keyPress=function(b){13==b.keyCode&&d.path()==
"/network/connections/"+c.id&&a.saveName(a.connection)}}]).controller("NetworkConnectionEditCtrl",["$scope","$route","$routeParams","$location","DhcpOptions","NetworkConnections","DhcpConnections","Routes","Devices","FirewallDMZ",function(a,b,c,d,e,f,g,h,k,n){a.tab=b.current.tab;a.section=b.current.section;a.confirm=!1;a.messages=[];a.staticConnections=[];a.routesConnections=[];a.oldCoaxPassword="";a.coTempIPAddress="";a.coTempHomeName="";a.tempStatic={};a.listOfNetworkIPAddress=[];a.fromString=c.from?
"?from="+c.from+"&connectionEdit="+c.id:"?connectionEdit="+c.id;a.getStyleName=function(a){switch(a){case 0:return"Network";case 1:return"Network";case 2:return"Wireless";case 3:return"Wireless";case 4:return"Ethernet";case 5:return"Coax";default:return"Network"}};a.checkForDevicesNow=function(a,b){var c=!1,d="";switch(String(b)){case "2":d="4";break;case "3":d="5";break;case "4":d="0";break;default:return!1}if(0<a.length){for(var e=0;e<a.length;e++)if(String(a[e].connectionType)==String(d)&&!0==
a[e].status){c=!0;break}return c}return!1};var p=k.query(function(){a.connection=f.get({id:c.id},function(){a.connection.styleName=a.getStyleName(c.id);if(a.connection.dhcpExpires){var b=a.connection.dhcpExpires;a.connection.dhcpExpireTime=0!=b?Math.ceil(b/60)+" minutes":"Expired"}a.name=unescape(a.connection.name);a.connection.name=unescape(a.connection.name);a.connection.hasConnectedDeviceNow=a.checkForDevicesNow(p,a.connection.connectionId);a.oldsubnet=a.connection.subnetMask;a.oldProtocolUsed=
a.connection.protocolUsed;switch(a.connection.type){case 3:a.connectionType="Ethernet";break;case 5:a.connectionType="Coax";break;case 4:a.connectionType="AP";break;default:a.connectionType="Basic"}1==a.connection.connectionId&&(a.tempStatic={ipAddress:a.connection.ipAddress,defaultGateway:a.connection.defaultGateway,primaryDnsServer:a.connection.primaryDnsServer,secondaryDnsServer:a.connection.secondaryDnsServer,subnetMask:a.connection.subnetMask},a.connection.ipAddress=void 0!=a.connection.staticIpAddress?
a.connection.staticIpAddress:a.connection.ipAddress,a.connection.defaultGateway=void 0!=a.connection.staticDefaultGateway?a.connection.staticDefaultGateway:a.connection.defaultGateway,a.connection.primaryDnsServer=void 0!=a.connection.staticPrimaryDnsServer?a.connection.staticPrimaryDnsServer:a.connection.primaryDnsServer,a.connection.secondaryDnsServer=void 0!=a.connection.staticSecondaryDnsServer?a.connection.staticSecondaryDnsServer:a.connection.secondaryDnsServer,a.connection.subnetMask=void 0!=
a.connection.staticSubnetMask?a.connection.staticSubnetMask:a.connection.subnetMask);a.connection.ipAddress&&(a.initialIpAddress=a.connection.ipAddress,a.ipAddress=splitIpArr(a.connection.ipAddress),a.subnetMask=splitIpArr(a.connection.subnetMask),null!=a.connection.defaultGateway&&(a.defaultGateway=splitIpArr(a.connection.defaultGateway)),a.connection.primaryDnsServer&&(a.primaryDnsServer=splitIpArr(a.connection.primaryDnsServer),a.secondaryDnsServer=splitIpArr(a.connection.secondaryDnsServer)));
...
[];a.messages=[];if(2==a.connection.mtuType){var b=!1;validRange(a.connection.mtu,68,1500)?checkForWholeNumbers(a.connection.mtu)&&(b=!0):b=!0;b&&a.errorMessages.push("MTU: The maximum transfer unit of "+a.connection.name+" should be between 68 and 1500. ")}var e=b=!1,f=!1,g=!1,h=!1,n=!1,k=!1,p="",l=!0;if(a.connection.ipAddress){if(2==a.connection.protocolUsed){var m=!1,x=!1;validateIp(a.ipAddress)?"0.0.0.0"==getNumIpString(a.ipAddress)&&(a.errorMessages.push("IP address may not be 0.0.0.0. IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces. At least one of the values must be greater than 0."),
x=m=!0):(a.errorMessages.push("IP Address: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces."),x=m=!0);if(223<a.ipAddress[0]||0==a.ipAddress[0]||m)a.errorMessages.push("IP Address: Device IP address should start with a value between 1-223."),b=!0;0==a.connection.connectionId&&x&&a.errorMessages.push("IP Address already in use: IP address item is already in use by Port Forwarding.");validateIp(a.ipAddress)&&checkAllNetworks(a.listOfNetworkIPAddress,
a.ipAddress,a.connection.connectionId)&&(a.errorMessages.push("IP Address Already Exists: IP Address address "+getNumIpString(a.ipAddress)+" is already in use by "+checkAllNetworks4Name(a.listOfNetworkIPAddress,a.ipAddress,a.connection.connectionId)+"."),e=!0);b||e||!checkFor127(a.ipAddress)||(a.errorMessages.push("IP Address: IP addresses starting with 127 are not valid because they are reserved for loopback addresses."),h=!0)}x=m=!1;if(2==a.connection.protocolUsed||1==a.connection.protocolUsed)if(x=
!0,1!=a.connection.protocolUsed||a.connection.overrideSubnetMask||(x=!1),x){if(!validateIp(a.subnetMask)||checkFullListOfSubnetMaskRange(a.subnetMask))"0.0.0.0"!=getIpString(a.subnetMask)&&a.errorMessages.push("Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0."),m=!0}else validateIp(a.subnetMask)||("0.0.0.0"!=getIpString(a.subnetMask)&&a.errorMessages.push("Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0."),
m=!0);0==a.connection.connectionId&&(checkForValidSubnetMaskRange(a.subnetMask)||m)&&(a.errorMessages.push("Subnet Mask: Subnet mask must be between 255.0.0.0 and 255.255.255.252."),m=!0);2==a.connection.protocolUsed&&a.defaultGateway&&!validateIp(a.defaultGateway)&&(a.errorMessages.push("Default Gateway: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces."),l=!1,n=!0);!b&&!1==m&&2==a.connection.protocolUsed&&validateIp(a.ipAddress)&&"0.0.0.0"!=getNumIpString(a.ipAddress)&&
(checkHostVsSubmask(a.ipAddress,a.subnetMask)?(p="IP Address and Subnet Mask combination: The combination of IP address and subnet mask is invalid. All of the bits in the host address portion of the IP address are set to "+checkBits(a.ipAddress)+".",a.errorMessages.push(p),k=!0):(m=compareIpMaskNetwork(a.ipAddress,a.subnetMask),"2"!=m&&(p="IP Address and Subnet Mask combination: The combination of IP address and subnet mask is invalid. All of the bits in the network address portion of the IP address are set to "+
m+".",a.errorMessages.push(p),k=!0)));if(2==a.connection.protocolUsed&&a.defaultGateway&&l&&!k&&validateIp(a.ipAddress)&&getNumIpString(a.ipAddress)==getNumIpString(a.defaultGateway)){if(""!=p){f=[];for(l=0;l<a.errorMessages.length;l++)p!=a.errorMessages[l]&&f.push(a.errorMessages[l]);a.errorMessages=f}a.errorMessages.push("Incorrect Gateway IP: The Gateway cannot have the same IP address as the specified Wireless Broadband Router IP address.");f=!0}a.connection.primaryDnsServer&&1==a.connection.dnsMode&&
...
0>a.connection.deviceMetric||255<a.connection.deviceMetric)&&a.errorMessages.push("Device Metric: Please enter a numeric value between 0 and 255.");p=getIpString(a.ipAddress);a.connection.dnsMode=parseInt(a.connection.dnsMode);x=m="";a.connection.primaryDnsServer&&(m=getIpString(a.primaryDnsServer),x=getIpString(a.secondaryDnsServer));var B=parseInt(a.connection.protocolUsed),u=a.connection.subnetMask;if(2==B||1==B)u=getIpString(a.subnetMask);var A=a.connection.defaultGateway;a.defaultGateway&&(A=
...
a.errorMessages.push("Coax Link Password:  Only digits can be used for the number.")):a.connection.coaxPasswordManual=a.oldCoaxPassword);if(0==a.connection.type)"0.0.0.0"==u&&a.errorMessages.push((1==B&&a.connection.overrideSubnetMask?"Override ":"")+"Subnet mask may not be 0.0.0.0. Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0.");else if(1==a.connection.type){var C=a.subnetMask;
a.connection.overrideSubnetMask||1!=B||(C=splitIpArr(u));if((2==B||1==B&&a.connection.overrideSubnetMask)&&validateIp(C)){for(var D=!0,F=!1,l=0;4>l;l++){for(var E=7;-1<E;E--){var G=1==(C[l]>>E&1);if(G&&F){D=!1;break}G||(F=!0)}if(!D)break}if(!D)a.checkMsg(a.errorMessages,"Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0.")||a.errorMessages.push("Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0.");
else if(2==B&&a.connection.defaultRoute&&"0.0.0.0"==A)a.errorMessages.push("Default Gateway: The Default Gateway must not be 0.0.0.0 while the Default Route is set.");else if(2==B&&"0.0.0.0"!=A&&validateIp(a.ipAddress)&&!(b||e||h||k||n))for(l=0;4>l;l++)if((C[l]&a.defaultGateway[l])!=(a.subnetMask[l]&a.ipAddress[l])){a.errorMessages.push("Wireless Broadband Router and Default Gateway Are Not on the Same Subnet: Under the given Netmask, the IP Address does not belong to the same Subnet as the Default Gateway.");
g=!0;break}"0.0.0.0"==u&&a.errorMessages.push("Subnet mask may not be 0.0.0.0. Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0.")}}0==a.connection.protocolUsed||1!=a.connection.dnsMode||1!=a.connection.connectionId||!a.connection.primaryDnsServer||b||e||f||g||h||(p==m&&1!=a.connection.protocolUsed?a.errorMessages.push("Primary DNS Server: DNS Server cannot have the IP address of Wireless Broadband Router "+
unescape(a.connection.name)+"."):m==a.coTempIPAddress&&a.errorMessages.push("Primary DNS Server: DNS Server cannot have the IP address of Wireless Broadband Router "+a.coTempHomeName+"."),p==x&&1!=a.connection.protocolUsed?a.errorMessages.push("Secondary DNS Server: DNS Server cannot have the IP address of Wireless Broadband Router "+unescape(a.connection.name)+"."):x==a.coTempIPAddress&&a.errorMessages.push("Secondary DNS Server: DNS Server cannot have the IP address of Wireless Broadband Router "+
a.coTempHomeName+"."),"0.0.0.0"!=m&&m==x&&a.errorMessages.push("Redundant DNS Entries: 'Primary' and 'Secondary' values may not point to the same DNS server."),"255.255.255.255"==m&&a.errorMessages.push("Primary DNS Server: "+m+" is invalid."),"255.255.255.255"==x&&a.errorMessages.push("Secondary DNS Server: "+x+" is invalid."));if(0!=a.errorMessages.length){a.showErrorPage=!0;window.scrollTo(0,0);return}2==a.connection.protocolUsed?(a.connection.ipAddress=p,a.defaultGateway&&(a.connection.defaultGateway=
A)):a.defaultGateway&&(a.connection.defaultGateway=null);void 0!==a.connection.routingMode&&(a.connection.routingMode=parseInt(a.connection.routingMode));a.connection.primaryDnsServer=m;a.connection.secondaryDnsServer=x;a.connection.protocolUsed=B;a.connection.subnetMask=u;0==c.id&&1==a.connection.protocolUsed&&2==a.oldProtocolUsed&&(a.messages.push({type:"DHCP Client:",data:"Configuring an internal connection to obtain an IP address automatically might make the connection inaccessible in case no IP address is obtained."}),
...
0;c<a.length;c++)if(a[c]===b)return!0;return!1};a.pingTest=function(){g.save({destination:a.device.ipAddress,count:4},function(){d.path("/advanced/diagnostics")})};a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.iconChanged=function(){a.device.icon=parseInt(a.device.icon);setDeviceStyle(a.device,"")};a.save=function(){a.errorMessages=[];for(var b=0;b<a.devices.length;b++)if(a.device.id!=b&&a.device.name==a.devices[b].name){a.errorMessages.push("Name: Name already exists in Wireless Broadband Router's database.");
...
function validateTransmissionSettings(a,b,c){isNaN(a.beaconInterval)||null==a.beaconInterval||!checksForDecimalNumber(a.beaconInterval)?c.push(b+" Beacon Interval: Please enter a numeric value."):(20>a.beaconInterval||1E3<a.beaconInterval)&&c.push(b+" Beacon Interval:  Beacon interval out of range (from=20, to=1000)");isNaN(a.dtimInterval)||null==a.dtimInterval||!checksForDecimalNumber(a.dtimInterval)?c.push(b+" DTIM Interval: Please enter a numeric value."):(1>a.dtimInterval||255<a.dtimInterval)&&
c.push(b+" DTIM Interval:  DTIM interval out of range (from=1, to=255)");isNaN(a.fragmentationThreshold)||null==a.fragmentationThreshold||!checksForDecimalNumber(a.fragmentationThreshold)?c.push(b+" Fragmentation Threshold: Please enter a numeric value."):(256>a.fragmentationThreshold||2346<a.fragmentationThreshold)&&c.push(b+" Fragmentation Threshold:  Fragmentation threshold out of range (from=256, to=2346)");null==a.rtsThreshold||""===a.rtsThreshold||isNaN(a.rtsThreshold)||!checksForDecimalNumber(a.rtsThreshold)?
c.push(b+" RTS Threshold: Please enter a numeric value."):(0>a.rtsThreshold||2347<a.rtsThreshold)&&c.push(b+" RTS Threshold:  RTS Threshold out of range (from=0, to=2347)");isNaN(a.frameBurstMax)||!checksForDecimalNumber(a.frameBurstMax)?c.push(b+" Frame Burst - Max Number: Please enter a numeric value."):(2>a.frameBurstMax||255<a.frameBurstMax)&&c.push(b+" Frame Burst - Max Number: Max number of frames in a burst is out of range (from=2, to=255)");null==a.frameBurstTime||""===a.frameBurstTime||isNaN(a.frameBurstTime)||
!checksForDecimalNumber(a.frameBurstTime)?c.push(b+" Frame Burst - Burst Time: Please enter a numeric value."):(0>a.frameBurstTime||1023<a.frameBurstTime)&&c.push(b+" Frame Burst - Burst Time: Burst time out of range (from=0, to=1023)");isNaN(a.power)||!checksForDecimalNumber(a.power)?c.push(b+" Transmit Power: Please enter a numeric value."):(1>a.power||100<a.power)&&c.push(b+" Transmit Power: Please enter a numeric value between 1 and 100.")}
function isInRange(a,b,c){for(var d=0;4>d;d++)if(a[d]>c[d]||b[d]<c[d])return!1;return!0}
function validateIPv4DhcpSettings(a,b,c,d,e,f,g,h,k,n){var p=[],q=getSubnetID(a,d),z=angular.copy(q);z[3]=100;q=angular.copy(q);q[3]=150;validateIp(a)||p.push("Invalid IP Address provided. Values must be between 0 and 255");validateIp(b)||p.push("Start IP Address: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces.");validateIp(c)||p.push("End IP Address: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces.");validateIp(a)&&
null!=n&&checkAllNetworks(n,a,g)&&$scope.errorMessages.push("IP Address Already Exists: IP Address address "+getNumIpString(a)+" is already in use by "+checkAllNetworks4Name(n,a,g)+".");var w=n=!1;if(2==h||1==h)if(w=!0,1!=h||k||(w=!1),w){if(!validateIp(d)||checkFullListOfSubnetMaskRange(d))"0.0.0.0"!=getIpString(d)&&p.push("Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0."),
n=!0}else validateIp(d)||("0.0.0.0"!=getIpString(d)&&p.push("Subnet Mask: Subnet mask must consist of 4 fields. Each field's value must be between 0 and 255, constructing a contiguous string of binary ones. The default mask value is 255.255.255.0."),n=!0);isIPWithinRange(b,z,q)&&isIPWithinRange(c,z,q)&&p.push("Start IP Address, End IP Address: IP addresses between "+getIpString(z)+" and "+getIpString(q)+" are used for FiOS TV. Please select a start and/or end IP address outside of this reserved range.");
...
function isScheduleActive(a,b){if(null===a||"Always"===a||""===a)return"Active";var c=["Active","Inactive"];a.activeDuring||(c=["Inactive","Active"]);var d=b.day();0==d&&(d=7);for(var d=d-1,e=b.hour(),f=b.minute(),g=0;g<a.timeSegments.length;g++)if(-1!=String(a.timeSegments[g].daysOfTheWeek).indexOf(d))for(var h=0;h<a.timeSegments[g].hourRanges.length;h++){var k=a.timeSegments[g].hourRanges[h].startTimeHour,n=a.timeSegments[g].hourRanges[h].endTimeHour,p=a.timeSegments[g].hourRanges[h].startTimeMinute,
q=a.timeSegments[g].hourRanges[h].endTimeMinute;if(k==n&&p<=q){if(k==e&&n==e&&p<=f&&q>f)return c[0]}else if(k<n){if(e>k&&e<n||k==e&&f>=p||n==e&&f<q)return c[0]}else if(k<e||k==e&&p<=f||n>e||n==e&&q>f)return c[0]}return c[1]}
...
function isAddressValidIPPattern(a){var b=!0;/^[0-9\.]/i.test(a)?(a=splitIpArr(a),validateIp(a)||(b=!1)):b=!1;return b}function filterOutGuest(a){for(var b=0;b<a.length;b++)6==Number(a[b].connectionType)&&(a.splice(b,1),b--);return a}function filterOutNonGuest(a){for(var b=0;b<a.length;b++)6!=Number(a[b].connectionType)?(a.splice(b,1),b--):a[b].approved||(a.splice(b,1),b--);return a}function getNextLocationForLocationChange(a){return String(a).split("#")[1]}
...
0))):(k=(new Date).getTime(),a.currentStep=2,window.setTimeout(a.testConnection,3E3))})};a.cancel=function(){d.update({id:0},{trigger:!a.trigger,pin:""},function(){a.currentStep=0;a.isCancelled=!0;k=0})};a.connect=function(){a.currentStep=4};a.completed=function(){a.currentStep=0;a.clientWpsPin=""};a.sendErEnabled=function(b){d.update({id:0},{erEnabled:b},function(){a.refresh()})}}]).controller("GuestWifiSetupTabCtrl",["$scope","$route","$location","Wireless",function(a,b,c,d){a.pageToShow=0;a.currentTab=
-1;a.bothDisabled=!1;a.basicGuestWifiEnabled=!1;a.guestPassWifiEnabled=!1;a.guestWifiEnum={BASIC_GUEST_WIFI:2,GUEST_PASS:3};a.tabsEnum={1:"partials/wireless/guestDevicesTab.html",2:"partials/wireless/basicGuestWifiTab.html",3:"partials/wireless/guestPassWifiTab.html"};a.section=b.current.section;b=c.path();-1!=b.indexOf("/wireless/guestWifiSetup/devices")?a.currentTab=1:-1!=b.indexOf("/wireless/guestWifiSetup/basic")?a.currentTab=2:-1!=b.indexOf("/wireless/guestWifiSetup/pass")?a.currentTab=3:a.wireless1=
d.query(function(){a.basicGuestWifi1=a.wireless1[a.guestWifiEnum.BASIC_GUEST_WIFI];a.guestPassWifi1=a.wireless1[a.guestWifiEnum.GUEST_PASS];void 0!=a.basicGuestWifi1&&null!=a.basicGuestWifi1&&a.basicGuestWifi1.enabled?c.url("/wireless/guestWifiSetup/basic"):void 0!=a.guestPassWifi1&&null!=a.guestPassWifi1&&a.guestPassWifi1.enabled?c.url("/wireless/guestWifiSetup/pass"):c.url("/wireless/guestWifiSetup/basic")});a.mainRefresh=function(){a.basicGuestWifiEnabled=!1;a.guestPassWifiEnabled=!1;a.bothDisabled=
!1;a.wireless=d.query(function(){a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];a.guestPassWifi=a.wireless[a.guestWifiEnum.GUEST_PASS];void 0!=a.basicGuestWifi&&null!=a.basicGuestWifi&&a.basicGuestWifi.enabled?(a.basicGuestWifiEnabled=!0,a.bothDisabled=!1):void 0!=a.guestPassWifi&&null!=a.guestPassWifi&&a.guestPassWifi.enabled?(a.guestPassWifiEnabled=!0,a.bothDisabled=!1):a.bothDisabled=!0});a.togglePage(0)};a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.mainRefresh();
a.isActive=function(b){return a.currentTab===b};a.setActive=function(a){switch(a){case 1:c.url("/wireless/guestWifiSetup/devices");break;case 2:c.url("/wireless/guestWifiSetup/basic");break;case 3:c.url("/wireless/guestWifiSetup/pass");break;default:c.url("/wireless/guestWifiSetup/basic")}};a.getActive=function(){return a.currentTab}}]).controller("GuestWifiSetupCtrl",["$scope","$route","$location","Wireless","GuestDevices","GuestPassDevices","Devices","$rootScope","securityTips",function(a,b,c,d,
e,f,g,h,k){a.bothDisable=!1;a.pageToShow=0;a.tab=b.current.tab;a.section=b.current.section;a.refresh=function(){a.guestDevices=null;a.wireless=d.query(function(){a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];a.guestPassWifi=a.wireless[a.guestWifiEnum.GUEST_PASS];a.basicGuestWifi.enabled||a.guestPassWifi.enabled?a.guestDevices=g.query(function(){for(var b=0;b<a.guestDevices.length;b++)a.guestDevices[b].toDisplay=!1,6==a.guestDevices[b].connectionType&&(a.guestDevices[b].ssid=a.basicGuestWifi.enabled?
a.basicGuestWifi.ssid:a.guestPassWifi.ssid,a.guestDevices[b].toDisplay=!0,setDeviceStyle(a.guestDevices[b],""))}):a.bothDisable=!0});a.togglePage(0)};a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.refresh();a.toggleOnOffSave=function(b){b.blocked=!b.blocked;g.update({id:b.id},b,function(){a.refresh()})}}]).controller("BasicGuestCtrl",["$scope","$route","$location","Wireless","GuestDevices","WPA","securityTips","$sce","$rootScope","Devices",function(a,b,c,d,e,f,g,h,k,n){a.warningFlag=
!1;a.pageToShow=0;a.tab=b.current.tab;a.section=b.current.section;a.keySet=!1;a.showPassword=!0;k.editingGuest=!1;k.guestHasChanges=!1;a.listener=null;a.tempWPAkey="";a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.refresh=function(){a.showPassword=!0;a.wireless=d.query(function(){a.wirelessA=a.wireless[0];a.wirelessB=a.wireless[1];a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];a.guestPassWifi=a.wireless[a.guestWifiEnum.GUEST_PASS];a.basicGuestWifi.ssid=a.basicGuestWifi.ssid;
a.tempWPAkey="";void 0!=a.basicGuestWifi&&null!=a.basicGuestWifi&&(a.guestDevices=n.query(function(){a.guestDevices=filterOutNonGuest(a.guestDevices)}),a.wpa=f.get({id:a.guestWifiEnum.BASIC_GUEST_WIFI},function(){void 0!=a.wpa.key&&(a.wpa.key=a.wpa.key,a.tempWPAkey=h.trustAsHtml(a.convertKey(a.wpa.key)),a.keySet=""!==a.wpa.key?!0:!1)}));a.warningFlag=void 0!=a.basicGuestWifi&&null!=a.basicGuestWifi&&!a.basicGuestWifi.enabled&&void 0!=a.guestPassWifi&&null!=a.guestPassWifi&&a.guestPassWifi.enabled?
...
{wpaShowKeyInUI:a.wpa.wpaShowKeyInUI},function(){a.saveWifiKey()})}))};a.cancel=function(){a.refresh();k.editingGuest=!1;k.guestHasChanges=!1};a.change=function(){k.guestHasChanges=!0};a.saveContents1Function=function(b){a.saveWifiSettings()};a.listener=k.$on("saveContents1",a.saveContents1Function);a.$on("$destroy",function(){a.listener()});a.redirect=function(){k.locationChangeActivate=!1;k.editingGuest=!1;k.guestHasChanges=!1;c.path(getNextLocationForLocationChange(k.locationChangeNext))};a.toggleShowPassword=
function(){f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{wpaShowKeyInUI:a.wpa.wpaShowKeyInUI},function(){})};a.cancelRedirect=function(){k.locationChangeActivate=!1}}]).controller("BasicGuestCtrlPopup",["$scope","WPA","model","dialog",function(a,b,c,d){a.key=c.key;a.wpaPopup=c.wpa;a.buttons=c.buttons;a.title=c.title;a.message=c.message;a.close=function(b){d.close({result:b,returnObj:a.key,wpaShowKeyInUI:a.wpaPopup.wpaShowKeyInUI})}}]).controller("GuestPassWifiCtrl",["$scope","$route","$location",
"Wireless","GuestPassDevices","securityTips","Devices","$rootScope",function(a,b,c,d,e,f,g,h){a.warningFlag=!1;a.pageToShow=0;a.tab=b.current.tab;a.section=b.current.section;h.editingGuest=!1;h.guestHasChanges=!1;a.listener=null;a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.refresh=function(){a.wireless=d.query(function(){a.wirelessA=a.wireless[0];a.wirelessB=a.wireless[1];a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];a.guestPassWifi=a.wireless[a.guestWifiEnum.GUEST_PASS];
