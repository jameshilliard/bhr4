...
function validateHostnameDNSServer(str) {
  if(!/[a-z0-9]/i.test(str))
    return false;
  if(!/^[a-z0-9]$|^[a-z0-9][a-z0-9\_\-]{0,}[a-z0-9]$|^[a-z0-9][a-z0-9]{0,}[\.]{1}[a-z0-9][a-z0-9]{0,}[\.]{1}[a-z0-9]{0,}$|^[a-z0-9][a-z0-9]{0,}[\.]{1}[a-z0-9]{0,}$|^[a-z0-9][a-z0-9]{0,}[\.]{1}[a-z0-9]{0,}[\.]{1}$|^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$/i.test(str))
    return false;
  var arr = str.split('.');
  for(var i = 0; i < arr.length; i++)
    if(arr[i].length>63)
