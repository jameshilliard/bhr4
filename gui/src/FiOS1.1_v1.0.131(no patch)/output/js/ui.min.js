...
d.save(function(){window.setTimeout(a.testConnection,0)});a.page=3};a.testConnection=function(){e.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),window.location="/redirect.html?v=v1.0.131"):window.setTimeout(a.testConnection,3E3)})}}]).controller("localAdminCtrl",["$scope","$route","$location","LocalAdmin","SystemSettings",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=e.get();a.locAdmin=d.get();
...
!1;window.uploadDone=function(){if(a.loadFile)var b=d.get(function(){b.successful?(e.save(function(){window.setTimeout(a.testConnection,0)}),a.completed=!0):(a.errorMessages=["Configuration File: Bad format of configuration file."],a.showErrorPage=!0)})};a.testConnection=function(){g.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,h.removeAll(),window.location="/redirect.html?v=v1.0.131"):window.setTimeout(a.testConnection,3E3)})};a.toggleShow=
...
3E3)},function(b){401==b.status?(a.restarting=!0,h.removeAll(),window.location=0==a.resetType?"/redirectSetup.html?v=v1.0.131":"/redirect.html?v=v1.0.131"):window.setTimeout(a.testConnection,3E3)})}}]).controller("rebootCtrl",["$scope","$route","Reboot","SystemSettings","Login","$location","$templateCache",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=d.get();a.rebooting=!1;a.restarting=!1;a.reboot=function(){a.rebooting=!0;c.save(function(){window.setTimeout(a.testConnection,
0)})};a.testConnection=function(){d.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),window.location="/redirect.html?v=v1.0.131"):window.setTimeout(a.testConnection,3E3)})};a.keyPress=function(b){13==b.keyCode&&"/advanced/reboot"==f.path()&&a.reboot()}}]).controller("macCloningCtrl",["$scope","$route","$location","MacCloning",function(a,b,c,d){a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.macCloning=d.get(function(){a.macAddress=
...
case "3":d="5";break;case "4":d="0";break;default:return!1}if(0<a.length){for(var e=0;e<a.length;e++){if(String(a[e].connectionType)==String(d)&&!0==a[e].status){c=!0;break}if("6"==String(a[e].connectionType)&&a[e].approved&&"5"==String(d)&&!0==a[e].status){c=!0;break}if("7"==String(a[e].connectionType)&&"4"==String(d)&&!0==a[e].status){c=!0;break}}return c}return!1};var m,p=h.query(function(){m=d.query(function(){a.names=[];for(var b=[],c=0;c<m.length;c++)if(!m[c].done&&(m[c].done=!0,m[c].isChild=
!1,m[c].styleName=a.getStyleName(m[c].connectionId),m[c].hasConnectedDeviceNow=a.checkForDevicesNow(p,m[c].connectionId),b.push(m[c]),a.names.push(unescape(m[c].name)),m[c].availableBridges))for(var d=0;d<m[c].availableBridges.length;d++){var e=m[c].availableBridges[d];1!=e&&m[c].bridged[d]&&(m[e].isChild=!0,m[e].done||(m[e].styleName="BridgedItem "+a.getStyleName(m[e].connectionId),b.push(m[e]),a.names.push(unescape(m[e].name)),m[e].done=!0,m[e].hasConnectedDeviceNow=a.checkForDevicesNow(p,m[e].connectionId)))}a.connections=
b})});a.showChildren=k.connectionListIsAdvanced;a.detectConfirm=function(){systemSettings.warnBeforeChanges?a.detectBroadband=!0:a.doDetectBroadband()};a.detectCancel=function(){a.detectBroadband=!1};a.doDetectBroadband=function(){d.update({id:1},{detectBroadband:!0},function(){a.rebootingPage=!0;window.setTimeout(a.testConnection,0)})};a.testConnection=function(){f.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),window.location="/redirect.html?v=v1.0.131"):
window.setTimeout(a.testConnection,3E3)})};a.toggleChildren=function(){a.showChildren=!a.showChildren;k.connectionListIsAdvanced=!0==a.showChildren?!0:!1};a.checkNetworkConnections=function(){c.path("/network/connections")}}]).controller("NetworkConnectionCtrl",["$scope","$route","$routeParams","$location","NetworkConnections","Devices","securityTips",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;a.fromString="";a.oldFrom="";a.prev="";a.deviceBridge=[];if(null!=c.from){a.fromString=
"?from="+c.from;b=c.from.split("-");"arptable"==b[b.length-1]?a.back="/advanced/arptable":"connlist"==b[b.length-1]?a.back="/advanced/dhcp/connections":"edit"==b[b.length-1]?a.back="/network/connections/0/edit":-1!=b[b.length-1].indexOf("dev_")?a.back="/network/device/details/"+b[b.length-1].substr(4):""===b[b.length-1]||isNaN(b[b.length-1])||(a.back="/network/connections/"+b[b.length-1]);for(var h=0;h<b.length-1;h++)0!=h&&(a.oldFrom+="-"),a.oldFrom+=b[h];""!==a.oldFrom&&(a.prev="?from="+a.oldFrom)}else a.back=
"/network/connections";a.deviceNames=[];a.checkForDevicesNow=function(a,b){var c=!1,d="";switch(String(b)){case "2":d="4";break;case "3":d="5";break;case "4":d="0";break;default:return!1}if(0<a.length){for(var e=0;e<a.length;e++){if(String(a[e].connectionType)==String(d)&&!0==a[e].status){c=!0;break}if("6"==String(a[e].connectionType)&&a[e].approved&&"5"==String(d)&&!0==a[e].status){c=!0;break}if("7"==String(a[e].connectionType)&&"4"==String(d)&&!0==a[e].status){c=!0;break}}return c}return!1};a.showBridgeDeviceList=
function(b){for(var c=0;c<a.deviceBridge.length;c++)if(a.deviceBridge[c].name==b)return a.deviceBridge[c].toShowOut;return!0};a.findDeviceNames=function(b){for(var c=0;c<a.deviceBridge.length;c++)if(a.deviceBridge[c].name==b)return a.deviceBridge[c].realDeviceName};var k,m=f.query(function(){k=e.get({id:c.id},function(){a.name=unescape(k.name);a.deviceBridge=[];if(k.availableBridges)for(var b=0;b<k.availableBridges.length;b++){var c={};c.name=k.availableBridges[b];c.toShowOut=k.bridged[b];a.deviceBridge.push(c)}k.hasConnectedDeviceNow=
a.checkForDevicesNow(m,k.connectionId);a.connections=e.query(function(){for(var b=0;b<a.connections.length;b++);if(k.underlyingDevices)for(angular.forEach(k.underlyingDevices,function(b){angular.forEach(a.connections,function(c){c.connectionId==b&&a.deviceNames.push(unescape(c.name))})}),b=0;b<a.deviceBridge.length;b++)for(var c=0;c<a.connections.length;c++)if(a.connections[c].connectionId==a.deviceBridge[b].name){a.deviceBridge[b].realDeviceName=unescape(a.connections[c].name);break}a.connection=
k;a.connFromString=""===a.fromString?"?from="+a.connection.connectionId:a.fromString+"-"+a.connection.connectionId;a.showIpv6=!1;void 0!==k.ipv6Address&&"::"!==k.ipv6Address&&""!==k.ipv6Address&&(a.showIpv6=!0)})})});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.refreshContentsNow=function(){location.reload()};a.toggleEnabled=function(){e.update({id:k.connectionId},{enabled:!k.enabled},function(){3==k.connectionId||2==k.connectionId?(a.savePopup=g.showSaving1("Save Settings",
"Saving your settings. Please wait..."),window.setTimeout(a.refreshContentsNow,15E3)):a.refreshContentsNow()})};a.toggleCoaxEnabled=function(){e.update({id:k.connectionId},{coaxEnabled:!k.coaxEnabled},function(){3==k.connectionId||2==k.connectionId?(a.savePopup=g.showSaving1("Save Settings","Saving your settings. Please wait..."),window.setTimeout(a.refreshContentsNow,15E3)):a.refreshContentsNow()})};a.cancelBtn=function(){window.scrollTo(0,0);null!=c.fromsystemtraffic?d.url("/monitoring/traffic"):
null!=c.fromsystemfullstatus?d.url("/monitoring/fullstatus"):null!=c.fromdevicenetwork?d.url("/network/device/details/"+c.devicenum+"?fromdevicenetwork=true&devicenum="+c.devicenum):null!=c.connEdit?d.url("/network/connections/"+c.connEdit+"/edit"):d.url(a.back+a.prev)};a.saveName=function(b){a.errorMessages=[];a.connection.name=escape(a.name.replace(/^\s+|\s+$/g,"")).replace(/\+/g,"%2B");if(0==a.connection.name.length)a.errorMessages.push("Connection Name: Connection Name cannot be empty.");else for(var f=
0;f<a.connections.length;f++)f!=a.connection.connectionId&&unescape(a.connection.name)==unescape(a.connections[f].name)&&a.errorMessages.push("Connection Name:  Connection Name already in use.");0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):e.update({id:b.connectionId},{name:a.connection.name},function(){window.scrollTo(0,0);null!=c.fromsystemtraffic?d.url("/monitoring/traffic"):null!=c.fromsystemfullstatus?d.url("/monitoring/fullstatus"):null!=c.fromdevicenetwork?d.url("/network/device/details/"+
c.devicenum+"?fromdevicenetwork=true&devicenum="+c.devicenum):null!=c.connEdit?d.url("/network/connections/"+c.connEdit+"/edit"):""==a.oldFrom?d.path(a.back).search({}):d.path(a.back).search({from:a.oldFrom})})};a.checkNetworkConnections=function(){d.path("/network/connections")};a.keyPress=function(b){13==b.keyCode&&d.path()=="/network/connections/"+c.id&&a.saveName(a.connection)}}]).controller("NetworkConnectionEditCtrl",["$scope","$route","$routeParams","$location","DhcpOptions","NetworkConnections",
"DhcpConnections","Routes","Devices","FirewallDMZ",function(a,b,c,d,e,f,g,h,k,m){a.tab=b.current.tab;a.section=b.current.section;a.confirm=!1;a.messages=[];a.staticConnections=[];a.routesConnections=[];a.oldCoaxPassword="";a.coTempIPAddress="";a.coTempHomeName="";a.tempStatic={};a.listOfNetworkIPAddress=[];a.fromString=c.from?"?from="+c.from+"&connectionEdit="+c.id:"?connectionEdit="+c.id;a.getStyleName=function(a){switch(a){case 0:return"Network";case 1:return"Network";case 2:return"Wireless";case 3:return"Wireless";
case 4:return"Ethernet";case 5:return"Coax";default:return"Network"}};a.checkForDevicesNow=function(a,b){var c=!1,d="";switch(String(b)){case "2":d="4";break;case "3":d="5";break;case "4":d="0";break;default:return!1}if(0<a.length){for(var e=0;e<a.length;e++){if(String(a[e].connectionType)==String(d)&&!0==a[e].status){c=!0;break}if("6"==String(a[e].connectionType)&&a[e].approved&&"5"==String(d)&&!0==a[e].status){c=!0;break}if("7"==String(a[e].connectionType)&&"4"==String(d)&&!0==a[e].status){c=!0;
break}}return c}return!1};var p=k.query(function(){a.connection=f.get({id:c.id},function(){a.connection.styleName=a.getStyleName(c.id);if(a.connection.dhcpExpires){var b=a.connection.dhcpExpires;a.connection.dhcpExpireTime=0!=b?Math.ceil(b/60)+" minutes":"Expired"}a.name=unescape(a.connection.name);a.connection.name=unescape(a.connection.name);a.connection.hasConnectedDeviceNow=a.checkForDevicesNow(p,a.connection.connectionId);a.oldsubnet=a.connection.subnetMask;a.oldProtocolUsed=a.connection.protocolUsed;
switch(a.connection.type){case 3:a.connectionType="Ethernet";break;case 5:a.connectionType="Coax";break;case 4:a.connectionType="AP";break;default:a.connectionType="Basic"}1==a.connection.connectionId&&(a.tempStatic={ipAddress:a.connection.ipAddress,defaultGateway:a.connection.defaultGateway,primaryDnsServer:a.connection.primaryDnsServer,secondaryDnsServer:a.connection.secondaryDnsServer,subnetMask:a.connection.subnetMask},a.connection.ipAddress=void 0!=a.connection.staticIpAddress?a.connection.staticIpAddress:
a.connection.ipAddress,a.connection.defaultGateway=void 0!=a.connection.staticDefaultGateway?a.connection.staticDefaultGateway:a.connection.defaultGateway,a.connection.primaryDnsServer=void 0!=a.connection.staticPrimaryDnsServer?a.connection.staticPrimaryDnsServer:a.connection.primaryDnsServer,a.connection.secondaryDnsServer=void 0!=a.connection.staticSecondaryDnsServer?a.connection.staticSecondaryDnsServer:a.connection.secondaryDnsServer,a.connection.subnetMask=void 0!=a.connection.staticSubnetMask?
a.connection.staticSubnetMask:a.connection.subnetMask);a.connection.ipAddress&&(a.initialIpAddress=a.connection.ipAddress,a.ipAddress=splitIpArr(a.connection.ipAddress),a.subnetMask=splitIpArr(a.connection.subnetMask),null!=a.connection.defaultGateway&&(a.defaultGateway=splitIpArr(a.connection.defaultGateway)),a.connection.primaryDnsServer&&(a.primaryDnsServer=splitIpArr(a.connection.primaryDnsServer),a.secondaryDnsServer=splitIpArr(a.connection.secondaryDnsServer)));1==a.connection.connectionId&&
(a.oldCoaxPassword=a.connection.coaxPassword);a.bridges=null;a.connection.availableBridges&&(a.bridges=[],a.allConnections=f.query(function(){for(var b=0;b<a.connection.availableBridges.length;b++)for(var c=0;c<a.allConnections.length;c++)if(a.allConnections[c].connectionId==a.connection.availableBridges[b]){a.bridges.push(a.allConnections[c]);a.bridges[b].fromString=""===a.fromString?"?from=edit&connEdit="+a.connection.connectionId:a.fromString+"-edit&connEdit="+a.connection.connectionId;a.bridges[b].styleName=
a.getStyleName(a.bridges[b].connectionId);a.bridges[b].bridged=a.connection.bridged[b];a.bridges[b].name=unescape(a.bridges[b].name);a.bridges[b].hasConnectedDeviceNow=a.checkForDevicesNow(p,a.bridges[b].connectionId);break}}));a.dmz=m.get(function(){});a.connections=f.query(function(){var b=0;a.listOfNetworkIPAddress=[];for(var d=0;d<a.connections.length;d++){if(null!=a.connections[d].bridged)for(var f=0;f<a.connections[d].bridged.length;f++)a.connections[d].bridged[f]&&(a.connections[a.connections[d].availableBridges[f]].name=
...
-1;a.bothDisabled=!1;a.basicGuestWifiEnabled=!1;a.guestPassWifiEnabled=!1;a.guestWifiEnum={BASIC_GUEST_WIFI:2,GUEST_PASS:3};a.tabsEnum={1:"partials/wireless/guestDevicesTab.html?v=v1.0.131",2:"partials/wireless/basicGuestWifiTab.html?v=v1.0.131",3:"partials/wireless/guestPassWifiTab.html?v=v1.0.131"};a.section=b.current.section;b=c.path();-1!=b.indexOf("/wireless/guestWifiSetup/devices")?a.currentTab=1:-1!=b.indexOf("/wireless/guestWifiSetup/basic")?a.currentTab=2:-1!=b.indexOf("/wireless/guestWifiSetup/pass")?
...
d,e,f,g,h,k,m){a.warningFlag=!1;a.pageToShow=0;a.tab=b.current.tab;a.section=b.current.section;a.keySet=!1;a.showPassword=!0;k.editingGuest=!1;k.guestHasChanges=!1;a.countDownPopup=null;a.fakeTimer=!1;a.listener=null;a.tempWPAkey="";a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.refresh=function(){a.showPassword=!0;a.wireless=d.query(function(){a.wirelessA=a.wireless[0];a.wirelessB=a.wireless[1];a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];a.guestPassWifi=a.wireless[a.guestWifiEnum.GUEST_PASS];
a.basicGuestWifi.ssid=a.basicGuestWifi.ssid;a.tempWPAkey="";void 0!=a.basicGuestWifi&&null!=a.basicGuestWifi&&(a.guestDevices=m.query(function(){a.guestDevices=filterOutNonGuest(a.guestDevices)}),a.wpa=f.get({id:a.guestWifiEnum.BASIC_GUEST_WIFI},function(){void 0!=a.wpa.key&&(a.wpa.key=a.wpa.key,a.tempWPAkey=h.trustAsHtml(a.convertKey(a.wpa.key)),a.keySet=""!==a.wpa.key?!0:!1)}));a.warningFlag=void 0!=a.basicGuestWifi&&null!=a.basicGuestWifi&&!a.basicGuestWifi.enabled&&void 0!=a.guestPassWifi&&null!=
a.guestPassWifi&&a.guestPassWifi.enabled?!0:!1});a.mainRefresh();a.togglePage(0)};a.convertKey=function(a){var b="";if(a)for(var c=0;c<a.length;c++)b+="&bull;";return b=unescape(b)};a.refresh();a.toggleOnOffSave=function(){a.wirelessA.radioEnabled?a.basicGuestWifi.enabled?(a.basicGuestWifi.enabled=!1,a.saveToggle(!0)):a.guestPassWifi.enabled?g.showWarningMsgGuestWifi("","Turning on the Basic Guest Wi-Fi will disable the Guest Pass Wi-Fi.",!0,[""]).then(function(b){"cancel"!=b&&(a.keySet?a.saveSettings(!0):
a.showKeyForm())}):a.keySet?a.saveSettings(!0):a.showKeyForm():g.showWirelease24GPrompt("","").then(function(a){})};a.saveSettings=function(b){a.basicGuestWifi.enabled=!0;a.guestPassWifi.enabled=!1;a.saveToggle(b)};a.saveToggle=function(b){a.basicGuestWifi.radioFreq=a.wirelessA.radioEnabled?1:-1;a.guestPassWifi.radioFreq=a.wirelessA.radioEnabled?1:-1;clearTimeout(a.fakeTimer);a.countDownPopup=g.showSavingNow("Save Settings","Saving your settings. Please wait...");a.countDownPopup.open();a.fakeTimer=
window.setTimeout(a.closeCountDownPopup1,15E3);d.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},a.basicGuestWifi,function(){b?a.refresh():a.saveWifiKey()})};a.showKeyForm=function(){g.showCreateGuestWifiPassword("Create Password","Please create a password to activate your Guest Wi-Fi.",a.wpa).then(function(b){if("cancel"==b.result)a.refresh();else{var c=!1;if(void 0==b.returnObj)c=!0;else if(a.wpa.key=b.returnObj,8>a.wpa.key.length||63<a.wpa.key.length)c=!0;c?a.openValidationPopup():f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},
{wpaShowKeyInUI:b.wpaShowKeyInUI},function(){a.saveSettings(!1)})}})};a.openValidationPopup=function(){g.showWarningMsgGuestWifi("","Password has to be at least 8 characters long",!1,[""]).then(function(b){"ok"==b&&a.showKeyForm()})};a.openValidationPopup1=function(){g.showWarningMsgGuestWifi("","Password has to be at least 8 characters long",!1,[""]).then(function(a){})};a.openValidationPopup2=function(){g.showWarningMsgGuestWifi("","SSID must be 1 to 64 characters",!1,[""]).then(function(a){})};
a.openValidationPopup3=function(){g.showWarningMsgGuestWifi2("","SSID must be 1 to 64 characters",!1,[""]).then(function(a){})};a.saveWifiKey=function(){a.wpa.encryptionAlgorithm=parseInt(a.wpa.encryptionAlgorithm);f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{type:a.wpa.type,mode:a.wpa.mode,encryptionAlgorithm:a.wpa.encryptionAlgorithm,groupKeyUpdateInterval:a.wpa.groupKeyUpdateInterval,groupKeyUpdateIntervalEnabled:a.wpa.groupKeyUpdateIntervalEnabled,key:a.wpa.key},function(){})};a.editWifiSettings=
function(){k.editingGuest=!0;k.guestHasChanges=!1};a.saveWifiSettings=function(){var b=!1,c=!1;if(8>a.wpa.key.length||63<a.wpa.key.length)b=!0;if(1>a.basicGuestWifi.ssid.length||64<a.basicGuestWifi.ssid.length||!/^[0-9a-zA-Z\!\"\#\$\%\&\u2019\'\(\)\*\+\,\-\.\/\:\;\<\=\>\?\@\[\\\]\^\_\`\{\|\}\~\ ]+$/i.test(a.basicGuestWifi.ssid))c=!0;c&&b?(a.cancelRedirect(),a.openValidationPopup3()):c?(a.cancelRedirect(),a.openValidationPopup2()):b?(a.cancelRedirect(),a.openValidationPopup1()):(a.basicGuestWifi.ssid=
a.basicGuestWifi.ssid,clearTimeout(a.fakeTimer),a.countDownPopup=g.showSavingNow("Save Settings","Saving your settings. Please wait..."),a.countDownPopup.open(),a.fakeTimer=window.setTimeout(a.closeCountDownPopup,15E3),d.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},a.basicGuestWifi,function(){f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{wpaShowKeyInUI:a.wpa.wpaShowKeyInUI},function(){a.saveWifiKey()})}))};a.closeCountDownPopup1=function(){a.countDownPopup.close();a.countDownPopup=null;a.basicGuestWifi.ssid=
"";a.refresh();k.editingGuest=!1};a.closeCountDownPopup=function(){a.countDownPopup.close();a.countDownPopup=null;k.locationChangeActivate?a.redirect():(a.basicGuestWifi.ssid="",a.refresh(),k.editingGuest=!1)};a.cancel=function(){a.refresh();k.editingGuest=!1;k.guestHasChanges=!1};a.change=function(){k.guestHasChanges=!0};a.saveContents1Function=function(b){a.saveWifiSettings()};a.listener=k.$on("saveContents1",a.saveContents1Function);a.$on("$destroy",function(){a.listener()});a.redirect=function(){k.locationChangeActivate=
!1;k.editingGuest=!1;k.guestHasChanges=!1;""==getNextLocationForLocationChangeSub(k.locationChangeNext)?c.path(getNextLocationForLocationChange(k.locationChangeNext)):c.path(getNextLocationForLocationChange(k.locationChangeNext)).search(getNextLocationForLocationChangeSub(k.locationChangeNext))};a.toggleShowPassword=function(){f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{wpaShowKeyInUI:a.wpa.wpaShowKeyInUI},function(){})};a.cancelRedirect=function(){k.locationChangeActivate=!1}}]).controller("BasicGuestCtrlPopup",
["$scope","WPA","model","dialog",function(a,b,c,d){a.key=c.key;a.wpaPopup=c.wpa;a.buttons=c.buttons;a.title=c.title;a.message=c.message;a.close=function(b){d.close({result:b,returnObj:a.key,wpaShowKeyInUI:a.wpaPopup.wpaShowKeyInUI})}}]).controller("GuestPassWifiCtrl",["$scope","$route","$location","Wireless","GuestPassDevices","securityTips","Devices","$rootScope",function(a,b,c,d,e,f,g,h){a.warningFlag=!1;a.pageToShow=0;a.tab=b.current.tab;a.section=b.current.section;h.editingGuest=!1;h.guestHasChanges=
!1;a.listener=null;a.countDownPopup=null;a.fakeTimer=null;a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.refresh=function(){a.wireless=d.query(function(){a.wirelessA=a.wireless[0];a.wirelessB=a.wireless[1];a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];a.guestPassWifi=a.wireless[a.guestWifiEnum.GUEST_PASS];a.guestPassWifi.ssid=a.guestPassWifi.ssid;void 0!=a.guestPassWifi&&null!=a.guestPassWifi&&(a.guestDevices=g.query(function(){a.guestDevices=filterOutNonGuest(a.guestDevices)}));
a.warningFlag=void 0!=a.guestPassWifi&&null!=a.guestPassWifi&&!a.guestPassWifi.enabled&&void 0!=a.basicGuestWifi&&null!=a.basicGuestWifi&&a.basicGuestWifi.enabled?!0:!1});a.mainRefresh();a.togglePage(0)};a.refresh();a.toggleOnOffSave=function(){a.wirelessA.radioEnabled?a.guestPassWifi.enabled?(a.guestPassWifi.enabled=!1,a.saveToggle()):a.basicGuestWifi.enabled?f.showWarningMsgGuestWifi3("","This will disable Basic Guest Wi-Fi and open your Wi-Fi to an unsecure security model.",!0,[""]).then(function(b){"cancel"!=
b&&(a.guestPassWifi.enabled=!0,a.basicGuestWifi.enabled=!1,a.saveToggle())}):(a.guestPassWifi.enabled=!0,a.saveToggle()):f.showWirelease24GPrompt("","").then(function(a){})};a.saveToggle=function(){a.basicGuestWifi.radioFreq=a.wirelessA.radioEnabled?1:-1;a.guestPassWifi.radioFreq=a.wirelessA.radioEnabled?1:-1;a.guestPassWifi.ssid=a.guestPassWifi.ssid;clearTimeout(a.fakeTimer);a.countDownPopup=f.showSavingNow("Save Settings","Saving your settings. Please wait...");a.countDownPopup.open();a.fakeTimer=
window.setTimeout(a.closeCountDownPopup,15E3);d.update({id:a.guestWifiEnum.GUEST_PASS},a.guestPassWifi,function(){})};a.closeCountDownPopup=function(){a.countDownPopup.close();a.countDownPopup=null;h.locationChangeActivate?a.redirect():(a.guestPassWifi.ssid="",a.refresh(),h.editingGuest=!1)};a.editWifiSettings=function(){h.editingGuest=!0;h.guestHasChanges=!1};a.openValidationPopup2=function(){f.showWarningMsgGuestWifi("","SSID must be 1 to 64 characters",!1,[""]).then(function(a){})};a.saveWifiSettings=
function(){var b=!1;if(1>a.guestPassWifi.ssid.length||64<a.guestPassWifi.ssid.length||!/^[0-9a-zA-Z\!\"\#\$\%\&\u2019\'\(\)\*\+\,\-\.\/\:\;\<\=\>\?\@\[\\\]\^\_\`\{\|\}\~\ ]+$/i.test(a.guestPassWifi.ssid))b=!0;b?(a.cancelRedirect(),a.openValidationPopup2()):a.saveToggle()};a.cancel=function(){a.refresh();h.editingGuest=!1;h.guestHasChanges=!1};a.change=function(){h.guestHasChanges=!0};a.saveContents2Function=function(b){a.saveWifiSettings()};a.listener=h.$on("saveContents2",a.saveContents2Function);
a.$on("$destroy",function(){a.listener()});a.redirect=function(){h.locationChangeActivate=!1;h.editingGuest=!1;h.guestHasChanges=!1;""==getNextLocationForLocationChangeSub(h.locationChangeNext)?c.path(getNextLocationForLocationChange(h.locationChangeNext)):c.path(getNextLocationForLocationChange(h.locationChangeNext)).search(getNextLocationForLocationChangeSub(h.locationChangeNext))};a.cancelRedirect=function(){h.locationChangeActivate=!1}}]);
