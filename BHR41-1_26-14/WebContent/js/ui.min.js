...
d.save(function(){window.setTimeout(a.testConnection,0)});a.page=3};a.testConnection=function(){e.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),window.location=findCurrentPath()+"/redirect.html?v=v1.0.134"):window.setTimeout(a.testConnection,3E3)})}}]).controller("localAdminCtrl",["$scope","$route","$location","LocalAdmin","SystemSettings",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=e.get();
a.locAdmin=d.get();a.save=function(){a.locAdmin.$update(function(){c.path("/advanced")})};a.keyPress=function(b){13==b.keyCode&&"/advanced/localadmin"==c.path()&&a.save()}}]).controller("remoteAdminCtrl",["$scope","$route","$routeParams","$location","RemoteAdmin","SystemSettings",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=f.get();a.remAdmin=e.get();a.fromString="?from=ad";b="";a.prev="";a.back="/advanced";a.comingFrom="";if(null!=c.from){a.comingFrom=c.from;
a.fromString="?from="+c.from+"-ad";a.back="/advanced/settings";c=c.from.split("-");for(e=0;e<c.length-1;e++)0!=e&&(b+="-"),b+=c[e];""!==b&&(a.prev="?from="+b)}else a.back="/advanced";a.save=function(){a.remAdmin.$update(function(){""==a.oldFrom?d.path(a.back).search({}):"settings"==a.comingFrom?location.reload():d.path(a.back).search({from:a.oldFrom})})};a.keyPress=function(b){13==b.keyCode&&"/advanced/remoteadmin"==d.path()&&a.save()}}]).controller("systemSettingsCtrl",["$scope","$route","$routeParams",
"$location","SystemSettings","securityTips",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.fromString="?from=settings";a.oldFrom="";a.prev="";a.oldDomainName="";if(null!=c.from){a.fromString="?from="+c.from+"-settings";b=c.from.split("-");"fw"==b[b.length-1]?a.back="/firewall/remoteadmin":"ad"==b[b.length-1]&&(a.back="/advanced/remoteadmin");for(c=0;c<b.length-1;c++)0!=c&&(a.oldFrom+="-"),a.oldFrom+=b[c];""!==a.oldFrom&&(a.prev="?from="+a.oldFrom)}else a.back=
...
!1;window.uploadDone=function(){if(a.loadFile)var b=d.get(function(){b.successful?(e.save(function(){window.setTimeout(a.testConnection,0)}),a.completed=!0):(a.errorMessages=["Configuration File: Bad format of configuration file."],a.showErrorPage=!0)})};a.testConnection=function(){g.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,h.removeAll(),window.location=findCurrentPath()+"/redirect.html?v=v1.0.134"):window.setTimeout(a.testConnection,
3E3)})};a.toggleShow=function(b){k(function(){document.getElementById("submitting").focus()},1E3);a.loadFile=!a.loadFile;0==b&&(a.inputFile=null)};a.errorPageOk=function(){a.showErrorPage=!1;a.loadFile=!1;a.completed=!1;a.isFileSubmitted=!1;window.scrollTo(0,0)};a.submittingFile=function(){a.isFileSubmitted=!0};a.saving=function(){f.get(function(a){window.location="api/settings/configfile"})};a.loadConfig=function(){document.getElementById("submitting").focus()};a.setFocus=function(){k(function(){document.getElementById("submitting").focus()},
...
3E3)},function(b){401==b.status?(a.restarting=!0,h.removeAll(),window.location=0==a.resetType?findCurrentPath()+"/redirectSetup.html?v=v1.0.134":findCurrentPath()+"/redirect.html?v=v1.0.134"):window.setTimeout(a.testConnection,3E3)})}}]).controller("rebootCtrl",["$scope","$route","Reboot","SystemSettings","Login","$location","$templateCache",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=d.get();a.rebooting=!1;a.restarting=!1;a.reboot=function(){a.rebooting=
!0;c.save(function(){window.setTimeout(a.testConnection,0)})};a.testConnection=function(){d.get(function(){window.setTimeout(a.testConnection,3E3)},function(b){401==b.status?(a.restarting=!0,g.removeAll(),window.location=findCurrentPath()+"/redirect.html?v=v1.0.134"):window.setTimeout(a.testConnection,3E3)})};a.keyPress=function(b){13==b.keyCode&&"/advanced/reboot"==f.path()&&a.reboot()}}]).controller("macCloningCtrl",["$scope","$route","$location","MacCloning",function(a,b,c,d){a.tab=b.current.tab;
a.section=b.current.section;a.showErrorPage=!1;a.macCloning=d.get(function(){a.macAddress=splitMacArr(a.macCloning.mac)});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.save=function(){a.errorMessages=[];a.macCloning.mac=getMacString(a.macAddress);if(!validateMac(a.macCloning.mac))a.errorMessages=["MAC Address: MAC address must consist of 6 fields. Each field's value must be between 00 and FF (in hexadecimal representation), without any spaces. The LSB of the first byte must be zero."];
else if(/[f\:]{17}$/i.test(a.macCloning.mac))a.errorMessages.push("MAC Address: MAC FF:FF:FF:FF:FF:FF is reserved for broadcast.");else if(!validateMac(a.macCloning.mac)||/[0\:]{17}$/i.test(a.macCloning.mac)||1==(parseInt(a.macAddress[0],16)&1))a.errorMessages=["MAC Address: MAC address must consist of 6 fields. Each field's value must be between 00 and FF (in hexadecimal representation), without any spaces. The LSB of the first byte must be zero."];0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,
0)):a.macCloning.$update(function(){c.path("/advanced")})};a.restore=function(){a.macAddress=splitMacArr(a.macCloning.defaultMac)};a.keyPress=function(b){13==b.keyCode&&"/advanced/maccloning"==c.path()&&a.save()}}]).controller("usersCtrl",["$scope","$route","$routeParams","$location","Users","SystemSettings",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.sysSettings=f.get();a.updateContent=function(){a.userObj=e.get(function(){a.user=a.userObj.users[0];a.userObj.users[0].fullName=
unescape(a.userObj.users[0].fullName);null!=c.edit&&a.edit(0)})};a.updateContent();a.pageToShow=0;a.editing=-1;a.showErrorPage=!1;a.setPassword=!1;a.showPassword=!1;a.userObjs=null;a.newPass=!1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.save=function(){a.errorMessages=[];var b=Number(a.userObj.maxLoginAttempts);(isNaN(b)||1>b||99<b)&&a.errorMessages.push("Maximum Unsuccessful Login Attempts: Please enter a numeric value between 1 and 99.");0<a.errorMessages.length?(a.showErrorPage=
!0,window.scrollTo(0,0)):e.update({maxLoginAttempts:b},function(){void 0!=window?window.location.reload(!0):location.reload(!0)})};a.togglePage=function(b){0==b?null!=c.frommain?d.url(d.path("/main")):(a.pageToShow=b,a.updateContent()):a.pageToShow=b;window.scrollTo(0,0)};a.edit=function(b){a.newName=a.userObj.users[0].fullName;a.newPassword="";a.rtNewPassword="";a.setPassword=!1;a.editing=b;a.togglePage(1)};a.saveUserCfm=function(){e.update({users:[a.userObjs]},function(){a.userObj.users[0].fullName=
unescape(a.userObj.users[0].fullName);a.newPass?d.path("/logout"):a.togglePage(0)})};a.saveUser=function(){a.userObjs={id:0};a.errorMessages=[];""==a.newName&&a.errorMessages.push("Full Name: A string must be specified.");a.newPass=!1;a.setPassword&&(0==a.newPassword.length&&0==a.rtNewPassword.length&&a.errorMessages.push("New Password: A password must be specified."),a.newPassword!=a.rtNewPassword&&a.errorMessages.push("Incorrect New Password: Entered passwords mismatch."),0==a.errorMessages.length&&
(a.user.password=a.newPassword),a.userObjs.salt=uuid(),a.userObjs.password=CryptoJS.SHA512(a.newPassword+a.userObjs.salt).toString(),a.newPass=!0);0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.userObjs.fullName=escape(a.newName).replace(/\+/g,"%2B"),a.newPass?!0==a.sysSettings.warnBeforeChanges?a.togglePage(2):a.saveUserCfm():a.saveUserCfm())};a.keyPress=function(b){13==b.keyCode&&"/advanced/users"==d.path()&&(1!=a.pageToShow||a.showErrorPage?a.save():a.saveUser())}}]).controller("schedulerCtrl",
["$scope","$route","Schedules","DateTimeSettings","$location","AccessControl","PortForward",function(a,b,c,d,e,f,g){a.tab=b.current.tab;a.section=b.current.section;a.runFocus=!1;init_schedules(a);a.pageToShow=0;a.editing=!1;a.showErrorPage=!1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.save=function(){a.schedules.$update(function(){void 0!=window?window.location.reload(!0):location.reload(!0)})};a.refresh=function(){a.schedules=c.query(function(){for(var b=0;b<a.schedules.length;b++)a.schedules[b].name=
unescape(a.schedules[b].name);a.printSchedArr=[];printSchedule(0,a.schedules,a.printSchedArr);a.dateTimeSettings=d.get(function(){a.localTimeMoment=findTimeNow(a.dateTimeSettings);for(var b=0;b<a.schedules.length;b++)a.schedules[b].status=isScheduleActive(a.schedules[b],a.localTimeMoment)})})};a.refresh();a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.removeSchedule=function(b){var c=!1;a.toDeleteIndex=b;a.portForward=g.query(function(){a.accessControl=f.query(function(){for(var b=
0;b<a.accessControl.length;b++)if(null!=a.accessControl[b].schedule&&unescape(a.accessControl[b].schedule.name)==a.schedules[a.toDeleteIndex].name){c=!0;break}for(b=0;b<a.portForward.length;b++)if(null!=a.portForward[b].schedule&&unescape(a.portForward[b].schedule)==a.schedules[a.toDeleteIndex].name){c=!0;break}c?a.togglePage(8):a.removeScheduleNow(a.toDeleteIndex)})})};a.updateAccessControlBeforeRemove=function(){var b=!0;a.portForward=g.query(function(){a.accessControl=f.query(function(){for(var c=
0;c<a.accessControl.length;c++)if(null!=a.accessControl[c].schedule&&unescape(a.accessControl[c].schedule.name)==a.schedules[a.toDeleteIndex].name){a.accessControl[c].schedule="";a.accessControl[c].schedule1={};f.update({id:a.accessControl[c].id},a.accessControl[c],function(){a.updateAccessControlBeforeRemove()});b=!1;break}if(b)for(c=0;c<a.portForward.length;c++)if(null!=a.portForward[c].schedule&&unescape(a.portForward[c].schedule)==a.schedules[a.toDeleteIndex].name){a.portForward[c].schedule="Always";
g.remove({id:a.portForward[c].id},function(){a.portForward[c].id="";g.save(a.portForward[c],function(){a.updateAccessControlBeforeRemove()})});b=!1;break}b&&a.removeScheduleNow(a.toDeleteIndex)})})};a.removeScheduleNow=function(b){c.remove({id:a.schedules[b].id},function(){a.togglePage(0);a.refresh()})};a.applyRuleScheduler=function(){a.errorMessages=[];""===a.schedule.name&&a.errorMessages.push("Description: A string must be specified.");for(var b=0;b<a.schedules.length;b++)if(b!=a.editingRuleSchedule&&
a.schedules[b].name==a.schedule.name){a.errorMessages.push("Name: This name is already used by another scheduler rule.");break}0==a.schedule.timeSegments.length&&a.errorMessages.push("Rule Schedule: At least one time segment should be defined.");if(0<a.errorMessages.length)a.showErrorPage=!0,window.scrollTo(0,0);else{var d={};copySchedule(d,a.schedule);for(b=0;b<d.timeSegments.length;b++)for(var e=0;e<d.timeSegments[b].hourRanges.length;e++)d.timeSegments[b].hourRanges[e].startTimeHour=parseInt(d.timeSegments[b].hourRanges[e].startTimeHour),
d.timeSegments[b].hourRanges[e].startTimeMinute=parseInt(d.timeSegments[b].hourRanges[e].startTimeMinute),d.timeSegments[b].hourRanges[e].endTimeHour=parseInt(d.timeSegments[b].hourRanges[e].endTimeHour),d.timeSegments[b].hourRanges[e].endTimeMinute=parseInt(d.timeSegments[b].hourRanges[e].endTimeMinute);d.name=escape(a.schedule.name).replace(/\+/g,"%2B");-1==a.editingRuleSchedule?c.save(d,function(){a.refresh()}):(d.id=a.schedules[a.editingRuleSchedule].id,c.update(d,function(){a.refresh()}));a.togglePage(0);
init_schedules(a)}};a.formatTimeString=function(a,b){return(10>a?"0"+a:a)+":"+(10>b?"0"+b:b)};a.applyTimeSegment=function(){a.errorMessages=[];for(var b=!1,c=0;c<a.daysOfTheWeek.length;c++)a.daysOfTheWeek[c]&&(b=!0);b||a.errorMessages.push("Days of Week: At least one day must be selected.");0==a.hourRanges.length&&a.errorMessages.push("Hours Range: At least one hour range must be set.");0<a.errorMessages.length?a.showErrorPage=!0:applyTimeSegment(a);window.scrollTo(0,0)};a.applyHourRange=function(){a.runFocus=
!0;a.errorMessages=[];var b=a.hourRange.startTimeHour,c=a.hourRange.endTimeHour,d=a.hourRange.startTimeMinute,e=a.hourRange.endTimeMinute;(""===b||isNaN(b)||0>b||23<b||!checksForWholeNumber(b))&&a.errorMessages.push("Start Time Hour: Please enter a numeric value between 0 and 23.");(""===c||isNaN(c)||0>c||23<c||!checksForWholeNumber(c))&&a.errorMessages.push("End Time Hour: Please enter a numeric value between 0 and 23.");(""===d||isNaN(d)||0>d||59<d||!checksForWholeNumber(d))&&a.errorMessages.push("Start Time Minutes: Please enter a numeric value between 0 and 59.");
(""===e||isNaN(e)||0>e||59<e||!checksForWholeNumber(e))&&a.errorMessages.push("End Time Minutes: Please enter a numeric value between 0 and 59.");0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.hourRange.startTimeHour=parseInt(a.hourRange.startTimeHour),a.hourRange.startTimeMinute=parseInt(a.hourRange.startTimeMinute),a.hourRange.endTimeHour=parseInt(a.hourRange.endTimeHour),a.hourRange.endTimeMinute=parseInt(a.hourRange.endTimeMinute),applyHourRange(a))};a.cancelRuleScheduler=
function(){cancelRuleScheduler(a)};a.cancelTimeSegment=function(){cancelTimeSegment(a)};a.cancelHourRange=function(){cancelHourRange(a)};a.editSchedule=function(b){editRuleScheduler(a,a.schedules,b)};a.editTimeSegment=function(b){editTimeSegment(a,b)};a.editHourRange=function(b){editHourRange(a,b)};a.removeTimeSegment=function(b){removeObject(a.schedule.timeSegments,b)};a.removeHourRange=function(b){removeObject(a.hourRanges,b)};a.keyPress=function(b){13==b.keyCode&&"/advanced/scheduler"==e.path()&&
(0==a.pageToShow?e.path("/advanced"):5!=a.pageToShow||a.showErrorPage?6!=a.pageToShow||a.showErrorPage?7!=a.pageToShow||a.showErrorPage||a.applyHourRange():a.applyTimeSegment():a.applyRuleScheduler())}}]).controller("networkObjectCtrl",["$scope","$route","NetworkObjects","Devices","$location","AccessControl",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.runFocus=!1;a.networkObjects=c.query(function(){for(var b=0;b<a.networkObjects.length;b++)a.networkObjects[b].name=unescape(a.networkObjects[b].name);
a.printAddArr=[];printAddresses(1,a.networkObjects,a.printAddArr)});init_networkObjs(a);a.pageToShow=0;a.editing=-1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.togglePage=function(b){a.pageToShow=b};a.addNetworkObject=function(){init_networkObjs(a);a.togglePage(1);a.editing=-1};a.loadDeviceData=function(b){a.devices=d.query();a.macSelect=-1;a.togglePage(2)};a.copyMacAddress=function(){var b=macSelecter.value;a.rule.mac=-1!=b?splitMacArr(a.devices[b].mac):splitMacArr("00:00:00:00:00:00");
a.rule.macMask=splitMacArr("ff:ff:ff:ff:ff:ff")};a.applyNetworkObj=function(){a.errorMessages=[];if(""===a.networkObj.name)a.errorMessages.push("Description: A string must be specified.");else for(var b=0;b<a.networkObjects.length;b++)a.editingNetworkObj!=b&&a.networkObj.name===a.networkObjects[b].name&&a.errorMessages.push("Description: This name is already used by another network object.");0==a.networkObj.rules.length&&a.errorMessages.push("Items: At least one item entry must be defined.");0<a.errorMessages.length?
(a.showErrorPage=!0,window.scrollTo(0,0)):(b={},copyNetworkObj(b,a.networkObj),a.networkObj.name=escape(a.networkObj.name),-1==a.editingNetworkObj?c.save(b,function(){a.networkObjects=c.query(function(){a.printAddArr=[];printAddresses(1,a.networkObjects,a.printAddArr)})}):c.update({id:a.networkObjects[a.editing].id},b,function(){a.networkObjects=c.query(function(){a.printAddArr=[];printAddresses(1,a.networkObjects,a.printAddArr)})}),a.togglePage(0),init_schedules(a))};a.applyAddress=function(){a.runFocus=
...
a.networkObjects[b].id){d=!1;break}d?c.remove({id:a.networkObjects[b].id},function(){a.networkObjects=c.query(function(){a.printAddArr=[];printAddresses(1,a.networkObjects,a.printAddArr)})}):(a.errorMessages=[],a.errorMessages.push("Network Object: Network object is in use."),a.showErrorPage=!0,window.scrollTo(0,0))})};a.removeAddress=function(b){removeObject(a.networkObj.rules,b)};a.keyPress=function(b){13==b.keyCode&&"/advanced/networkobjects"==e.path()&&(0!=a.pageToShow||a.showErrorPage?1!=a.pageToShow&&
2!=a.pageToShow||a.showErrorPage||(2==a.pageToShow?a.applyAddress():a.applyNetworkObj()):e.path("/advanced"))}}]).controller("portForwardRuleCtrl",["$scope","$route","PortForwardRules","StaticNAT","PortForward","$location",function(a,b,c,d,e,f){a.tab=b.current.tab;a.section=b.current.section;a.showErrorPage=!1;a.runFocus=!1;init_services(a);a.tempPortForward={name:"Global Application",description:"",servType:1,protocols:[]};a.pageToShow=0;a.editing=-1;a.showBasic=!1;a.togglePage=function(b){a.runFocus=
!0;a.pageToShow=b;window.scrollTo(0,0)};a.toggleBasic=function(){a.showBasic=!a.showBasic;window.scrollTo(0,0)};a.refresh=function(){a.nat=d.query();a.forwards=e.query();a.portForwardRules=c.query(function(){a.portForwardRules=sortListItems(a.portForwardRules);a.printProtArr=[];printProtocol(1,a.portForwardRules,a.printProtArr)})};a.refresh();a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.applyPortForwardRule=function(){a.errorMessages=[];""==a.tempPortForward.name?a.errorMessages.push("Service Name: A name must be specified."):
/^[0-9A-Z\!\-\_]+$/i.test(a.tempPortForward.name)||a.errorMessages.push('Service Name: Rule name should consist of standard characters only (ASCII 32-126) excluding the special character space and any of :@"|\\/=+<>()[]{}&%^$*?,;');for(var b=0;b<a.portForwardRules.length;b++)b!=a.editing&&a.portForwardRules[b].name==a.tempPortForward.name&&a.errorMessages.push("Service Name: This name is already used by another protocol.");0==a.tempPortForward.protocols.length&&a.errorMessages.push("Server Ports: At least one server ports entry must be defined.");
if(0<a.errorMessages.length)a.showErrorPage=!0,window.scrollTo(0,0);else{var d={};d.name=escape(a.tempPortForward.name).replace(/\+/g,"%2B");d.description=escape(a.tempPortForward.description).replace(/\+/g,"%2B");d.servType=a.tempPortForward.servType;d.protocols=[];for(b=0;b<a.tempPortForward.protocols.length;b++){var e={};copyProtocol(e,a.tempPortForward.protocols[b]);d.protocols.push(e)}-1==a.editing?c.save(d,function(){a.refresh()}):c.update({id:a.portForwardRules[a.editing].id},d,function(){a.refresh()});
init_services(a);a.tempPortForward={name:"Global Application",description:"",servType:1,protocols:[]};a.editing=-1;a.togglePage(0)}};a.applyProtocol=function(){a.errorMessages=[];a.protocols.protocol=parseInt(a.protocols.protocol);a.protocols.incomingPorts=parseInt(a.protocols.incomingPorts);a.protocols.outgoingPorts=parseInt(a.protocols.outgoingPorts);a.protocols.icmpMessage=parseInt(a.protocols.icmpMessage);var b=a.protocols.incomingPortStart,c=a.protocols.incomingPortEnd,d=a.protocols.outgoingPortStart,
e=a.protocols.outgoingPortEnd;switch(a.protocols.protocol){case 0:var f=a.protocols.protocolNumber;(null==f||""===f||isNaN(f)||0>f||255<f||isNotaInt(f)||!checksForWholeNumber(f))&&a.errorMessages.push("Protocol Number: Please enter a numeric value between 0 and 255.");break;case 1:case 2:switch(a.protocols.incomingPorts){case 1:(null==b||""===b||1>b||65535<b||isNotaInt(b))&&a.errorMessages.push("Source Port: Please enter a numeric value between 1 and 65535.");break;case 2:(null==b||""===b||1>b||65535<
b||isNotaInt(b))&&a.errorMessages.push("Start Source Port: Please enter a numeric value between 1 and 65535."),(null==c||""===c||1>c||65535<c||isNotaInt(c))&&a.errorMessages.push("End Source Port: Please enter a numeric value between 1 and 65535."),0==a.errorMessages.length&&b>=c&&a.errorMessages.push("Source Ports: The From value must be lower than the To value in a range of ports (from="+b+", to="+c+").")}switch(a.protocols.outgoingPorts){case 1:(null==d||""===d||1>d||65535<d||isNotaInt(d))&&a.errorMessages.push("Destination Port: Please enter a numeric value between 1 and 65535.");
4567==d&&!1==a.protocols.outgoingExclude&&1==a.protocols.protocol&&a.errorMessages.push("Invalid rule: Port 4567 cannot be blocked");break;case 2:(null==d||""===d||1>d||65535<d||isNotaInt(d))&&a.errorMessages.push("Start Destination Port: Please enter a numeric value between 1 and 65535."),(null==e||""===e||1>e||65535<e||isNotaInt(e))&&a.errorMessages.push("End Destination Port: Please enter a numeric value between 1 and 65535."),0==a.errorMessages.length&&d>=e&&a.errorMessages.push("Destination Ports: The From value must be lower than the To value in a range of ports (from="+
d+", to="+e+").")}break;case 3:if(10==a.protocols.icmpMessage){var f=a.protocols.icmpType,q=a.protocols.icmpCode;(null==f||""===f||0>f||255<f||isNotaInt(f))&&a.errorMessages.push("ICMP Type:  Please enter a numeric value between 0 and 255.");(null==q||""===q||0>q||255<q||isNotaInt(q))&&a.errorMessages.push("ICMP Code:  Please enter a numeric value between 0 and 255.")}}0==a.errorMessages.length&&(0==a.protocols.incomingPorts&&(a.protocols.incomingExclude=!1),0==a.protocols.outgoingPorts&&(a.protocols.outgoingExclude=
!1),1==a.protocols.protocol||2==a.protocols.protocol)&&(q=f=!1,0==a.protocols.incomingPorts?f=!0:2==a.protocols.incomingPorts&&!1==a.protocols.incomingExclude&&1==b&&65535==c&&(f=!0),0==a.protocols.outgoingPorts?q=!0:2==a.protocols.outgoingPorts&&!1==a.protocols.outgoingExclude&&1==d&&65535==e&&(q=!0),f&&q&&a.errorMessages.push('Port forwarding rules can not be Any-to-Any (or "source: 1-65535" with "destination: 1-65535").'));0==a.errorMessages.length&&(b=getTempObjectContent(a.protocols),a.errorMessages=
...
a.keyPress=function(b){13==b.keyCode&&"/advanced/portforward"==f.path()&&(0!=a.pageToShow||a.showErrorPage?3!=a.pageToShow||a.showErrorPage?4!=a.pageToShow||a.showErrorPage||a.applyProtocol():a.applyPortForwardRule():f.path("/advanced"))}}]).controller("dnsServerCtrl",["$scope","$route","DnsServer","securityTips","$location",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;a.dnsServer=c.query();a.showErrorPage=!1;a.showAdd=!1;a.editing=-1;a.runFocus=!1;a.errorPageOk=function(){a.showErrorPage=
!1;window.scrollTo(0,0)};a.validateBeforeSave=function(){a.errorMessages=[];validateHostnameDNSServer(a.tempDnsServer.hostname)||a.errorMessages.push("Host Name: Name may not contain spaces. Only letters, digits and the special characters dash (-), underscore (_) and dot (.) may be used. These special characters may not appear at the beginning or at the end of a name. The maximum length of a label (text between two dots) is 63.");validateIp(a.tempDnsServer.ipAddress)?"0.0.0.0"===getIpString(a.tempDnsServer.ipAddress)?
a.errorMessages.push("IP Address: IP address may not be 0.0.0.0. IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces. At least one of the values must be greater than 0."):("255.255.255.255"===getIpString(a.tempDnsServer.ipAddress)||224<=Number(a.tempDnsServer.ipAddress[0])&&239>=Number(a.tempDnsServer.ipAddress[0]))&&a.errorMessages.push("Invalid IP address."):a.errorMessages.push("IP Address: IP address must consist of 4 fields. Each field's value must be between 0 and 255, without any spaces.");
for(var b=0;b<a.dnsServer.length;b++)a.editing!=b&&a.tempDnsServer.hostname==a.dnsServer[b].hostname&&a.errorMessages.push("Host Name: This name is already used by another DNS object.");0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):hasADot(a.tempDnsServer.hostname)?d.showWarningMsgBeforeSaving("DNS Entry","Hostnames including a period (.) may not resolve correctly.",[""]).then(function(b){"cancel"!=b&&a.save()}):a.save()};a.save=function(){var b={hostname:a.tempDnsServer.hostname,
...
{};c.name=k.availableBridges[b];c.toShowOut=k.bridged[b];a.deviceBridge.push(c)}k.hasConnectedDeviceNow=a.checkForDevicesNow(m,k.connectionId);a.connections=e.query(function(){for(var b=0;b<a.connections.length;b++);if(k.underlyingDevices)for(angular.forEach(k.underlyingDevices,function(b){angular.forEach(a.connections,function(c){c.connectionId==b&&a.deviceNames.push(unescape(c.name))})}),b=0;b<a.deviceBridge.length;b++)for(var c=0;c<a.connections.length;c++)if(a.connections[c].connectionId==a.deviceBridge[b].name){a.deviceBridge[b].realDeviceName=
...
"4"==String(d)&&!0==a[e].status){c=!0;break}}return c}return!1};var p=k.query(function(){a.connection=f.get({id:c.id},function(){a.connection.styleName=a.getStyleName(c.id);if(a.connection.dhcpExpires){var b=a.connection.dhcpExpires;a.connection.dhcpExpireTime=0!=b?Math.ceil(b/60)+" minutes":"Expired"}a.name=unescape(a.connection.name);a.connection.name=unescape(a.connection.name);a.connection.hasConnectedDeviceNow=a.checkForDevicesNow(p,a.connection.connectionId);a.oldsubnet=a.connection.subnetMask;
...
function validateHostnameDNSServer(a){if(!/[a-z0-9]/i.test(a)||!/^[a-z0-9]$|^[a-z0-9][a-z0-9\_\-]{0,}[a-z0-9]$|^[a-z0-9][a-z0-9]{0,}[\.]{1}[a-z0-9][a-z0-9]{0,}[\.]{1}[a-z0-9]{0,}$|^[a-z0-9][a-z0-9]{0,}[\.]{1}[a-z0-9]{0,}$|^[a-z0-9][a-z0-9]{0,}[\.]{1}[a-z0-9]{0,}[\.]{1}$|^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$/i.test(a))return!1;a=a.split(".");for(var b=0;b<a.length;b++)if(63<a[b].length)return!1;return!0}
...
a.wirelessUpdate=function(){e.update({id:h},{ssidBroadcast:a.ssidBroadcast},function(){d.path("/wireless/advanced")})};a.check5GHzBroadcast=function(){f.showAutoConnectMsgBroadcast("","").then(function(b){"cancel"!=b&&a.wirelessUpdate()})};a.save=function(){a.wpsEnabled&&!a.ssidBroadcast?f.showCustomMessage("Warning",["If SSID Broadcast is disabled for the "+a.wirelessName+" wireless network, then WPS will also be disabled for the "+a.wirelessName+" wireless network.","Are you sure you want to disable SSID Broadcast?"]).then(function(b){"cancel"!=
b&&(0==a.wirelessType?a.wirelessUpdate():a.check5GHzBroadcast())}):a.wirelessUpdate()}}]).controller("WirelessMode",["$scope","$route","$location","Wireless","securityTips",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;var f=d.query(function(){a.modeA=f[0].mode;a.modeB=f[1].mode;a.wirelessAEnabled=f[0].radioEnabled;a.wAtype=f[0].security.enabled?0==f[0].security.type?0:1:1});a.wirelessUpdate=function(){d.update({id:0},{mode:parseInt(a.modeA)},function(){d.update({id:1},{mode:parseInt(a.modeB)},
function(){c.path("/wireless/advanced")})})};a.enableWEP=function(){0!=a.wAtype||!a.wirelessAEnabled||1!=a.modeA&&8!=a.modeA?a.wirelessUpdate():e.showCustomMessage2("Warning",["Compatibility Mode and Performance Mode are not compatible with WEP security. You must first select WPA/WPA2 Mixed Mode or WPA2 security before enabling Compatibility or Performance mode."])};a.save=function(){a.enableWEP()}}]).controller("WirelessTransmissionCtrl",["$scope","$route","$routeParams","$location","WirelessTransmission",
function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;a.errorMessages=[];a.showErrorPage=!1;a.confirmed=!(null!=c.warn&&"true"==c.warn);a.trans1=e.get({id:0});a.trans2=e.get({id:1});a.runFocus=!1;a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.isConfirmed=function(){a.confirmed=!0;a.runFocus=!0};a.keyPress=function(b){13==b.keyCode&&!a.showErrorPage&&a.confirmed&&a.save()};a.save=function(){a.errorMessages=[];a.trans1.ctsProtection=parseInt(a.trans1.ctsProtection);
...
a.trans1.beaconInterval=parseInt(a.trans1.beaconInterval),a.trans2.beaconInterval=parseInt(a.trans2.beaconInterval),a.trans1.dtimInterval=parseInt(a.trans1.dtimInterval),a.trans2.dtimInterval=parseInt(a.trans2.dtimInterval),a.trans1.fragmentationThreshold=parseInt(a.trans1.fragmentationThreshold),a.trans2.fragmentationThreshold=parseInt(a.trans2.fragmentationThreshold),a.trans1.rtsThreshold=parseInt(a.trans1.rtsThreshold),a.trans2.rtsThreshold=parseInt(a.trans2.rtsThreshold),a.trans1.frameBurstMax=
parseInt(a.trans1.frameBurstMax),a.trans2.frameBurstMax=parseInt(a.trans2.frameBurstMax),a.trans1.frameBurstTime=parseInt(a.trans1.frameBurstTime),a.trans2.frameBurstTime=parseInt(a.trans2.frameBurstTime),a.trans1.power=parseInt(a.trans1.power),a.trans2.power=parseInt(a.trans2.power),a.trans1.$update({id:0},function(){a.trans2.$update({id:1},function(){d.path("/wireless/advanced")})}))}}]).controller("WirelessWmmCtrl",["$scope","$route","$routeParams","$location","WirelessWmm",function(a,b,c,d,e){a.tab=
b.current.tab;a.section=b.current.section;a.wirelessName=0==c.id?"2.4 GHz":"5 GHz";a.qos=e.get({id:c.id});a.enabledClick=function(){a.qos.enabled||(a.qos.powerSave=!1)};a.save=function(){a.qos.$update({id:c.id},function(){location.reload()})};a.keyPress=function(b){13==b.keyCode&&d.path()=="/wireless/wmm/"+c.id&&a.save()}}]).controller("WirelessWEPCtrl",["$scope","$route","$routeParams","$location","WEP","securityTips","WPS","Wireless",function(a,b,c,d,e,f,g,h){a.tab=b.current.tab;a.section=b.current.section;
a.showErrorPage=!1;a.errorMessages=[];var k=c.id;a.wirelessName=0==k?"2.4 GHz":"5 GHz";a.wep=e.get({id:k},function(){var b=g.get({id:0},function(){a.wpsIsEnabled=b.enabled;a.wirelessCmd=h.query(function(){a.wirelessACmd=a.wirelessCmd[0];a.wpsIsEnabled=a.wpsIsEnabled?!0:!1;a.ipAddress=splitIpArr(a.wep.serverIp)})})});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.wepChanged=function(b){b=a.wep.settings[b];var c=10,c=0==b.keyLength?0==b.entryMethod?10:5:0==b.entryMethod?26:13;b.key.length>
c&&(b.key=b.key.substr(0,c))};a.wirelessUpdate=function(b){e.update({id:k},{activeSetting:a.wep.activeSetting,mode:a.wep.mode,authenticationType:a.wep.authenticationType,settings:a.wep.settings},function(){1==b?h.update({id:0},{mode:4},function(){d.path("/wireless/advanced")}):d.path("/wireless/advanced")})};a.checkWEP=function(){a.wirelessACmd.radioEnabled&&a.wpsIsEnabled&&4==a.wirelessACmd.mode?a.enableWEP():a.wirelessACmd.radioEnabled&&(a.wpsIsEnabled||1==a.wirelessACmd.mode||8==a.wirelessACmd.mode)?
a.enableWEP1():a.wirelessUpdate(0)};a.enableWEP=function(){f.showCustomMessage("Warning",["If WEP is enabled for the 2.4 GHz wireless network, then WPS will be disabled for the 2.4 GHz wireless network.","Are you sure you want to enable WEP?"]).then(function(b){"ok"==b&&a.wirelessUpdate(0)})};a.enableWEP1=function(){f.showCustomMessage1("Warning",["Turning on WEP will change your 2.4 GHz wireless mode to Legacy Mode (802.11b/g) and disable Wi-Fi Protected Setup.","Press OK to continue or Cancel."]).then(function(b){"ok"==
b&&a.wirelessUpdate(1)})};a.save=function(){a.errorMessages=[];a.wep.authenticationType=parseInt(a.wep.authenticationType);for(var b=0;b<a.wep.settings.length;b++)a.wep.settings[b].entryMethod=parseInt(a.wep.settings[b].entryMethod),a.wep.settings[b].keyLength=parseInt(a.wep.settings[b].keyLength),validateWepSettings(a.wep.settings[b],b==a.wep.activeSetting,"Key #"+(b+1),a.errorMessages);0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):a.checkWEP()}}]).controller("WirelessWPACtrl",
["$scope","$route","$routeParams","$location","WPA",function(a,b,c,d,e){a.tab=b.current.tab;a.section=b.current.section;a.whichKey=1;a.keyType=0;a.errorMessages=[];a.showErrorPage=!1;var f=c.id;a.wirelessName=0==f?"2.4 GHz":"5 GHz";a.wpaType=0==b.current.wpa?"WPA2/WPA mixed mode":"WPA2";a.wpa=e.get({id:f},function(){a.wpa.key=a.wpa.key;a.wpa.type=b.current.wpa});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.validateWpaKey=function(b){8>b.length&&a.errorMessages.push("Pre-Shared Key: Pass-Phrase has to be at least 8 characters long.")};
a.save=function(){a.errorMessages=[];a.wpa.groupKeyUpdateIntervalEnabled&&(isNaN(a.wpa.groupKeyUpdateInterval)||900>a.wpa.groupKeyUpdateInterval||86400<a.wpa.groupKeyUpdateInterval||!checksForDecimalNumber(a.wpa.groupKeyUpdateInterval))&&a.errorMessages.push("Group Key Update Interval: Please enter a numeric value between 900 and 86400.");a.validateWpaKey(a.wpa.key);0!=a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.wpa.groupKeyUpdateIntervalEnabled||(a.wpa.groupKeyUpdateInterval=
0),a.wpa.encryptionAlgorithm=parseInt(a.wpa.encryptionAlgorithm),e.update({id:f},{type:a.wpa.type,mode:a.wpa.mode,encryptionAlgorithm:a.wpa.encryptionAlgorithm,groupKeyUpdateInterval:a.wpa.groupKeyUpdateInterval,groupKeyUpdateIntervalEnabled:a.wpa.groupKeyUpdateIntervalEnabled,key:a.wpa.key},function(){d.path("/wireless/advanced")}))}}]).controller("WirelessMACFilterCtrl",["$scope","$route","$location","WirelessMACFilter","Wireless","securityTips","WPS",function(a,b,c,d,e,f,g){a.tab=b.current.tab;
a.section=b.current.section;a.warningFlg=!1;a.newMac="";a.filter0=d.get({id:0});a.filter1=d.get({id:1});a.errorPageOk=function(){a.showErrorPage=!1;window.scrollTo(0,0)};a.checkFilters=function(b){for(var c=0;c<b.length;c++)if(17!=b[c].length||!validateMac(b[c])||/[0\:]{17}$/.test(b[c])||/[f\:]{17}$/i.test(b[c])||parseInt(b[c].split(":")[0],16)&1){a.errorMessages.push("Invalid MAC Address format: Please try again.");break}};a.save=function(){a.errorMessages=[];a.checkFilters(a.filter0.macs);0==a.errorMessages.length&&
a.checkFilters(a.filter1.macs);0<a.errorMessages.length?(a.showErrorPage=!0,window.scrollTo(0,0)):(a.filter0.mode=parseInt(a.filter0.mode),a.filter1.mode=parseInt(a.filter1.mode),a.filter0.$update({id:0},function(){a.filter1.$update({id:1},function(){c.path("/wireless/advanced")})}))};a.chkBeforeSave=function(){var b=!0,c=e.query(function(){var d=g.get({id:0},function(){a.wpsEnabled=d.enabled;b=!0;a.wire0=c[0].radioEnabled;a.wire1=c[1].radioEnabled;var e=c[0].wpsEnabled,g=c[1].wpsEnabled;a.wire0||
a.wire1||(b=!1);e||g||(b=!1);a.wpsEnabled&&!b&&(a.wpsEnabled=!1);var g=e=!1,z="",w="";a.filter0.enabled&&0==a.filter0.mode&&0==a.filter0.macs.length&&(e=!0);a.filter1.enabled&&0==a.filter1.mode&&0==a.filter1.macs.length&&(g=!0);a.warningFlg=a.wpsEnabled?e||g?!0:!1:!1;a.warningFlg?(e&&g?(z="2.4GHz and 5.0GHz",w="networks"):g?(z="5.0GHz",w="network"):e&&(z="2.4GHz",w="network"),f.showCustomMessage1("Warning",["If Access List (MAC address filter) is enabled with no accepted devices (an empty white list) for the "+
z+" wireless "+w+", then WPS will be disabled for the "+z+" wireless "+w+".","Are you sure you want to enable Access List with no accepted devices?","Press OK to continue or Cancel."]).then(function(b){"cancel"!=b&&a.check5GHZList()})):a.check5GHZList()})})};a.check5GHZList=function(){a.filter1.enabled?f.showAutoConnectMsgAuth("","").then(function(b){"cancel"!=b&&a.save()}):a.save()};a.removeMac=function(b,c){0==b?a.filter0.macs.splice(c,1):a.filter1.macs.splice(c,1)};a.addFilter=function(b){a.errorMessages=
[];if(0==b)if(angular.isUndefined(a.newMac0))a.errorMessages.push("MAC Address: MAC address must consist of 6 fields. Each field's value must be between 00 and FF (in hexadecimal representation), without any spaces. The LSB of the first byte must be zero.");else if(0!=a.errorMessages.length||validateMac(a.newMac0)&&notAcceptedMac(a.newMac0)&&/^([0-9A-Fa-f]{2}[:]){5}([0-9A-Fa-f]{2})$/.test(a.newMac0)){for(b=0;b<a.filter0.macs.length;b++)if(a.newMac0==a.filter0.macs[b])return;a.filter0.macs.push(a.newMac0);
a.newMac0=""}else a.errorMessages.push("MAC Address: MAC address must consist of 6 fields. Each field's value must be between 00 and FF (in hexadecimal representation), without any spaces. The LSB of the first byte must be zero.");else if(angular.isUndefined(a.newMac1))a.errorMessages.push("MAC Address: MAC address must consist of 6 fields. Each field's value must be between 00 and FF (in hexadecimal representation), without any spaces. The LSB of the first byte must be zero.");else if(0!=a.errorMessages.length||
validateMac(a.newMac1)&&notAcceptedMac(a.newMac1)&&/^([0-9A-Fa-f]{2}[:]){5}([0-9A-Fa-f]{2})$/.test(a.newMac1)){for(b=0;b<a.filter1.macs.length;b++)if(a.newMac1==a.filter1.macs[b])return;a.filter1.macs.push(a.newMac1);a.newMac1=""}else a.errorMessages.push("MAC Address: MAC address must consist of 6 fields. Each field's value must be between 00 and FF (in hexadecimal representation), without any spaces. The LSB of the first byte must be zero.");0<a.errorMessages.length&&(a.showErrorPage=!0,window.scrollTo(0,
...
-1;a.bothDisabled=!1;a.basicGuestWifiEnabled=!1;a.guestPassWifiEnabled=!1;a.guestWifiEnum={BASIC_GUEST_WIFI:2};a.tabsEnum={1:"partials/wireless/guestDevicesTab.html?v=v1.0.134",2:"partials/wireless/basicGuestWifiTab.html?v=v1.0.134"};a.section=b.current.section;b=c.path();-1!=b.indexOf("/wireless/guestWifiSetup/devices")?a.currentTab=1:-1!=b.indexOf("/wireless/guestWifiSetup/basic")?a.currentTab=2:a.wireless1=d.query(function(){a.wirelessA1=a.wireless1[0];a.basicGuestWifi1=a.wireless1[a.guestWifiEnum.BASIC_GUEST_WIFI];
...
a.section=b.current.section;a.refresh=function(){a.guestDevices=null;a.wireless=d.query(function(){a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];a.basicGuestWifi.enabled?a.guestDevices=g.query(function(){for(var b=0;b<a.guestDevices.length;b++)a.guestDevices[b].toDisplay=!1,6==a.guestDevices[b].connectionType&&(a.basicGuestWifi.enabled&&(a.guestDevices[b].ssid=a.basicGuestWifi.ssid),a.guestDevices[b].toDisplay=!0,setDeviceStyle(a.guestDevices[b],""))}):a.bothDisable=!0});a.togglePage(0)};
a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.refresh();a.toggleOnOffSave=function(b){b.blocked=!b.blocked;g.update({id:b.id},b,function(){a.refresh()})}}]).controller("BasicGuestCtrl",["$scope","$route","$location","Wireless","GuestDevices","WPA","securityTips","$sce","$rootScope","Devices",function(a,b,c,d,e,f,g,h,k,m){a.warningFlag=!1;a.pageToShow=0;a.tab=b.current.tab;a.section=b.current.section;a.keySet=!1;a.showPassword=!0;k.editingGuest=!1;k.guestHasChanges=!1;a.countDownPopup=
null;a.fakeTimer=!1;a.listener=null;a.tempWPAkey="";a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.refresh=function(){a.showPassword=!0;a.wireless=d.query(function(){a.wirelessA=a.wireless[0];a.wirelessB=a.wireless[1];a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];a.basicGuestWifi.ssid=a.basicGuestWifi.ssid;a.tempWPAkey="";void 0!=a.basicGuestWifi&&null!=a.basicGuestWifi&&(a.guestDevices=m.query(function(){a.guestDevices=filterOutNonGuest(a.guestDevices)}),a.wpa=f.get({id:a.guestWifiEnum.BASIC_GUEST_WIFI},
function(){void 0!=a.wpa.key&&(a.wpa.key=a.wpa.key,a.tempWPAkey=h.trustAsHtml(a.convertKey(a.wpa.key)),a.keySet=""!==a.wpa.key?!0:!1)}));a.warningFlag=void 0==a.basicGuestWifi||null==a.basicGuestWifi||a.basicGuestWifi.enabled?!1:!0});a.mainRefresh();a.togglePage(0)};a.convertKey=function(a){var b="";if(a)for(var c=0;c<a.length;c++)b+="&bull;";return b=unescape(b)};a.refresh();a.toggleOnOffSave=function(){a.wirelessA.radioEnabled?a.basicGuestWifi.enabled?a.showAutoConnectMsg(1,""):a.keySet?a.showAutoConnectMsg(0,
""):a.showKeyForm():g.showWirelease24GPrompt("","").then(function(a){})};a.showAutoConnectMsg=function(b,c){g.showAutoConnectMsgGuest("","").then(function(d){"cancel"==d?a.refresh():0==b?a.saveSettings(!0):1==b?(a.basicGuestWifi.enabled=!1,a.saveToggle(!0)):2==b&&f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{wpaShowKeyInUI:c.wpaShowKeyInUI},function(){a.saveSettings(!1)})})};a.saveSettings=function(b){a.basicGuestWifi.enabled=!0;a.saveToggle(b)};a.saveToggle=function(b){a.basicGuestWifi.radioFreq=
a.wirelessA.radioEnabled?1:-1;clearTimeout(a.fakeTimer);a.countDownPopup=g.showSavingNow("Save Settings","Saving your settings. Please wait...");a.countDownPopup.open();a.fakeTimer=window.setTimeout(a.closeCountDownPopup1,15E3);d.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},a.basicGuestWifi,function(){b?a.refresh():a.saveWifiKey()})};a.showKeyForm=function(){g.showCreateGuestWifiPassword("Create Password","Please create a password to activate your Guest Wi-Fi.",a.wpa).then(function(b){if("cancel"==
b.result)a.refresh();else{var c=!1;if(void 0==b.returnObj)c=!0;else if(a.wpa.key=b.returnObj,8>a.wpa.key.length||63<a.wpa.key.length)c=!0;c?a.openValidationPopup():a.showAutoConnectMsg(2,b)}})};a.openValidationPopup=function(){g.showWarningMsgGuestWifi("","Password has to be at least 8 characters long",!1,[""]).then(function(b){"ok"==b&&a.showKeyForm()})};a.openValidationPopup1=function(){g.showWarningMsgGuestWifi("","Password has to be at least 8 characters long",!1,[""]).then(function(a){})};a.openValidationPopup2=
function(){g.showWarningMsgGuestWifi("","SSID must be 1 to 64 characters",!1,[""]).then(function(a){})};a.openValidationPopup3=function(){g.showWarningMsgGuestWifi2("","SSID must be 1 to 64 characters",!1,[""]).then(function(a){})};a.saveWifiKey=function(){a.wpa.encryptionAlgorithm=parseInt(a.wpa.encryptionAlgorithm);f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{type:a.wpa.type,mode:a.wpa.mode,encryptionAlgorithm:a.wpa.encryptionAlgorithm,groupKeyUpdateInterval:a.wpa.groupKeyUpdateInterval,groupKeyUpdateIntervalEnabled:a.wpa.groupKeyUpdateIntervalEnabled,
key:a.wpa.key},function(){})};a.editWifiSettings=function(){k.editingGuest=!0;k.guestHasChanges=!1};a.saveWifiSettings=function(){var b=!1,c=!1;if(8>a.wpa.key.length||63<a.wpa.key.length)b=!0;if(1>a.basicGuestWifi.ssid.length||64<a.basicGuestWifi.ssid.length||!/^[0-9a-zA-Z\!\"\#\$\%\&\u2019\'\(\)\*\+\,\-\.\/\:\;\<\=\>\?\@\[\\\]\^\_\`\{\|\}\~\ ]+$/i.test(a.basicGuestWifi.ssid))c=!0;c&&b?(a.cancelRedirect(),a.openValidationPopup3()):c?(a.cancelRedirect(),a.openValidationPopup2()):b?(a.cancelRedirect(),
a.openValidationPopup1()):(a.basicGuestWifi.ssid=a.basicGuestWifi.ssid,clearTimeout(a.fakeTimer),a.countDownPopup=g.showSavingNow("Save Settings","Saving your settings. Please wait..."),a.countDownPopup.open(),a.fakeTimer=window.setTimeout(a.closeCountDownPopup,15E3),d.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},a.basicGuestWifi,function(){f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{wpaShowKeyInUI:a.wpa.wpaShowKeyInUI},function(){a.saveWifiKey()})}))};a.closeCountDownPopup1=function(){a.countDownPopup.close();
a.countDownPopup=null;a.basicGuestWifi.ssid="";a.refresh();k.editingGuest=!1};a.closeCountDownPopup=function(){a.countDownPopup.close();a.countDownPopup=null;k.locationChangeActivate?a.redirect():(a.basicGuestWifi.ssid="",a.refresh(),k.editingGuest=!1)};a.cancel=function(){a.refresh();k.editingGuest=!1;k.guestHasChanges=!1};a.change=function(){k.guestHasChanges=!0};a.saveContents1Function=function(b){a.saveWifiSettings()};a.listener=k.$on("saveContents1",a.saveContents1Function);a.$on("$destroy",
function(){a.listener()});a.redirect=function(){k.locationChangeActivate=!1;k.editingGuest=!1;k.guestHasChanges=!1;""==getNextLocationForLocationChangeSub(k.locationChangeNext)?c.path(getNextLocationForLocationChange(k.locationChangeNext)):c.path(getNextLocationForLocationChange(k.locationChangeNext)).search(getNextLocationForLocationChangeSub(k.locationChangeNext))};a.toggleShowPassword=function(){f.update({id:a.guestWifiEnum.BASIC_GUEST_WIFI},{wpaShowKeyInUI:a.wpa.wpaShowKeyInUI},function(){})};
a.cancelRedirect=function(){k.locationChangeActivate=!1}}]).controller("BasicGuestCtrlPopup",["$scope","WPA","model","dialog",function(a,b,c,d){a.key=c.key;a.wpaPopup=c.wpa;a.buttons=c.buttons;a.title=c.title;a.message=c.message;a.close=function(b){d.close({result:b,returnObj:a.key,wpaShowKeyInUI:a.wpaPopup.wpaShowKeyInUI})}}]).controller("GuestPassWifiCtrl",["$scope","$route","$location","Wireless","GuestPassDevices","securityTips","Devices","$rootScope",function(a,b,c,d,e,f,g,h){a.warningFlag=!1;
a.pageToShow=0;a.tab=b.current.tab;a.section=b.current.section;h.editingGuest=!1;h.guestHasChanges=!1;a.listener=null;a.countDownPopup=null;a.fakeTimer=null;a.togglePage=function(b){a.pageToShow=b;window.scrollTo(0,0)};a.refresh=function(){a.wireless=d.query(function(){a.wirelessA=a.wireless[0];a.wirelessB=a.wireless[1];a.basicGuestWifi=a.wireless[a.guestWifiEnum.BASIC_GUEST_WIFI];a.guestPassWifi=a.wireless[a.guestWifiEnum.GUEST_PASS];a.guestPassWifi.ssid=a.guestPassWifi.ssid;void 0!=a.guestPassWifi&&
null!=a.guestPassWifi&&(a.guestDevices=g.query(function(){a.guestDevices=filterOutNonGuest(a.guestDevices)}));a.warningFlag=void 0!=a.guestPassWifi&&null!=a.guestPassWifi&&!a.guestPassWifi.enabled&&void 0!=a.basicGuestWifi&&null!=a.basicGuestWifi&&a.basicGuestWifi.enabled?!0:!1});a.mainRefresh();a.togglePage(0)};a.refresh();a.toggleOnOffSave=function(){a.wirelessA.radioEnabled?a.guestPassWifi.enabled?(a.guestPassWifi.enabled=!1,a.saveToggle()):a.basicGuestWifi.enabled?f.showWarningMsgGuestWifi3("",
"This will disable Basic Guest Wi-Fi and open your Wi-Fi to an unsecure security model.",!0,[""]).then(function(b){"cancel"!=b&&(a.guestPassWifi.enabled=!0,a.basicGuestWifi.enabled=!1,a.saveToggle())}):(a.guestPassWifi.enabled=!0,a.saveToggle()):f.showWirelease24GPrompt("","").then(function(a){})};a.saveToggle=function(){a.basicGuestWifi.radioFreq=a.wirelessA.radioEnabled?1:-1;a.guestPassWifi.radioFreq=a.wirelessA.radioEnabled?1:-1;a.guestPassWifi.ssid=a.guestPassWifi.ssid;clearTimeout(a.fakeTimer);
a.countDownPopup=f.showSavingNow("Save Settings","Saving your settings. Please wait...");a.countDownPopup.open();a.fakeTimer=window.setTimeout(a.closeCountDownPopup,15E3);d.update({id:a.guestWifiEnum.GUEST_PASS},a.guestPassWifi,function(){})};a.closeCountDownPopup=function(){a.countDownPopup.close();a.countDownPopup=null;h.locationChangeActivate?a.redirect():(a.guestPassWifi.ssid="",a.refresh(),h.editingGuest=!1)};a.editWifiSettings=function(){h.editingGuest=!0;h.guestHasChanges=!1};a.openValidationPopup2=
